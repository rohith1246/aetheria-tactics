/**
 * GladiatorDisruptorAI.js
 * Tactical Decision-Making Engine for Gladiator units utilizing Disruptor logic.
 */

class GladiatorDisruptorAI {
...
module.exports = { GladiatorDisruptorAI };
