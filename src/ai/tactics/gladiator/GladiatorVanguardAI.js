/**
 * GladiatorVanguardAI.js
 * Tactical Decision-Making Engine for Gladiator units utilizing Vanguard logic.
 */

class GladiatorVanguardAI {
  constructor(unit, blackboard) {
    this.unit = unit;
    this.blackboard = blackboard;
    this.tacticName = 'Vanguard';
    this.aggressionScore = 1.75;
...
module.exports = { GladiatorVanguardAI };
