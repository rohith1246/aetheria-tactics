/**
 * GladiatorZoneControlAI.js
 * Tactical Decision-Making Engine for Gladiator units utilizing ZoneControl logic.
 */

class GladiatorZoneControlAI {
  constructor(unit, blackboard) {
    this.unit = unit;
    this.blackboard = blackboard;
    this.tacticName = 'ZoneControl';
    this.aggressionScore = 1.6;
...
module.exports = { GladiatorZoneControlAI };
