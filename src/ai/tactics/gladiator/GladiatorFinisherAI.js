/**
 * GladiatorFinisherAI.js
 * Tactical Decision-Making Engine for Gladiator units utilizing Finisher logic.
 */

class GladiatorFinisherAI {
...
module.exports = { GladiatorFinisherAI };
