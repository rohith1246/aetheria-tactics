/**
 * GladiatorAggressiveAI.js
 * Tactical Decision-Making Engine for Gladiator units utilizing Aggressive logic.
 */

class GladiatorAggressiveAI {
...
module.exports = { GladiatorAggressiveAI };
