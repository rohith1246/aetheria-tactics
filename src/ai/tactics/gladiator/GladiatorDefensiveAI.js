/**
 * GladiatorDefensiveAI.js
 * Tactical Decision-Making Engine for Gladiator units utilizing Defensive logic.
 */

class GladiatorDefensiveAI {
  constructor(unit, blackboard) {
    this.unit = unit;
    this.blackboard = blackboard;
    this.tacticName = 'Defensive';
    this.aggressionScore = 1.35;
...
module.exports = { GladiatorDefensiveAI };
