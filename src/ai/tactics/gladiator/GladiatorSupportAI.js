/**
 * GladiatorSupportAI.js
 * Tactical Decision-Making Engine for Gladiator units utilizing Support logic.
 */

class GladiatorSupportAI {
...
module.exports = { GladiatorSupportAI };
