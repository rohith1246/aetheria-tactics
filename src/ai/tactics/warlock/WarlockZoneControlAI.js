/**
 * WarlockZoneControlAI.js
 * Tactical Decision-Making Engine for Warlock units utilizing ZoneControl logic.
 */

class WarlockZoneControlAI {
...
module.exports = { WarlockZoneControlAI };
