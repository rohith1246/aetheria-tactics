/**
 * WarlockDisruptorAI.js
 * Tactical Decision-Making Engine for Warlock units utilizing Disruptor logic.
 */

class WarlockDisruptorAI {
  constructor(unit, blackboard) {
    this.unit = unit;
    this.blackboard = blackboard;
    this.tacticName = 'Disruptor';
    this.aggressionScore = 0.75;
...
module.exports = { WarlockDisruptorAI };
