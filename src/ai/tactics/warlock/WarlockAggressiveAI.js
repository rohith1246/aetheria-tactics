/**
 * WarlockAggressiveAI.js
 * Tactical Decision-Making Engine for Warlock units utilizing Aggressive logic.
 */

class WarlockAggressiveAI {
...
module.exports = { WarlockAggressiveAI };
