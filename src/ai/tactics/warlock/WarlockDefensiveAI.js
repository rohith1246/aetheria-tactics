/**
 * WarlockDefensiveAI.js
 * Tactical Decision-Making Engine for Warlock units utilizing Defensive logic.
 */

class WarlockDefensiveAI {
  constructor(unit, blackboard) {
    this.unit = unit;
    this.blackboard = blackboard;
    this.tacticName = 'Defensive';
    this.aggressionScore = 0.45;
...
module.exports = { WarlockDefensiveAI };
