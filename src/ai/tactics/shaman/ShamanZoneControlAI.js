/**
 * ShamanZoneControlAI.js
 * Tactical Decision-Making Engine for Shaman units utilizing ZoneControl logic.
 */

class ShamanZoneControlAI {
  constructor(unit, blackboard) {
    this.unit = unit;
    this.blackboard = blackboard;
    this.tacticName = 'ZoneControl';
    this.aggressionScore = 0.9000000000000001;
...
module.exports = { ShamanZoneControlAI };
