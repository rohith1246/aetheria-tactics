/**
 * ShamanDisruptorAI.js
 * Tactical Decision-Making Engine for Shaman units utilizing Disruptor logic.
 */

class ShamanDisruptorAI {
  constructor(unit, blackboard) {
    this.unit = unit;
    this.blackboard = blackboard;
    this.tacticName = 'Disruptor';
    this.aggressionScore = 0.9500000000000002;
...
module.exports = { ShamanDisruptorAI };
