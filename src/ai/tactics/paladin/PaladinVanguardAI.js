/**
 * PaladinVanguardAI.js
 * Tactical Decision-Making Engine for Paladin units utilizing Vanguard logic.
 */

class PaladinVanguardAI {
  constructor(unit, blackboard) {
    this.unit = unit;
    this.blackboard = blackboard;
    this.tacticName = 'Vanguard';
    this.aggressionScore = 0.95;
...
module.exports = { PaladinVanguardAI };
