/**
 * PaladinFlankingAI.js
 * Tactical Decision-Making Engine for Paladin units utilizing Flanking logic.
 */

class PaladinFlankingAI {
  constructor(unit, blackboard) {
    this.unit = unit;
    this.blackboard = blackboard;
    this.tacticName = 'Flanking';
    this.aggressionScore = 0.6;
...
module.exports = { PaladinFlankingAI };
