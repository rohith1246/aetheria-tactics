/**
 * SniperDefensiveAI.js
 * Tactical Decision-Making Engine for Sniper units utilizing Defensive logic.
 */

class SniperDefensiveAI {
  constructor(unit, blackboard) {
    this.unit = unit;
    this.blackboard = blackboard;
    this.tacticName = 'Defensive';
    this.aggressionScore = 0.25;
...
module.exports = { SniperDefensiveAI };
