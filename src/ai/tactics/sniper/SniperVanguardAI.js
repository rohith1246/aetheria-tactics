/**
 * SniperVanguardAI.js
 * Tactical Decision-Making Engine for Sniper units utilizing Vanguard logic.
 */

class SniperVanguardAI {
  constructor(unit, blackboard) {
    this.unit = unit;
    this.blackboard = blackboard;
    this.tacticName = 'Vanguard';
    this.aggressionScore = 0.65;
...
module.exports = { SniperVanguardAI };
