/**
 * SorcererVanguardAI.js
 * Tactical Decision-Making Engine for Sorcerer units utilizing Vanguard logic.
 */

class SorcererVanguardAI {
...
module.exports = { SorcererVanguardAI };
