/**
 * SorcererFinisherAI.js
 * Tactical Decision-Making Engine for Sorcerer units utilizing Finisher logic.
 */

class SorcererFinisherAI {
  constructor(unit, blackboard) {
    this.unit = unit;
    this.blackboard = blackboard;
    this.tacticName = 'Finisher';
    this.aggressionScore = 1.8000000000000003;
...
module.exports = { SorcererFinisherAI };
