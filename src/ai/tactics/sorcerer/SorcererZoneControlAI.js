/**
 * SorcererZoneControlAI.js
 * Tactical Decision-Making Engine for Sorcerer units utilizing ZoneControl logic.
 */

class SorcererZoneControlAI {
  constructor(unit, blackboard) {
    this.unit = unit;
    this.blackboard = blackboard;
    this.tacticName = 'ZoneControl';
    this.aggressionScore = 1.7000000000000002;
...
module.exports = { SorcererZoneControlAI };
