/**
 * SorcererDisruptorAI.js
 * Tactical Decision-Making Engine for Sorcerer units utilizing Disruptor logic.
 */

class SorcererDisruptorAI {
  constructor(unit, blackboard) {
    this.unit = unit;
    this.blackboard = blackboard;
    this.tacticName = 'Disruptor';
    this.aggressionScore = 1.7500000000000002;
...
module.exports = { SorcererDisruptorAI };
