/**
 * SorcererDefensiveAI.js
 * Tactical Decision-Making Engine for Sorcerer units utilizing Defensive logic.
 */

class SorcererDefensiveAI {
...
module.exports = { SorcererDefensiveAI };
