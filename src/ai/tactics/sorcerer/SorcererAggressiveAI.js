/**
 * SorcererAggressiveAI.js
 * Tactical Decision-Making Engine for Sorcerer units utilizing Aggressive logic.
 */

class SorcererAggressiveAI {
  constructor(unit, blackboard) {
    this.unit = unit;
    this.blackboard = blackboard;
    this.tacticName = 'Aggressive';
    this.aggressionScore = 1.4000000000000001;
...
module.exports = { SorcererAggressiveAI };
