/**
 * VanguardDefensiveAI.js
 * Tactical Decision-Making Engine for Vanguard units utilizing Defensive logic.
 */

class VanguardDefensiveAI {
  constructor(unit, blackboard) {
    this.unit = unit;
    this.blackboard = blackboard;
    this.tacticName = 'Defensive';
    this.aggressionScore = 1.55;
...
module.exports = { VanguardDefensiveAI };
