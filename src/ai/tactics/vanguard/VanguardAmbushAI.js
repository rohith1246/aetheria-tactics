/**
 * VanguardAmbushAI.js
 * Tactical Decision-Making Engine for Vanguard units utilizing Ambush logic.
 */

class VanguardAmbushAI {
  constructor(unit, blackboard) {
    this.unit = unit;
    this.blackboard = blackboard;
    this.tacticName = 'Ambush';
    this.aggressionScore = 1.65;
...
module.exports = { VanguardAmbushAI };
