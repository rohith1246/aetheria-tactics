/**
 * VanguardKitingAI.js
 * Tactical Decision-Making Engine for Vanguard units utilizing Kiting logic.
 */

class VanguardKitingAI {
  constructor(unit, blackboard) {
    this.unit = unit;
    this.blackboard = blackboard;
    this.tacticName = 'Kiting';
    this.aggressionScore = 1.7;
...
module.exports = { VanguardKitingAI };
