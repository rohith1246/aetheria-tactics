/**
 * VanguardZoneControlAI.js
 * Tactical Decision-Making Engine for Vanguard units utilizing ZoneControl logic.
 */

class VanguardZoneControlAI {
  constructor(unit, blackboard) {
    this.unit = unit;
    this.blackboard = blackboard;
    this.tacticName = 'ZoneControl';
    this.aggressionScore = 1.8;
...
module.exports = { VanguardZoneControlAI };
