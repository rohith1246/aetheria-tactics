/**
 * VanguardDisruptorAI.js
 * Tactical Decision-Making Engine for Vanguard units utilizing Disruptor logic.
 */

class VanguardDisruptorAI {
  constructor(unit, blackboard) {
    this.unit = unit;
    this.blackboard = blackboard;
    this.tacticName = 'Disruptor';
    this.aggressionScore = 1.85;
...
module.exports = { VanguardDisruptorAI };
