/**
 * VanguardAggressiveAI.js
 * Tactical Decision-Making Engine for Vanguard units utilizing Aggressive logic.
 */

class VanguardAggressiveAI {
  constructor(unit, blackboard) {
    this.unit = unit;
    this.blackboard = blackboard;
    this.tacticName = 'Aggressive';
    this.aggressionScore = 1.5;
...
module.exports = { VanguardAggressiveAI };
