/**
 * VanguardVanguardAI.js
 * Tactical Decision-Making Engine for Vanguard units utilizing Vanguard logic.
 */

class VanguardVanguardAI {
  constructor(unit, blackboard) {
    this.unit = unit;
    this.blackboard = blackboard;
    this.tacticName = 'Vanguard';
    this.aggressionScore = 1.95;
...
module.exports = { VanguardVanguardAI };
