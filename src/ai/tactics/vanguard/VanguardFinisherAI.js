/**
 * VanguardFinisherAI.js
 * Tactical Decision-Making Engine for Vanguard units utilizing Finisher logic.
 */

class VanguardFinisherAI {
  constructor(unit, blackboard) {
    this.unit = unit;
    this.blackboard = blackboard;
    this.tacticName = 'Finisher';
    this.aggressionScore = 1.9;
...
module.exports = { VanguardFinisherAI };
