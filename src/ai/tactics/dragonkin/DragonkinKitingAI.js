/**
 * DragonkinKitingAI.js
 * Tactical Decision-Making Engine for Dragonkin units utilizing Kiting logic.
 */

class DragonkinKitingAI {
  constructor(unit, blackboard) {
    this.unit = unit;
    this.blackboard = blackboard;
    this.tacticName = 'Kiting';
    this.aggressionScore = 1.2;
...
module.exports = { DragonkinKitingAI };
