/**
 * DragonkinZoneControlAI.js
 * Tactical Decision-Making Engine for Dragonkin units utilizing ZoneControl logic.
 */

class DragonkinZoneControlAI {
  constructor(unit, blackboard) {
    this.unit = unit;
    this.blackboard = blackboard;
    this.tacticName = 'ZoneControl';
    this.aggressionScore = 1.3;
...
module.exports = { DragonkinZoneControlAI };
