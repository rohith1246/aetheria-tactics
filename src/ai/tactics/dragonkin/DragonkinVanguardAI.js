/**
 * DragonkinVanguardAI.js
 * Tactical Decision-Making Engine for Dragonkin units utilizing Vanguard logic.
 */

class DragonkinVanguardAI {
  constructor(unit, blackboard) {
    this.unit = unit;
    this.blackboard = blackboard;
    this.tacticName = 'Vanguard';
    this.aggressionScore = 1.45;
...
module.exports = { DragonkinVanguardAI };
