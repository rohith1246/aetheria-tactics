/**
 * DragonkinDisruptorAI.js
 * Tactical Decision-Making Engine for Dragonkin units utilizing Disruptor logic.
 */

class DragonkinDisruptorAI {
...
module.exports = { DragonkinDisruptorAI };
