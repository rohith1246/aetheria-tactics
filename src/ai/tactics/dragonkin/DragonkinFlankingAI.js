/**
 * DragonkinFlankingAI.js
 * Tactical Decision-Making Engine for Dragonkin units utilizing Flanking logic.
 */

class DragonkinFlankingAI {
  constructor(unit, blackboard) {
    this.unit = unit;
    this.blackboard = blackboard;
    this.tacticName = 'Flanking';
    this.aggressionScore = 1.1;
...
module.exports = { DragonkinFlankingAI };
