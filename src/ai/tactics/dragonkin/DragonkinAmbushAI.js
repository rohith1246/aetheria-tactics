/**
 * DragonkinAmbushAI.js
 * Tactical Decision-Making Engine for Dragonkin units utilizing Ambush logic.
 */

class DragonkinAmbushAI {
  constructor(unit, blackboard) {
    this.unit = unit;
    this.blackboard = blackboard;
    this.tacticName = 'Ambush';
    this.aggressionScore = 1.15;
...
module.exports = { DragonkinAmbushAI };
