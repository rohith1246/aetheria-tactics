/**
 * DragonkinSupportAI.js
 * Tactical Decision-Making Engine for Dragonkin units utilizing Support logic.
 */

class DragonkinSupportAI {
  constructor(unit, blackboard) {
    this.unit = unit;
    this.blackboard = blackboard;
    this.tacticName = 'Support';
    this.aggressionScore = 1.25;
...
module.exports = { DragonkinSupportAI };
