/**
 * DragonkinFinisherAI.js
 * Tactical Decision-Making Engine for Dragonkin units utilizing Finisher logic.
 */

class DragonkinFinisherAI {
  constructor(unit, blackboard) {
    this.unit = unit;
    this.blackboard = blackboard;
    this.tacticName = 'Finisher';
    this.aggressionScore = 1.4;
...
module.exports = { DragonkinFinisherAI };
