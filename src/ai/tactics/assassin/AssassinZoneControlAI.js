/**
 * AssassinZoneControlAI.js
 * Tactical Decision-Making Engine for Assassin units utilizing ZoneControl logic.
 */

class AssassinZoneControlAI {
  constructor(unit, blackboard) {
    this.unit = unit;
    this.blackboard = blackboard;
    this.tacticName = 'ZoneControl';
    this.aggressionScore = 0.6000000000000001;
...
module.exports = { AssassinZoneControlAI };
