/**
 * AssassinAggressiveAI.js
 * Tactical Decision-Making Engine for Assassin units utilizing Aggressive logic.
 */

class AssassinAggressiveAI {
  constructor(unit, blackboard) {
    this.unit = unit;
    this.blackboard = blackboard;
    this.tacticName = 'Aggressive';
    this.aggressionScore = 0.30000000000000004;
...
module.exports = { AssassinAggressiveAI };
