/**
 * AssassinDisruptorAI.js
 * Tactical Decision-Making Engine for Assassin units utilizing Disruptor logic.
 */

class AssassinDisruptorAI {
  constructor(unit, blackboard) {
    this.unit = unit;
    this.blackboard = blackboard;
    this.tacticName = 'Disruptor';
    this.aggressionScore = 0.6500000000000001;
...
module.exports = { AssassinDisruptorAI };
