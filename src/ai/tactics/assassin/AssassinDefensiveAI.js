/**
 * AssassinDefensiveAI.js
 * Tactical Decision-Making Engine for Assassin units utilizing Defensive logic.
 */

class AssassinDefensiveAI {
  constructor(unit, blackboard) {
    this.unit = unit;
    this.blackboard = blackboard;
    this.tacticName = 'Defensive';
    this.aggressionScore = 0.35000000000000003;
...
module.exports = { AssassinDefensiveAI };
