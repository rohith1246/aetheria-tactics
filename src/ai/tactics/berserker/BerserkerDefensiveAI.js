/**
 * BerserkerDefensiveAI.js
 * Tactical Decision-Making Engine for Berserker units utilizing Defensive logic.
 */

class BerserkerDefensiveAI {
  constructor(unit, blackboard) {
    this.unit = unit;
    this.blackboard = blackboard;
    this.tacticName = 'Defensive';
    this.aggressionScore = 0.15000000000000002;
...
module.exports = { BerserkerDefensiveAI };
