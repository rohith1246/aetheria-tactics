/**
 * BerserkerSupportAI.js
 * Tactical Decision-Making Engine for Berserker units utilizing Support logic.
 */

class BerserkerSupportAI {
  constructor(unit, blackboard) {
    this.unit = unit;
    this.blackboard = blackboard;
    this.tacticName = 'Support';
    this.aggressionScore = 0.35;
...
module.exports = { BerserkerSupportAI };
