/**
 * BerserkerAggressiveAI.js
 * Tactical Decision-Making Engine for Berserker units utilizing Aggressive logic.
 */

class BerserkerAggressiveAI {
  constructor(unit, blackboard) {
    this.unit = unit;
    this.blackboard = blackboard;
    this.tacticName = 'Aggressive';
    this.aggressionScore = 0.1;
...
module.exports = { BerserkerAggressiveAI };
