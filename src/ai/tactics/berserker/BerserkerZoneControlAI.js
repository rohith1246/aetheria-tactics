/**
 * BerserkerZoneControlAI.js
 * Tactical Decision-Making Engine for Berserker units utilizing ZoneControl logic.
 */

class BerserkerZoneControlAI {
  constructor(unit, blackboard) {
    this.unit = unit;
    this.blackboard = blackboard;
    this.tacticName = 'ZoneControl';
    this.aggressionScore = 0.4;
...
module.exports = { BerserkerZoneControlAI };
