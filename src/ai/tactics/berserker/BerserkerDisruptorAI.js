/**
 * BerserkerDisruptorAI.js
 * Tactical Decision-Making Engine for Berserker units utilizing Disruptor logic.
 */

class BerserkerDisruptorAI {
  constructor(unit, blackboard) {
    this.unit = unit;
    this.blackboard = blackboard;
    this.tacticName = 'Disruptor';
    this.aggressionScore = 0.45000000000000007;
...
module.exports = { BerserkerDisruptorAI };
