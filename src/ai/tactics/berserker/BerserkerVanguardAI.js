/**
 * BerserkerVanguardAI.js
 * Tactical Decision-Making Engine for Berserker units utilizing Vanguard logic.
 */

class BerserkerVanguardAI {
  constructor(unit, blackboard) {
    this.unit = unit;
    this.blackboard = blackboard;
    this.tacticName = 'Vanguard';
    this.aggressionScore = 0.55;
...
module.exports = { BerserkerVanguardAI };
