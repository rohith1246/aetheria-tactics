/**
 * BerserkerFlankingAI.js
 * Tactical Decision-Making Engine for Berserker units utilizing Flanking logic.
 */

class BerserkerFlankingAI {
  constructor(unit, blackboard) {
    this.unit = unit;
    this.blackboard = blackboard;
    this.tacticName = 'Flanking';
    this.aggressionScore = 0.2;
...
module.exports = { BerserkerFlankingAI };
