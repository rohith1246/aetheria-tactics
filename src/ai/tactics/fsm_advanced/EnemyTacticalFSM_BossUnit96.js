/**
 * EnemyTacticalFSM_BossUnit96.js - Hierarchical Finite State Machine for Enemy Bosses
 * Boss Unit ID: 96
 * Part of Aetheria Tactics Engine
 */

class EnemyTacticalFSM_BossUnit96 {
  constructor(unitId = 'BOSS_96') {
    this.unitId = unitId;
    this.state = 'PATROL';
    this.phase = 1;
...
module.exports = EnemyTacticalFSM_BossUnit96;
