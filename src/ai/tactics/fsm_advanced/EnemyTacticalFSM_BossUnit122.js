/**
 * EnemyTacticalFSM_BossUnit122.js - Hierarchical Finite State Machine for Enemy Bosses
 * Boss Unit ID: 122
 * Part of Aetheria Tactics Engine
 */

class EnemyTacticalFSM_BossUnit122 {
  constructor(unitId = 'BOSS_122') {
    this.unitId = unitId;
    this.state = 'PATROL';
    this.phase = 1;
...
module.exports = EnemyTacticalFSM_BossUnit122;
