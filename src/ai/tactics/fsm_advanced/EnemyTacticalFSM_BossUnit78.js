/**
 * EnemyTacticalFSM_BossUnit78.js - Hierarchical Finite State Machine for Enemy Bosses
 * Boss Unit ID: 78
 * Part of Aetheria Tactics Engine
 */

class EnemyTacticalFSM_BossUnit78 {
  constructor(unitId = 'BOSS_78') {
    this.unitId = unitId;
    this.state = 'PATROL';
    this.phase = 1;
...
module.exports = EnemyTacticalFSM_BossUnit78;
