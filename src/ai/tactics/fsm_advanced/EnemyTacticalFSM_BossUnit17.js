/**
 * EnemyTacticalFSM_BossUnit17.js - Hierarchical Finite State Machine for Enemy Bosses
 * Boss Unit ID: 17
 * Part of Aetheria Tactics Engine
 */

class EnemyTacticalFSM_BossUnit17 {
  constructor(unitId = 'BOSS_17') {
    this.unitId = unitId;
    this.state = 'PATROL';
    this.phase = 1;
...
module.exports = EnemyTacticalFSM_BossUnit17;
