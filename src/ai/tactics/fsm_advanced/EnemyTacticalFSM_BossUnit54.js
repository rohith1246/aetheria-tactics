/**
 * EnemyTacticalFSM_BossUnit54.js - Hierarchical Finite State Machine for Enemy Bosses
 * Boss Unit ID: 54
 * Part of Aetheria Tactics Engine
 */

class EnemyTacticalFSM_BossUnit54 {
  constructor(unitId = 'BOSS_54') {
    this.unitId = unitId;
    this.state = 'PATROL';
    this.phase = 1;
...
module.exports = EnemyTacticalFSM_BossUnit54;
