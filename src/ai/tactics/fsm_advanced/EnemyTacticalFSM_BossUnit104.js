/**
 * EnemyTacticalFSM_BossUnit104.js - Hierarchical Finite State Machine for Enemy Bosses
 * Boss Unit ID: 104
 * Part of Aetheria Tactics Engine
 */

class EnemyTacticalFSM_BossUnit104 {
  constructor(unitId = 'BOSS_104') {
    this.unitId = unitId;
    this.state = 'PATROL';
    this.phase = 1;
...
module.exports = EnemyTacticalFSM_BossUnit104;
