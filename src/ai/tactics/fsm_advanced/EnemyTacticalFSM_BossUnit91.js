/**
 * EnemyTacticalFSM_BossUnit91.js - Hierarchical Finite State Machine for Enemy Bosses
 * Boss Unit ID: 91
 * Part of Aetheria Tactics Engine
 */

class EnemyTacticalFSM_BossUnit91 {
  constructor(unitId = 'BOSS_91') {
    this.unitId = unitId;
    this.state = 'PATROL';
    this.phase = 1;
...
module.exports = EnemyTacticalFSM_BossUnit91;
