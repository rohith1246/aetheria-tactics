/**
 * EnemyTacticalFSM_BossUnit83.js - Hierarchical Finite State Machine for Enemy Bosses
 * Boss Unit ID: 83
 * Part of Aetheria Tactics Engine
 */

class EnemyTacticalFSM_BossUnit83 {
  constructor(unitId = 'BOSS_83') {
    this.unitId = unitId;
    this.state = 'PATROL';
    this.phase = 1;
...
module.exports = EnemyTacticalFSM_BossUnit83;
