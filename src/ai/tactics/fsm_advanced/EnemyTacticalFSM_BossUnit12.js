/**
 * EnemyTacticalFSM_BossUnit12.js - Hierarchical Finite State Machine for Enemy Bosses
 * Boss Unit ID: 12
 * Part of Aetheria Tactics Engine
 */

class EnemyTacticalFSM_BossUnit12 {
  constructor(unitId = 'BOSS_12') {
    this.unitId = unitId;
    this.state = 'PATROL';
    this.phase = 1;
...
module.exports = EnemyTacticalFSM_BossUnit12;
