/**
 * EnemyTacticalFSM_BossUnit36.js - Hierarchical Finite State Machine for Enemy Bosses
 * Boss Unit ID: 36
 * Part of Aetheria Tactics Engine
 */

class EnemyTacticalFSM_BossUnit36 {
  constructor(unitId = 'BOSS_36') {
    this.unitId = unitId;
    this.state = 'PATROL';
    this.phase = 1;
...
module.exports = EnemyTacticalFSM_BossUnit36;
