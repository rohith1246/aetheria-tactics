/**
 * EnemyTacticalFSM_BossUnit106.js - Hierarchical Finite State Machine for Enemy Bosses
 * Boss Unit ID: 106
 * Part of Aetheria Tactics Engine
 */

class EnemyTacticalFSM_BossUnit106 {
  constructor(unitId = 'BOSS_106') {
    this.unitId = unitId;
    this.state = 'PATROL';
    this.phase = 1;
...
module.exports = EnemyTacticalFSM_BossUnit106;
