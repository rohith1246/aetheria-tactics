/**
 * EnemyTacticalFSM_BossUnit38.js - Hierarchical Finite State Machine for Enemy Bosses
 * Boss Unit ID: 38
 * Part of Aetheria Tactics Engine
 */

class EnemyTacticalFSM_BossUnit38 {
  constructor(unitId = 'BOSS_38') {
    this.unitId = unitId;
    this.state = 'PATROL';
    this.phase = 1;
...
module.exports = EnemyTacticalFSM_BossUnit38;
