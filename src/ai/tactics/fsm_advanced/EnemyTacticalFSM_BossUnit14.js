/**
 * EnemyTacticalFSM_BossUnit14.js - Hierarchical Finite State Machine for Enemy Bosses
 * Boss Unit ID: 14
 * Part of Aetheria Tactics Engine
 */

class EnemyTacticalFSM_BossUnit14 {
  constructor(unitId = 'BOSS_14') {
    this.unitId = unitId;
    this.state = 'PATROL';
    this.phase = 1;
...
module.exports = EnemyTacticalFSM_BossUnit14;
