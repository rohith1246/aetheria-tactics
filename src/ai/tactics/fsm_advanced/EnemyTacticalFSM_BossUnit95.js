/**
 * EnemyTacticalFSM_BossUnit95.js - Hierarchical Finite State Machine for Enemy Bosses
 * Boss Unit ID: 95
 * Part of Aetheria Tactics Engine
 */

class EnemyTacticalFSM_BossUnit95 {
  constructor(unitId = 'BOSS_95') {
    this.unitId = unitId;
    this.state = 'PATROL';
    this.phase = 1;
...
module.exports = EnemyTacticalFSM_BossUnit95;
