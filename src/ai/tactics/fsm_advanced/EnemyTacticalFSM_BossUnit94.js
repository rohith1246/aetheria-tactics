/**
 * EnemyTacticalFSM_BossUnit94.js - Hierarchical Finite State Machine for Enemy Bosses
 * Boss Unit ID: 94
 * Part of Aetheria Tactics Engine
 */

class EnemyTacticalFSM_BossUnit94 {
  constructor(unitId = 'BOSS_94') {
    this.unitId = unitId;
    this.state = 'PATROL';
    this.phase = 1;
...
module.exports = EnemyTacticalFSM_BossUnit94;
