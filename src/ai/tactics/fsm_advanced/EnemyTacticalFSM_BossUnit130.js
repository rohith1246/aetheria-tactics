/**
 * EnemyTacticalFSM_BossUnit130.js - Hierarchical Finite State Machine for Enemy Bosses
 * Boss Unit ID: 130
 * Part of Aetheria Tactics Engine
 */

class EnemyTacticalFSM_BossUnit130 {
  constructor(unitId = 'BOSS_130') {
    this.unitId = unitId;
    this.state = 'PATROL';
    this.phase = 1;
...
module.exports = EnemyTacticalFSM_BossUnit130;
