/**
 * EnemyTacticalFSM_BossUnit121.js - Hierarchical Finite State Machine for Enemy Bosses
 * Boss Unit ID: 121
 * Part of Aetheria Tactics Engine
 */

class EnemyTacticalFSM_BossUnit121 {
  constructor(unitId = 'BOSS_121') {
    this.unitId = unitId;
    this.state = 'PATROL';
    this.phase = 1;
...
module.exports = EnemyTacticalFSM_BossUnit121;
