/**
 * EnemyTacticalFSM_BossUnit26.js - Hierarchical Finite State Machine for Enemy Bosses
 * Boss Unit ID: 26
 * Part of Aetheria Tactics Engine
 */

class EnemyTacticalFSM_BossUnit26 {
  constructor(unitId = 'BOSS_26') {
    this.unitId = unitId;
    this.state = 'PATROL';
    this.phase = 1;
...
module.exports = EnemyTacticalFSM_BossUnit26;
