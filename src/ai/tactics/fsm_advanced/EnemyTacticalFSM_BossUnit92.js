/**
 * EnemyTacticalFSM_BossUnit92.js - Hierarchical Finite State Machine for Enemy Bosses
 * Boss Unit ID: 92
 * Part of Aetheria Tactics Engine
 */

class EnemyTacticalFSM_BossUnit92 {
  constructor(unitId = 'BOSS_92') {
    this.unitId = unitId;
    this.state = 'PATROL';
    this.phase = 1;
...
module.exports = EnemyTacticalFSM_BossUnit92;
