/**
 * EnemyTacticalFSM_BossUnit13.js - Hierarchical Finite State Machine for Enemy Bosses
 * Boss Unit ID: 13
 * Part of Aetheria Tactics Engine
 */

class EnemyTacticalFSM_BossUnit13 {
  constructor(unitId = 'BOSS_13') {
    this.unitId = unitId;
    this.state = 'PATROL';
    this.phase = 1;
...
module.exports = EnemyTacticalFSM_BossUnit13;
