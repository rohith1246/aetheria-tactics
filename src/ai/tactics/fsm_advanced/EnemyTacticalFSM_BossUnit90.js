/**
 * EnemyTacticalFSM_BossUnit90.js - Hierarchical Finite State Machine for Enemy Bosses
 * Boss Unit ID: 90
 * Part of Aetheria Tactics Engine
 */

class EnemyTacticalFSM_BossUnit90 {
  constructor(unitId = 'BOSS_90') {
    this.unitId = unitId;
    this.state = 'PATROL';
    this.phase = 1;
...
module.exports = EnemyTacticalFSM_BossUnit90;
