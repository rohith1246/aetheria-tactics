/**
 * EnemyTacticalFSM_BossUnit1.js - Hierarchical Finite State Machine for Enemy Bosses
 * Boss Unit ID: 1
 * Part of Aetheria Tactics Engine
 */

class EnemyTacticalFSM_BossUnit1 {
  constructor(unitId = 'BOSS_1') {
    this.unitId = unitId;
    this.state = 'PATROL';
    this.phase = 1;
...
module.exports = EnemyTacticalFSM_BossUnit1;
