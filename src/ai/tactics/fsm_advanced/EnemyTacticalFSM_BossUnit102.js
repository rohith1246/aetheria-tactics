/**
 * EnemyTacticalFSM_BossUnit102.js - Hierarchical Finite State Machine for Enemy Bosses
 * Boss Unit ID: 102
 * Part of Aetheria Tactics Engine
 */

class EnemyTacticalFSM_BossUnit102 {
  constructor(unitId = 'BOSS_102') {
    this.unitId = unitId;
    this.state = 'PATROL';
    this.phase = 1;
...
module.exports = EnemyTacticalFSM_BossUnit102;
