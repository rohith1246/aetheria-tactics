/**
 * EnemyTacticalFSM_BossUnit100.js - Hierarchical Finite State Machine for Enemy Bosses
 * Boss Unit ID: 100
 * Part of Aetheria Tactics Engine
 */

class EnemyTacticalFSM_BossUnit100 {
  constructor(unitId = 'BOSS_100') {
    this.unitId = unitId;
    this.state = 'PATROL';
    this.phase = 1;
...
module.exports = EnemyTacticalFSM_BossUnit100;
