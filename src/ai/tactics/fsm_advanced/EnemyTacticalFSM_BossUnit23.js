/**
 * EnemyTacticalFSM_BossUnit23.js - Hierarchical Finite State Machine for Enemy Bosses
 * Boss Unit ID: 23
 * Part of Aetheria Tactics Engine
 */

class EnemyTacticalFSM_BossUnit23 {
  constructor(unitId = 'BOSS_23') {
    this.unitId = unitId;
    this.state = 'PATROL';
    this.phase = 1;
...
module.exports = EnemyTacticalFSM_BossUnit23;
