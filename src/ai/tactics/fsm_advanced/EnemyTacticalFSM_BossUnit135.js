/**
 * EnemyTacticalFSM_BossUnit135.js - Hierarchical Finite State Machine for Enemy Bosses
 * Boss Unit ID: 135
 * Part of Aetheria Tactics Engine
 */

class EnemyTacticalFSM_BossUnit135 {
  constructor(unitId = 'BOSS_135') {
    this.unitId = unitId;
    this.state = 'PATROL';
    this.phase = 1;
...
module.exports = EnemyTacticalFSM_BossUnit135;
