/**
 * EnemyTacticalFSM_BossUnit93.js - Hierarchical Finite State Machine for Enemy Bosses
 * Boss Unit ID: 93
 * Part of Aetheria Tactics Engine
 */

class EnemyTacticalFSM_BossUnit93 {
  constructor(unitId = 'BOSS_93') {
    this.unitId = unitId;
    this.state = 'PATROL';
    this.phase = 1;
...
module.exports = EnemyTacticalFSM_BossUnit93;
