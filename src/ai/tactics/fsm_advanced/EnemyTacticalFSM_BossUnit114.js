/**
 * EnemyTacticalFSM_BossUnit114.js - Hierarchical Finite State Machine for Enemy Bosses
 * Boss Unit ID: 114
 * Part of Aetheria Tactics Engine
 */

class EnemyTacticalFSM_BossUnit114 {
  constructor(unitId = 'BOSS_114') {
    this.unitId = unitId;
    this.state = 'PATROL';
    this.phase = 1;
...
module.exports = EnemyTacticalFSM_BossUnit114;
