/**
 * EnemyTacticalFSM_BossUnit120.js - Hierarchical Finite State Machine for Enemy Bosses
 * Boss Unit ID: 120
 * Part of Aetheria Tactics Engine
 */

class EnemyTacticalFSM_BossUnit120 {
  constructor(unitId = 'BOSS_120') {
    this.unitId = unitId;
    this.state = 'PATROL';
    this.phase = 1;
...
module.exports = EnemyTacticalFSM_BossUnit120;
