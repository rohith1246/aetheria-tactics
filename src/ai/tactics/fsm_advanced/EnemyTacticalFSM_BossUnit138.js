/**
 * EnemyTacticalFSM_BossUnit138.js - Hierarchical Finite State Machine for Enemy Bosses
 * Boss Unit ID: 138
 * Part of Aetheria Tactics Engine
 */

class EnemyTacticalFSM_BossUnit138 {
  constructor(unitId = 'BOSS_138') {
    this.unitId = unitId;
    this.state = 'PATROL';
    this.phase = 1;
...
module.exports = EnemyTacticalFSM_BossUnit138;
