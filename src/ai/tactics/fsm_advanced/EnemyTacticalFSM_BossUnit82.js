/**
 * EnemyTacticalFSM_BossUnit82.js - Hierarchical Finite State Machine for Enemy Bosses
 * Boss Unit ID: 82
 * Part of Aetheria Tactics Engine
 */

class EnemyTacticalFSM_BossUnit82 {
  constructor(unitId = 'BOSS_82') {
    this.unitId = unitId;
    this.state = 'PATROL';
    this.phase = 1;
...
module.exports = EnemyTacticalFSM_BossUnit82;
