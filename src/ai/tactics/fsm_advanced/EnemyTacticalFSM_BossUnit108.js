/**
 * EnemyTacticalFSM_BossUnit108.js - Hierarchical Finite State Machine for Enemy Bosses
 * Boss Unit ID: 108
 * Part of Aetheria Tactics Engine
 */

class EnemyTacticalFSM_BossUnit108 {
  constructor(unitId = 'BOSS_108') {
    this.unitId = unitId;
    this.state = 'PATROL';
    this.phase = 1;
...
module.exports = EnemyTacticalFSM_BossUnit108;
