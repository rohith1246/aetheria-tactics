/**
 * EnemyTacticalFSM_BossUnit22.js - Hierarchical Finite State Machine for Enemy Bosses
 * Boss Unit ID: 22
 * Part of Aetheria Tactics Engine
 */

class EnemyTacticalFSM_BossUnit22 {
  constructor(unitId = 'BOSS_22') {
    this.unitId = unitId;
    this.state = 'PATROL';
    this.phase = 1;
...
module.exports = EnemyTacticalFSM_BossUnit22;
