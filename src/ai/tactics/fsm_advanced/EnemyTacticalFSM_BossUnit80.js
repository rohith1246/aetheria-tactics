/**
 * EnemyTacticalFSM_BossUnit80.js - Hierarchical Finite State Machine for Enemy Bosses
 * Boss Unit ID: 80
 * Part of Aetheria Tactics Engine
 */

class EnemyTacticalFSM_BossUnit80 {
  constructor(unitId = 'BOSS_80') {
    this.unitId = unitId;
    this.state = 'PATROL';
    this.phase = 1;
...
module.exports = EnemyTacticalFSM_BossUnit80;
