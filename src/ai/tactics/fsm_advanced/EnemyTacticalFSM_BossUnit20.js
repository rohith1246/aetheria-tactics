/**
 * EnemyTacticalFSM_BossUnit20.js - Hierarchical Finite State Machine for Enemy Bosses
 * Boss Unit ID: 20
 * Part of Aetheria Tactics Engine
 */

class EnemyTacticalFSM_BossUnit20 {
  constructor(unitId = 'BOSS_20') {
    this.unitId = unitId;
    this.state = 'PATROL';
    this.phase = 1;
...
module.exports = EnemyTacticalFSM_BossUnit20;
