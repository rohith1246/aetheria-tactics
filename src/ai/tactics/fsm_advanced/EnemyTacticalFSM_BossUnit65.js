/**
 * EnemyTacticalFSM_BossUnit65.js - Hierarchical Finite State Machine for Enemy Bosses
 * Boss Unit ID: 65
 * Part of Aetheria Tactics Engine
 */

class EnemyTacticalFSM_BossUnit65 {
  constructor(unitId = 'BOSS_65') {
    this.unitId = unitId;
    this.state = 'PATROL';
    this.phase = 1;
...
module.exports = EnemyTacticalFSM_BossUnit65;
