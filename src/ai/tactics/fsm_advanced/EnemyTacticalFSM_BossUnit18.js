/**
 * EnemyTacticalFSM_BossUnit18.js - Hierarchical Finite State Machine for Enemy Bosses
 * Boss Unit ID: 18
 * Part of Aetheria Tactics Engine
 */

class EnemyTacticalFSM_BossUnit18 {
  constructor(unitId = 'BOSS_18') {
    this.unitId = unitId;
    this.state = 'PATROL';
    this.phase = 1;
...
module.exports = EnemyTacticalFSM_BossUnit18;
