/**
 * EnemyTacticalFSM_BossUnit129.js - Hierarchical Finite State Machine for Enemy Bosses
 * Boss Unit ID: 129
 * Part of Aetheria Tactics Engine
 */

class EnemyTacticalFSM_BossUnit129 {
  constructor(unitId = 'BOSS_129') {
    this.unitId = unitId;
    this.state = 'PATROL';
    this.phase = 1;
...
module.exports = EnemyTacticalFSM_BossUnit129;
