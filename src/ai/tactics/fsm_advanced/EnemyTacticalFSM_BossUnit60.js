/**
 * EnemyTacticalFSM_BossUnit60.js - Hierarchical Finite State Machine for Enemy Bosses
 * Boss Unit ID: 60
 * Part of Aetheria Tactics Engine
 */

class EnemyTacticalFSM_BossUnit60 {
  constructor(unitId = 'BOSS_60') {
    this.unitId = unitId;
    this.state = 'PATROL';
    this.phase = 1;
...
module.exports = EnemyTacticalFSM_BossUnit60;
