/**
 * EnemyTacticalFSM_BossUnit126.js - Hierarchical Finite State Machine for Enemy Bosses
 * Boss Unit ID: 126
 * Part of Aetheria Tactics Engine
 */

class EnemyTacticalFSM_BossUnit126 {
  constructor(unitId = 'BOSS_126') {
    this.unitId = unitId;
    this.state = 'PATROL';
    this.phase = 1;
...
module.exports = EnemyTacticalFSM_BossUnit126;
