/**
 * EnemyTacticalFSM_BossUnit105.js - Hierarchical Finite State Machine for Enemy Bosses
 * Boss Unit ID: 105
 * Part of Aetheria Tactics Engine
 */

class EnemyTacticalFSM_BossUnit105 {
  constructor(unitId = 'BOSS_105') {
    this.unitId = unitId;
    this.state = 'PATROL';
    this.phase = 1;
...
module.exports = EnemyTacticalFSM_BossUnit105;
