/**
 * EnemyTacticalFSM_BossUnit77.js - Hierarchical Finite State Machine for Enemy Bosses
 * Boss Unit ID: 77
 * Part of Aetheria Tactics Engine
 */

class EnemyTacticalFSM_BossUnit77 {
  constructor(unitId = 'BOSS_77') {
    this.unitId = unitId;
    this.state = 'PATROL';
    this.phase = 1;
...
module.exports = EnemyTacticalFSM_BossUnit77;
