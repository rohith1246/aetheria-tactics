/**
 * EnemyTacticalFSM_BossUnit51.js - Hierarchical Finite State Machine for Enemy Bosses
 * Boss Unit ID: 51
 * Part of Aetheria Tactics Engine
 */

class EnemyTacticalFSM_BossUnit51 {
  constructor(unitId = 'BOSS_51') {
    this.unitId = unitId;
    this.state = 'PATROL';
    this.phase = 1;
...
module.exports = EnemyTacticalFSM_BossUnit51;
