/**
 * EnemyTacticalFSM_BossUnit76.js - Hierarchical Finite State Machine for Enemy Bosses
 * Boss Unit ID: 76
 * Part of Aetheria Tactics Engine
 */

class EnemyTacticalFSM_BossUnit76 {
  constructor(unitId = 'BOSS_76') {
    this.unitId = unitId;
    this.state = 'PATROL';
    this.phase = 1;
...
module.exports = EnemyTacticalFSM_BossUnit76;
