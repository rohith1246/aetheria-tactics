/**
 * EnemyTacticalFSM_BossUnit30.js - Hierarchical Finite State Machine for Enemy Bosses
 * Boss Unit ID: 30
 * Part of Aetheria Tactics Engine
 */

class EnemyTacticalFSM_BossUnit30 {
  constructor(unitId = 'BOSS_30') {
    this.unitId = unitId;
    this.state = 'PATROL';
    this.phase = 1;
...
module.exports = EnemyTacticalFSM_BossUnit30;
