/**
 * EnemyTacticalFSM_BossUnit15.js - Hierarchical Finite State Machine for Enemy Bosses
 * Boss Unit ID: 15
 * Part of Aetheria Tactics Engine
 */

class EnemyTacticalFSM_BossUnit15 {
  constructor(unitId = 'BOSS_15') {
    this.unitId = unitId;
    this.state = 'PATROL';
    this.phase = 1;
...
module.exports = EnemyTacticalFSM_BossUnit15;
