/**
 * EnemyTacticalFSM_BossUnit125.js - Hierarchical Finite State Machine for Enemy Bosses
 * Boss Unit ID: 125
 * Part of Aetheria Tactics Engine
 */

class EnemyTacticalFSM_BossUnit125 {
  constructor(unitId = 'BOSS_125') {
    this.unitId = unitId;
    this.state = 'PATROL';
    this.phase = 1;
...
module.exports = EnemyTacticalFSM_BossUnit125;
