/**
 * EnemyTacticalFSM_BossUnit127.js - Hierarchical Finite State Machine for Enemy Bosses
 * Boss Unit ID: 127
 * Part of Aetheria Tactics Engine
 */

class EnemyTacticalFSM_BossUnit127 {
  constructor(unitId = 'BOSS_127') {
    this.unitId = unitId;
    this.state = 'PATROL';
    this.phase = 1;
...
module.exports = EnemyTacticalFSM_BossUnit127;
