/**
 * EnemyTacticalFSM_BossUnit8.js - Hierarchical Finite State Machine for Enemy Bosses
 * Boss Unit ID: 8
 * Part of Aetheria Tactics Engine
 */

class EnemyTacticalFSM_BossUnit8 {
  constructor(unitId = 'BOSS_8') {
    this.unitId = unitId;
    this.state = 'PATROL';
    this.phase = 1;
...
module.exports = EnemyTacticalFSM_BossUnit8;
