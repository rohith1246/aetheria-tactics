/**
 * EnemyTacticalFSM_BossUnit103.js - Hierarchical Finite State Machine for Enemy Bosses
 * Boss Unit ID: 103
 * Part of Aetheria Tactics Engine
 */

class EnemyTacticalFSM_BossUnit103 {
  constructor(unitId = 'BOSS_103') {
    this.unitId = unitId;
    this.state = 'PATROL';
    this.phase = 1;
...
module.exports = EnemyTacticalFSM_BossUnit103;
