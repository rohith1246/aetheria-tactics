/**
 * EnemyTacticalFSM_BossUnit25.js - Hierarchical Finite State Machine for Enemy Bosses
 * Boss Unit ID: 25
 * Part of Aetheria Tactics Engine
 */

class EnemyTacticalFSM_BossUnit25 {
  constructor(unitId = 'BOSS_25') {
    this.unitId = unitId;
    this.state = 'PATROL';
    this.phase = 1;
...
module.exports = EnemyTacticalFSM_BossUnit25;
