/**
 * EnemyTacticalFSM_BossUnit52.js - Hierarchical Finite State Machine for Enemy Bosses
 * Boss Unit ID: 52
 * Part of Aetheria Tactics Engine
 */

class EnemyTacticalFSM_BossUnit52 {
  constructor(unitId = 'BOSS_52') {
    this.unitId = unitId;
    this.state = 'PATROL';
    this.phase = 1;
...
module.exports = EnemyTacticalFSM_BossUnit52;
