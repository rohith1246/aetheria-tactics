/**
 * EnemyTacticalFSM_BossUnit124.js - Hierarchical Finite State Machine for Enemy Bosses
 * Boss Unit ID: 124
 * Part of Aetheria Tactics Engine
 */

class EnemyTacticalFSM_BossUnit124 {
  constructor(unitId = 'BOSS_124') {
    this.unitId = unitId;
    this.state = 'PATROL';
    this.phase = 1;
...
module.exports = EnemyTacticalFSM_BossUnit124;
