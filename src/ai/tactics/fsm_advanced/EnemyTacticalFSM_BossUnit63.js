/**
 * EnemyTacticalFSM_BossUnit63.js - Hierarchical Finite State Machine for Enemy Bosses
 * Boss Unit ID: 63
 * Part of Aetheria Tactics Engine
 */

class EnemyTacticalFSM_BossUnit63 {
  constructor(unitId = 'BOSS_63') {
    this.unitId = unitId;
    this.state = 'PATROL';
    this.phase = 1;
...
module.exports = EnemyTacticalFSM_BossUnit63;
