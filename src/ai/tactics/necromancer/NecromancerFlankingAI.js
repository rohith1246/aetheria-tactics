/**
 * NecromancerFlankingAI.js
 * Tactical Decision-Making Engine for Necromancer units utilizing Flanking logic.
 */

class NecromancerFlankingAI {
  constructor(unit, blackboard) {
    this.unit = unit;
    this.blackboard = blackboard;
    this.tacticName = 'Flanking';
    this.aggressionScore = 1.3000000000000003;
...
module.exports = { NecromancerFlankingAI };
