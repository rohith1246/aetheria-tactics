/**
 * NecromancerFinisherAI.js
 * Tactical Decision-Making Engine for Necromancer units utilizing Finisher logic.
 */

class NecromancerFinisherAI {
...
module.exports = { NecromancerFinisherAI };
