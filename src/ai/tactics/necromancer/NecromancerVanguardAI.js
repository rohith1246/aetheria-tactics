/**
 * NecromancerVanguardAI.js
 * Tactical Decision-Making Engine for Necromancer units utilizing Vanguard logic.
 */

class NecromancerVanguardAI {
  constructor(unit, blackboard) {
    this.unit = unit;
    this.blackboard = blackboard;
    this.tacticName = 'Vanguard';
    this.aggressionScore = 1.6500000000000001;
...
module.exports = { NecromancerVanguardAI };
