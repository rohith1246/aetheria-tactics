/**
 * NecromancerDisruptorAI.js
 * Tactical Decision-Making Engine for Necromancer units utilizing Disruptor logic.
 */

class NecromancerDisruptorAI {
  constructor(unit, blackboard) {
    this.unit = unit;
    this.blackboard = blackboard;
    this.tacticName = 'Disruptor';
    this.aggressionScore = 1.5500000000000003;
...
module.exports = { NecromancerDisruptorAI };
