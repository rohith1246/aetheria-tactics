/**
 * NecromancerZoneControlAI.js
 * Tactical Decision-Making Engine for Necromancer units utilizing ZoneControl logic.
 */

class NecromancerZoneControlAI {
  constructor(unit, blackboard) {
    this.unit = unit;
    this.blackboard = blackboard;
    this.tacticName = 'ZoneControl';
    this.aggressionScore = 1.5000000000000002;
...
module.exports = { NecromancerZoneControlAI };
