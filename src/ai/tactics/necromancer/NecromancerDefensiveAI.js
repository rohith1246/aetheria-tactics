/**
 * NecromancerDefensiveAI.js
 * Tactical Decision-Making Engine for Necromancer units utilizing Defensive logic.
 */

class NecromancerDefensiveAI {
  constructor(unit, blackboard) {
    this.unit = unit;
    this.blackboard = blackboard;
    this.tacticName = 'Defensive';
    this.aggressionScore = 1.2500000000000002;
...
module.exports = { NecromancerDefensiveAI };
