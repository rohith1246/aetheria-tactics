/**
 * NecromancerSupportAI.js
 * Tactical Decision-Making Engine for Necromancer units utilizing Support logic.
 */

class NecromancerSupportAI {
  constructor(unit, blackboard) {
    this.unit = unit;
    this.blackboard = blackboard;
    this.tacticName = 'Support';
    this.aggressionScore = 1.4500000000000002;
...
module.exports = { NecromancerSupportAI };
