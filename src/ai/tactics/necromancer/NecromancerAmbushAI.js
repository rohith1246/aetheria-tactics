/**
 * NecromancerAmbushAI.js
 * Tactical Decision-Making Engine for Necromancer units utilizing Ambush logic.
 */

class NecromancerAmbushAI {
...
module.exports = { NecromancerAmbushAI };
