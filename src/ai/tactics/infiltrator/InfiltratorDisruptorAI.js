/**
 * InfiltratorDisruptorAI.js
 * Tactical Decision-Making Engine for Infiltrator units utilizing Disruptor logic.
 */

class InfiltratorDisruptorAI {
  constructor(unit, blackboard) {
    this.unit = unit;
    this.blackboard = blackboard;
    this.tacticName = 'Disruptor';
    this.aggressionScore = 1.05;
...
module.exports = { InfiltratorDisruptorAI };
