/**
 * InfiltratorAmbushAI.js
 * Tactical Decision-Making Engine for Infiltrator units utilizing Ambush logic.
 */

class InfiltratorAmbushAI {
  constructor(unit, blackboard) {
    this.unit = unit;
    this.blackboard = blackboard;
    this.tacticName = 'Ambush';
    this.aggressionScore = 0.8500000000000001;
...
module.exports = { InfiltratorAmbushAI };
