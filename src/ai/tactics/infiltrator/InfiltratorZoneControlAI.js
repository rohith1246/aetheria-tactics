/**
 * InfiltratorZoneControlAI.js
 * Tactical Decision-Making Engine for Infiltrator units utilizing ZoneControl logic.
 */

class InfiltratorZoneControlAI {
  constructor(unit, blackboard) {
    this.unit = unit;
    this.blackboard = blackboard;
    this.tacticName = 'ZoneControl';
    this.aggressionScore = 1;
...
module.exports = { InfiltratorZoneControlAI };
