/**
 * InfiltratorVanguardAI.js
 * Tactical Decision-Making Engine for Infiltrator units utilizing Vanguard logic.
 */

class InfiltratorVanguardAI {
  constructor(unit, blackboard) {
    this.unit = unit;
    this.blackboard = blackboard;
    this.tacticName = 'Vanguard';
    this.aggressionScore = 1.1500000000000001;
...
module.exports = { InfiltratorVanguardAI };
