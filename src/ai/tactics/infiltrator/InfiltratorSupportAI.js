/**
 * InfiltratorSupportAI.js
 * Tactical Decision-Making Engine for Infiltrator units utilizing Support logic.
 */

class InfiltratorSupportAI {
  constructor(unit, blackboard) {
    this.unit = unit;
    this.blackboard = blackboard;
    this.tacticName = 'Support';
    this.aggressionScore = 0.9500000000000001;
...
module.exports = { InfiltratorSupportAI };
