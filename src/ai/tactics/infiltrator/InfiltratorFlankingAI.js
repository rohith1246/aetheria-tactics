/**
 * InfiltratorFlankingAI.js
 * Tactical Decision-Making Engine for Infiltrator units utilizing Flanking logic.
 */

class InfiltratorFlankingAI {
  constructor(unit, blackboard) {
    this.unit = unit;
    this.blackboard = blackboard;
    this.tacticName = 'Flanking';
    this.aggressionScore = 0.8;
...
module.exports = { InfiltratorFlankingAI };
