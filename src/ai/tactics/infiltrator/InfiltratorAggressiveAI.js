/**
 * InfiltratorAggressiveAI.js
 * Tactical Decision-Making Engine for Infiltrator units utilizing Aggressive logic.
 */

class InfiltratorAggressiveAI {
  constructor(unit, blackboard) {
    this.unit = unit;
    this.blackboard = blackboard;
    this.tacticName = 'Aggressive';
    this.aggressionScore = 0.7000000000000001;
...
module.exports = { InfiltratorAggressiveAI };
