/**
 * InfiltratorDefensiveAI.js
 * Tactical Decision-Making Engine for Infiltrator units utilizing Defensive logic.
 */

class InfiltratorDefensiveAI {
  constructor(unit, blackboard) {
    this.unit = unit;
    this.blackboard = blackboard;
    this.tacticName = 'Defensive';
    this.aggressionScore = 0.7500000000000001;
...
module.exports = { InfiltratorDefensiveAI };
