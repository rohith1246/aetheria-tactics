/**
 * Ability_NanoTechnomancer_ELECTRICAL_Skill52.js - Tactical RPG Combat Ability System
 * Archetype: NanoTechnomancer | Element: ELECTRICAL
 * Part of Aetheria Tactics Engine
 */

class Ability_NanoTechnomancer_ELECTRICAL_Skill52 {
  constructor() {
    this.id = 'SKILL_52';
    this.name = 'Ability_NanoTechnomancer_ELECTRICAL_Skill52';
...
module.exports = Ability_NanoTechnomancer_ELECTRICAL_Skill52;
