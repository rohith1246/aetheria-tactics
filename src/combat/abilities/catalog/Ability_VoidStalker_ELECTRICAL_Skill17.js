/**
 * Ability_VoidStalker_ELECTRICAL_Skill17.js - Tactical RPG Combat Ability System
 * Archetype: VoidStalker | Element: ELECTRICAL
 * Part of Aetheria Tactics Engine
 */

class Ability_VoidStalker_ELECTRICAL_Skill17 {
  constructor() {
    this.id = 'SKILL_17';
    this.name = 'Ability_VoidStalker_ELECTRICAL_Skill17';
...
module.exports = Ability_VoidStalker_ELECTRICAL_Skill17;
