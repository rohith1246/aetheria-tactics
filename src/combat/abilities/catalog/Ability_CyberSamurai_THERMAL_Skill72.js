/**
 * Ability_CyberSamurai_THERMAL_Skill72.js - Tactical RPG Combat Ability System
 * Archetype: CyberSamurai | Element: THERMAL
 * Part of Aetheria Tactics Engine
 */

class Ability_CyberSamurai_THERMAL_Skill72 {
  constructor() {
    this.id = 'SKILL_72';
    this.name = 'Ability_CyberSamurai_THERMAL_Skill72';
...
module.exports = Ability_CyberSamurai_THERMAL_Skill72;
