/**
 * Ability_BioMage_THERMAL_Skill58.js - Tactical RPG Combat Ability System
 * Archetype: BioMage | Element: THERMAL
 * Part of Aetheria Tactics Engine
 */

class Ability_BioMage_THERMAL_Skill58 {
  constructor() {
    this.id = 'SKILL_58';
    this.name = 'Ability_BioMage_THERMAL_Skill58';
...
module.exports = Ability_BioMage_THERMAL_Skill58;
