/**
 * Ability_BioMage_THERMAL_Skill114.js - Tactical RPG Combat Ability System
 * Archetype: BioMage | Element: THERMAL
 * Part of Aetheria Tactics Engine
 */

class Ability_BioMage_THERMAL_Skill114 {
  constructor() {
    this.id = 'SKILL_114';
    this.name = 'Ability_BioMage_THERMAL_Skill114';
...
module.exports = Ability_BioMage_THERMAL_Skill114;
