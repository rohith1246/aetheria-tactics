/**
 * Ability_ChronoWarden_VOID_Skill13.js - Tactical RPG Combat Ability System
 * Archetype: ChronoWarden | Element: VOID
 * Part of Aetheria Tactics Engine
 */

class Ability_ChronoWarden_VOID_Skill13 {
  constructor() {
    this.id = 'SKILL_13';
    this.name = 'Ability_ChronoWarden_VOID_Skill13';
...
module.exports = Ability_ChronoWarden_VOID_Skill13;
