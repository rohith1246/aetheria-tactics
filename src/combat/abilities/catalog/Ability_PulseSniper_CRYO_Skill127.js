/**
 * Ability_PulseSniper_CRYO_Skill127.js - Tactical RPG Combat Ability System
 * Archetype: PulseSniper | Element: CRYO
 * Part of Aetheria Tactics Engine
 */

class Ability_PulseSniper_CRYO_Skill127 {
  constructor() {
    this.id = 'SKILL_127';
    this.name = 'Ability_PulseSniper_CRYO_Skill127';
...
module.exports = Ability_PulseSniper_CRYO_Skill127;
