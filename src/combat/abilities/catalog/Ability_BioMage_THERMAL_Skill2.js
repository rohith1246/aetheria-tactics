/**
 * Ability_BioMage_THERMAL_Skill2.js - Tactical RPG Combat Ability System
 * Archetype: BioMage | Element: THERMAL
 * Part of Aetheria Tactics Engine
 */

class Ability_BioMage_THERMAL_Skill2 {
  constructor() {
    this.id = 'SKILL_2';
    this.name = 'Ability_BioMage_THERMAL_Skill2';
...
module.exports = Ability_BioMage_THERMAL_Skill2;
