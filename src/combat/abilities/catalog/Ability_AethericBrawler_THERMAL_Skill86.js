/**
 * Ability_AethericBrawler_THERMAL_Skill86.js - Tactical RPG Combat Ability System
 * Archetype: AethericBrawler | Element: THERMAL
 * Part of Aetheria Tactics Engine
 */

class Ability_AethericBrawler_THERMAL_Skill86 {
  constructor() {
    this.id = 'SKILL_86';
    this.name = 'Ability_AethericBrawler_THERMAL_Skill86';
...
module.exports = Ability_AethericBrawler_THERMAL_Skill86;
