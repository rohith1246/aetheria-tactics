/**
 * Ability_NanoTechnomancer_VOID_Skill20.js - Tactical RPG Combat Ability System
 * Archetype: NanoTechnomancer | Element: VOID
 * Part of Aetheria Tactics Engine
 */

class Ability_NanoTechnomancer_VOID_Skill20 {
  constructor() {
    this.id = 'SKILL_20';
    this.name = 'Ability_NanoTechnomancer_VOID_Skill20';
...
module.exports = Ability_NanoTechnomancer_VOID_Skill20;
