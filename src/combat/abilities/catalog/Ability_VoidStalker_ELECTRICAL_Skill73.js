/**
 * Ability_VoidStalker_ELECTRICAL_Skill73.js - Tactical RPG Combat Ability System
 * Archetype: VoidStalker | Element: ELECTRICAL
 * Part of Aetheria Tactics Engine
 */

class Ability_VoidStalker_ELECTRICAL_Skill73 {
  constructor() {
    this.id = 'SKILL_73';
    this.name = 'Ability_VoidStalker_ELECTRICAL_Skill73';
    this.archetype = 'VoidStalker';
    this.element = 'ELECTRICAL';
    this.apCost = 2;
    this.basePower = 445;
    this.critChance = 0.23;
    this.rangeTiles = 2;
...
module.exports = Ability_VoidStalker_ELECTRICAL_Skill73;
