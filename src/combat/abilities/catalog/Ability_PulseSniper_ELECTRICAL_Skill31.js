/**
 * Ability_PulseSniper_ELECTRICAL_Skill31.js - Tactical RPG Combat Ability System
 * Archetype: PulseSniper | Element: ELECTRICAL
 * Part of Aetheria Tactics Engine
 */

class Ability_PulseSniper_ELECTRICAL_Skill31 {
  constructor() {
    this.id = 'SKILL_31';
    this.name = 'Ability_PulseSniper_ELECTRICAL_Skill31';
    this.archetype = 'PulseSniper';
    this.element = 'ELECTRICAL';
    this.apCost = 4;
    this.basePower = 235;
    this.critChance = 0.21;
    this.rangeTiles = 2;
...
module.exports = Ability_PulseSniper_ELECTRICAL_Skill31;
