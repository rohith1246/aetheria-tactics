/**
 * Ability_PlasmaTrooper_VOID_Skill139.js - Tactical RPG Combat Ability System
 * Archetype: PlasmaTrooper | Element: VOID
 * Part of Aetheria Tactics Engine
 */

class Ability_PlasmaTrooper_VOID_Skill139 {
  constructor() {
    this.id = 'SKILL_139';
    this.name = 'Ability_PlasmaTrooper_VOID_Skill139';
...
module.exports = Ability_PlasmaTrooper_VOID_Skill139;
