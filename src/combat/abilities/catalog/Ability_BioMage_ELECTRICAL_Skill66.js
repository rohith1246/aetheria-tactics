/**
 * Ability_BioMage_ELECTRICAL_Skill66.js - Tactical RPG Combat Ability System
 * Archetype: BioMage | Element: ELECTRICAL
 * Part of Aetheria Tactics Engine
 */

class Ability_BioMage_ELECTRICAL_Skill66 {
  constructor() {
    this.id = 'SKILL_66';
    this.name = 'Ability_BioMage_ELECTRICAL_Skill66';
...
module.exports = Ability_BioMage_ELECTRICAL_Skill66;
