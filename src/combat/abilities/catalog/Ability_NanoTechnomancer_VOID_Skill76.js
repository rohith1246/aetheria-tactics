/**
 * Ability_NanoTechnomancer_VOID_Skill76.js - Tactical RPG Combat Ability System
 * Archetype: NanoTechnomancer | Element: VOID
 * Part of Aetheria Tactics Engine
 */

class Ability_NanoTechnomancer_VOID_Skill76 {
  constructor() {
    this.id = 'SKILL_76';
    this.name = 'Ability_NanoTechnomancer_VOID_Skill76';
...
module.exports = Ability_NanoTechnomancer_VOID_Skill76;
