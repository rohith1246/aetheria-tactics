/**
 * Ability_ChronoWarden_VOID_Skill125.js - Tactical RPG Combat Ability System
 * Archetype: ChronoWarden | Element: VOID
 * Part of Aetheria Tactics Engine
 */

class Ability_ChronoWarden_VOID_Skill125 {
  constructor() {
    this.id = 'SKILL_125';
    this.name = 'Ability_ChronoWarden_VOID_Skill125';
...
module.exports = Ability_ChronoWarden_VOID_Skill125;
