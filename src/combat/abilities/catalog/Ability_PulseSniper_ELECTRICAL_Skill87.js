/**
 * Ability_PulseSniper_ELECTRICAL_Skill87.js - Tactical RPG Combat Ability System
 * Archetype: PulseSniper | Element: ELECTRICAL
 * Part of Aetheria Tactics Engine
 */

class Ability_PulseSniper_ELECTRICAL_Skill87 {
  constructor() {
    this.id = 'SKILL_87';
    this.name = 'Ability_PulseSniper_ELECTRICAL_Skill87';
    this.archetype = 'PulseSniper';
    this.element = 'ELECTRICAL';
    this.apCost = 4;
    this.basePower = 515;
    this.critChance = 0.17;
    this.rangeTiles = 4;
...
module.exports = Ability_PulseSniper_ELECTRICAL_Skill87;
