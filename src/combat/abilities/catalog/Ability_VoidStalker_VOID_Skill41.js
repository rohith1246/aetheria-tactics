/**
 * Ability_VoidStalker_VOID_Skill41.js - Tactical RPG Combat Ability System
 * Archetype: VoidStalker | Element: VOID
 * Part of Aetheria Tactics Engine
 */

class Ability_VoidStalker_VOID_Skill41 {
  constructor() {
    this.id = 'SKILL_41';
    this.name = 'Ability_VoidStalker_VOID_Skill41';
...
module.exports = Ability_VoidStalker_VOID_Skill41;
