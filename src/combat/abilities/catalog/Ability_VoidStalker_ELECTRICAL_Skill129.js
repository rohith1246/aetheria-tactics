/**
 * Ability_VoidStalker_ELECTRICAL_Skill129.js - Tactical RPG Combat Ability System
 * Archetype: VoidStalker | Element: ELECTRICAL
 * Part of Aetheria Tactics Engine
 */

class Ability_VoidStalker_ELECTRICAL_Skill129 {
  constructor() {
    this.id = 'SKILL_129';
    this.name = 'Ability_VoidStalker_ELECTRICAL_Skill129';
...
module.exports = Ability_VoidStalker_ELECTRICAL_Skill129;
