/**
 * Ability_AethericBrawler_CRYO_Skill78.js - Tactical RPG Combat Ability System
 * Archetype: AethericBrawler | Element: CRYO
 * Part of Aetheria Tactics Engine
 */

class Ability_AethericBrawler_CRYO_Skill78 {
  constructor() {
    this.id = 'SKILL_78';
    this.name = 'Ability_AethericBrawler_CRYO_Skill78';
...
module.exports = Ability_AethericBrawler_CRYO_Skill78;
