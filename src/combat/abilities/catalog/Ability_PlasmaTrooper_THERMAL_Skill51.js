/**
 * Ability_PlasmaTrooper_THERMAL_Skill51.js - Tactical RPG Combat Ability System
 * Archetype: PlasmaTrooper | Element: THERMAL
 * Part of Aetheria Tactics Engine
 */

class Ability_PlasmaTrooper_THERMAL_Skill51 {
  constructor() {
    this.id = 'SKILL_51';
    this.name = 'Ability_PlasmaTrooper_THERMAL_Skill51';
...
module.exports = Ability_PlasmaTrooper_THERMAL_Skill51;
