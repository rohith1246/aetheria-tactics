/**
 * Ability_AethericBrawler_PLASMA_Skill126.js - Tactical RPG Combat Ability System
 * Archetype: AethericBrawler | Element: PLASMA
 * Part of Aetheria Tactics Engine
 */

class Ability_AethericBrawler_PLASMA_Skill126 {
  constructor() {
    this.id = 'SKILL_126';
    this.name = 'Ability_AethericBrawler_PLASMA_Skill126';
...
module.exports = Ability_AethericBrawler_PLASMA_Skill126;
