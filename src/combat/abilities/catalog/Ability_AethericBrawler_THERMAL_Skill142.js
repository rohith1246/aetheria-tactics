/**
 * Ability_AethericBrawler_THERMAL_Skill142.js - Tactical RPG Combat Ability System
 * Archetype: AethericBrawler | Element: THERMAL
 * Part of Aetheria Tactics Engine
 */

class Ability_AethericBrawler_THERMAL_Skill142 {
  constructor() {
    this.id = 'SKILL_142';
    this.name = 'Ability_AethericBrawler_THERMAL_Skill142';
...
module.exports = Ability_AethericBrawler_THERMAL_Skill142;
