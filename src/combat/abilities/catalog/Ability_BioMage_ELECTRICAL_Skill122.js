/**
 * Ability_BioMage_ELECTRICAL_Skill122.js - Tactical RPG Combat Ability System
 * Archetype: BioMage | Element: ELECTRICAL
 * Part of Aetheria Tactics Engine
 */

class Ability_BioMage_ELECTRICAL_Skill122 {
  constructor() {
    this.id = 'SKILL_122';
    this.name = 'Ability_BioMage_ELECTRICAL_Skill122';
    this.archetype = 'BioMage';
...
module.exports = Ability_BioMage_ELECTRICAL_Skill122;
