/**
 * Ability_VoidStalker_CRYO_Skill113.js - Tactical RPG Combat Ability System
 * Archetype: VoidStalker | Element: CRYO
 * Part of Aetheria Tactics Engine
 */

class Ability_VoidStalker_CRYO_Skill113 {
  constructor() {
    this.id = 'SKILL_113';
    this.name = 'Ability_VoidStalker_CRYO_Skill113';
...
module.exports = Ability_VoidStalker_CRYO_Skill113;
