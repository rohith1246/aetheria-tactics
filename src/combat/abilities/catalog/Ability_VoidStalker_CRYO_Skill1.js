/**
 * Ability_VoidStalker_CRYO_Skill1.js - Tactical RPG Combat Ability System
 * Archetype: VoidStalker | Element: CRYO
 * Part of Aetheria Tactics Engine
 */

class Ability_VoidStalker_CRYO_Skill1 {
  constructor() {
    this.id = 'SKILL_1';
    this.name = 'Ability_VoidStalker_CRYO_Skill1';
...
module.exports = Ability_VoidStalker_CRYO_Skill1;
