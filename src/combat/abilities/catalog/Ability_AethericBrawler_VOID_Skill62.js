/**
 * Ability_AethericBrawler_VOID_Skill62.js - Tactical RPG Combat Ability System
 * Archetype: AethericBrawler | Element: VOID
 * Part of Aetheria Tactics Engine
 */

class Ability_AethericBrawler_VOID_Skill62 {
  constructor() {
    this.id = 'SKILL_62';
    this.name = 'Ability_AethericBrawler_VOID_Skill62';
...
module.exports = Ability_AethericBrawler_VOID_Skill62;
