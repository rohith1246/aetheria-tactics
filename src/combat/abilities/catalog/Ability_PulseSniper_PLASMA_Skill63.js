/**
 * Ability_PulseSniper_PLASMA_Skill63.js - Tactical RPG Combat Ability System
 * Archetype: PulseSniper | Element: PLASMA
 * Part of Aetheria Tactics Engine
 */

class Ability_PulseSniper_PLASMA_Skill63 {
  constructor() {
    this.id = 'SKILL_63';
    this.name = 'Ability_PulseSniper_PLASMA_Skill63';
...
module.exports = Ability_PulseSniper_PLASMA_Skill63;
