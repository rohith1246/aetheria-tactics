/**
 * Ability_AethericBrawler_CORROSIVE_Skill102.js - Tactical RPG Combat Ability System
 * Archetype: AethericBrawler | Element: CORROSIVE
 * Part of Aetheria Tactics Engine
 */

class Ability_AethericBrawler_CORROSIVE_Skill102 {
  constructor() {
    this.id = 'SKILL_102';
    this.name = 'Ability_AethericBrawler_CORROSIVE_Skill102';
...
module.exports = Ability_AethericBrawler_CORROSIVE_Skill102;
