/**
 * Ability_NanoTechnomancer_THERMAL_Skill44.js - Tactical RPG Combat Ability System
 * Archetype: NanoTechnomancer | Element: THERMAL
 * Part of Aetheria Tactics Engine
 */

class Ability_NanoTechnomancer_THERMAL_Skill44 {
  constructor() {
    this.id = 'SKILL_44';
    this.name = 'Ability_NanoTechnomancer_THERMAL_Skill44';
...
module.exports = Ability_NanoTechnomancer_THERMAL_Skill44;
