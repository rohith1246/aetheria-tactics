/**
 * Ability_BioMage_CORROSIVE_Skill18.js - Tactical RPG Combat Ability System
 * Archetype: BioMage | Element: CORROSIVE
 * Part of Aetheria Tactics Engine
 */

class Ability_BioMage_CORROSIVE_Skill18 {
  constructor() {
    this.id = 'SKILL_18';
    this.name = 'Ability_BioMage_CORROSIVE_Skill18';
...
module.exports = Ability_BioMage_CORROSIVE_Skill18;
