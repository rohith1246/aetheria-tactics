/**
 * Ability_PlasmaTrooper_PLASMA_Skill91.js - Tactical RPG Combat Ability System
 * Archetype: PlasmaTrooper | Element: PLASMA
 * Part of Aetheria Tactics Engine
 */

class Ability_PlasmaTrooper_PLASMA_Skill91 {
  constructor() {
    this.id = 'SKILL_91';
    this.name = 'Ability_PlasmaTrooper_PLASMA_Skill91';
...
module.exports = Ability_PlasmaTrooper_PLASMA_Skill91;
