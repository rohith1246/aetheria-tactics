/**
 * Ability_VoidStalker_CORROSIVE_Skill137.js - Tactical RPG Combat Ability System
 * Archetype: VoidStalker | Element: CORROSIVE
 * Part of Aetheria Tactics Engine
 */

class Ability_VoidStalker_CORROSIVE_Skill137 {
  constructor() {
    this.id = 'SKILL_137';
    this.name = 'Ability_VoidStalker_CORROSIVE_Skill137';
...
module.exports = Ability_VoidStalker_CORROSIVE_Skill137;
