/**
 * Ability_VoidStalker_THERMAL_Skill9.js - Tactical RPG Combat Ability System
 * Archetype: VoidStalker | Element: THERMAL
 * Part of Aetheria Tactics Engine
 */

class Ability_VoidStalker_THERMAL_Skill9 {
  constructor() {
    this.id = 'SKILL_9';
    this.name = 'Ability_VoidStalker_THERMAL_Skill9';
...
module.exports = Ability_VoidStalker_THERMAL_Skill9;
