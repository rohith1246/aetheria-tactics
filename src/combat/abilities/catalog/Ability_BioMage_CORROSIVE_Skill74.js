/**
 * Ability_BioMage_CORROSIVE_Skill74.js - Tactical RPG Combat Ability System
 * Archetype: BioMage | Element: CORROSIVE
 * Part of Aetheria Tactics Engine
 */

class Ability_BioMage_CORROSIVE_Skill74 {
  constructor() {
    this.id = 'SKILL_74';
    this.name = 'Ability_BioMage_CORROSIVE_Skill74';
...
module.exports = Ability_BioMage_CORROSIVE_Skill74;
