/**
 * Ability_PlasmaTrooper_VOID_Skill27.js - Tactical RPG Combat Ability System
 * Archetype: PlasmaTrooper | Element: VOID
 * Part of Aetheria Tactics Engine
 */

class Ability_PlasmaTrooper_VOID_Skill27 {
  constructor() {
    this.id = 'SKILL_27';
    this.name = 'Ability_PlasmaTrooper_VOID_Skill27';
...
module.exports = Ability_PlasmaTrooper_VOID_Skill27;
