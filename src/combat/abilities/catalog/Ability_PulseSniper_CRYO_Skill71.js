/**
 * Ability_PulseSniper_CRYO_Skill71.js - Tactical RPG Combat Ability System
 * Archetype: PulseSniper | Element: CRYO
 * Part of Aetheria Tactics Engine
 */

class Ability_PulseSniper_CRYO_Skill71 {
  constructor() {
    this.id = 'SKILL_71';
    this.name = 'Ability_PulseSniper_CRYO_Skill71';
...
module.exports = Ability_PulseSniper_CRYO_Skill71;
