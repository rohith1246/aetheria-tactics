/**
 * Ability_PulseSniper_THERMAL_Skill23.js - Tactical RPG Combat Ability System
 * Archetype: PulseSniper | Element: THERMAL
 * Part of Aetheria Tactics Engine
 */

class Ability_PulseSniper_THERMAL_Skill23 {
  constructor() {
    this.id = 'SKILL_23';
    this.name = 'Ability_PulseSniper_THERMAL_Skill23';
...
module.exports = Ability_PulseSniper_THERMAL_Skill23;
