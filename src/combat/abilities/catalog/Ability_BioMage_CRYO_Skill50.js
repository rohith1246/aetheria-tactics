/**
 * Ability_BioMage_CRYO_Skill50.js - Tactical RPG Combat Ability System
 * Archetype: BioMage | Element: CRYO
 * Part of Aetheria Tactics Engine
 */

class Ability_BioMage_CRYO_Skill50 {
  constructor() {
    this.id = 'SKILL_50';
    this.name = 'Ability_BioMage_CRYO_Skill50';
...
module.exports = Ability_BioMage_CRYO_Skill50;
