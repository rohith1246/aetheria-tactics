/**
 * Ability_BioMage_ELECTRICAL_Skill10.js - Tactical RPG Combat Ability System
 * Archetype: BioMage | Element: ELECTRICAL
 * Part of Aetheria Tactics Engine
 */

class Ability_BioMage_ELECTRICAL_Skill10 {
  constructor() {
    this.id = 'SKILL_10';
    this.name = 'Ability_BioMage_ELECTRICAL_Skill10';
...
module.exports = Ability_BioMage_ELECTRICAL_Skill10;
