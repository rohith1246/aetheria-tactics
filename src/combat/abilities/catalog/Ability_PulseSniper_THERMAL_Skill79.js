/**
 * Ability_PulseSniper_THERMAL_Skill79.js - Tactical RPG Combat Ability System
 * Archetype: PulseSniper | Element: THERMAL
 * Part of Aetheria Tactics Engine
 */

class Ability_PulseSniper_THERMAL_Skill79 {
  constructor() {
    this.id = 'SKILL_79';
    this.name = 'Ability_PulseSniper_THERMAL_Skill79';
...
module.exports = Ability_PulseSniper_THERMAL_Skill79;
