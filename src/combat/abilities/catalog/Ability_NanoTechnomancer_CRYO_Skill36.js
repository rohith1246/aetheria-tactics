/**
 * Ability_NanoTechnomancer_CRYO_Skill36.js - Tactical RPG Combat Ability System
 * Archetype: NanoTechnomancer | Element: CRYO
 * Part of Aetheria Tactics Engine
 */

class Ability_NanoTechnomancer_CRYO_Skill36 {
  constructor() {
    this.id = 'SKILL_36';
    this.name = 'Ability_NanoTechnomancer_CRYO_Skill36';
...
module.exports = Ability_NanoTechnomancer_CRYO_Skill36;
