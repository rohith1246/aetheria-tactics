/**
 * Ability_ChronoWarden_THERMAL_Skill93.js - Tactical RPG Combat Ability System
 * Archetype: ChronoWarden | Element: THERMAL
 * Part of Aetheria Tactics Engine
 */

class Ability_ChronoWarden_THERMAL_Skill93 {
  constructor() {
    this.id = 'SKILL_93';
    this.name = 'Ability_ChronoWarden_THERMAL_Skill93';
...
module.exports = Ability_ChronoWarden_THERMAL_Skill93;
