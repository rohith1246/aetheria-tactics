/**
 * Ability_CyberSamurai_ELECTRICAL_Skill136.js - Tactical RPG Combat Ability System
 * Archetype: CyberSamurai | Element: ELECTRICAL
 * Part of Aetheria Tactics Engine
 */

class Ability_CyberSamurai_ELECTRICAL_Skill136 {
  constructor() {
    this.id = 'SKILL_136';
    this.name = 'Ability_CyberSamurai_ELECTRICAL_Skill136';
    this.archetype = 'CyberSamurai';
    this.element = 'ELECTRICAL';
    this.apCost = 1;
    this.basePower = 760;
    this.critChance = 0.26;
    this.rangeTiles = 5;
...
module.exports = Ability_CyberSamurai_ELECTRICAL_Skill136;
