/**
 * Ability_BioMage_PLASMA_Skill98.js - Tactical RPG Combat Ability System
 * Archetype: BioMage | Element: PLASMA
 * Part of Aetheria Tactics Engine
 */

class Ability_BioMage_PLASMA_Skill98 {
  constructor() {
    this.id = 'SKILL_98';
    this.name = 'Ability_BioMage_PLASMA_Skill98';
...
module.exports = Ability_BioMage_PLASMA_Skill98;
