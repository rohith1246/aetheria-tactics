/**
 * Ability_VoidStalker_CORROSIVE_Skill81.js - Tactical RPG Combat Ability System
 * Archetype: VoidStalker | Element: CORROSIVE
 * Part of Aetheria Tactics Engine
 */

class Ability_VoidStalker_CORROSIVE_Skill81 {
  constructor() {
    this.id = 'SKILL_81';
    this.name = 'Ability_VoidStalker_CORROSIVE_Skill81';
...
module.exports = Ability_VoidStalker_CORROSIVE_Skill81;
