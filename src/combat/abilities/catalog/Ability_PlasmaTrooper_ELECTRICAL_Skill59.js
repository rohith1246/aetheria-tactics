/**
 * Ability_PlasmaTrooper_ELECTRICAL_Skill59.js - Tactical RPG Combat Ability System
 * Archetype: PlasmaTrooper | Element: ELECTRICAL
 * Part of Aetheria Tactics Engine
 */

class Ability_PlasmaTrooper_ELECTRICAL_Skill59 {
  constructor() {
    this.id = 'SKILL_59';
    this.name = 'Ability_PlasmaTrooper_ELECTRICAL_Skill59';
    this.archetype = 'PlasmaTrooper';
    this.element = 'ELECTRICAL';
    this.apCost = 4;
    this.basePower = 375;
    this.critChance = 0.29;
    this.rangeTiles = 6;
...
module.exports = Ability_PlasmaTrooper_ELECTRICAL_Skill59;
