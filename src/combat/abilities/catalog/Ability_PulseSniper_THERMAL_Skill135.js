/**
 * Ability_PulseSniper_THERMAL_Skill135.js - Tactical RPG Combat Ability System
 * Archetype: PulseSniper | Element: THERMAL
 * Part of Aetheria Tactics Engine
 */

class Ability_PulseSniper_THERMAL_Skill135 {
  constructor() {
    this.id = 'SKILL_135';
    this.name = 'Ability_PulseSniper_THERMAL_Skill135';
...
module.exports = Ability_PulseSniper_THERMAL_Skill135;
