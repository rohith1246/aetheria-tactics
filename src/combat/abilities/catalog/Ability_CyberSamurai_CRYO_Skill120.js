/**
 * Ability_CyberSamurai_CRYO_Skill120.js - Tactical RPG Combat Ability System
 * Archetype: CyberSamurai | Element: CRYO
 * Part of Aetheria Tactics Engine
 */

class Ability_CyberSamurai_CRYO_Skill120 {
  constructor() {
    this.id = 'SKILL_120';
    this.name = 'Ability_CyberSamurai_CRYO_Skill120';
...
module.exports = Ability_CyberSamurai_CRYO_Skill120;
