/**
 * Ability_AethericBrawler_VOID_Skill118.js - Tactical RPG Combat Ability System
 * Archetype: AethericBrawler | Element: VOID
 * Part of Aetheria Tactics Engine
 */

class Ability_AethericBrawler_VOID_Skill118 {
  constructor() {
    this.id = 'SKILL_118';
    this.name = 'Ability_AethericBrawler_VOID_Skill118';
...
module.exports = Ability_AethericBrawler_VOID_Skill118;
