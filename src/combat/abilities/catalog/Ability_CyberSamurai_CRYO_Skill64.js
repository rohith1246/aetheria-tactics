/**
 * Ability_CyberSamurai_CRYO_Skill64.js - Tactical RPG Combat Ability System
 * Archetype: CyberSamurai | Element: CRYO
 * Part of Aetheria Tactics Engine
 */

class Ability_CyberSamurai_CRYO_Skill64 {
  constructor() {
    this.id = 'SKILL_64';
    this.name = 'Ability_CyberSamurai_CRYO_Skill64';
...
module.exports = Ability_CyberSamurai_CRYO_Skill64;
