/**
 * Ability_BioMage_CORROSIVE_Skill130.js - Tactical RPG Combat Ability System
 * Archetype: BioMage | Element: CORROSIVE
 * Part of Aetheria Tactics Engine
 */

class Ability_BioMage_CORROSIVE_Skill130 {
  constructor() {
    this.id = 'SKILL_130';
    this.name = 'Ability_BioMage_CORROSIVE_Skill130';
...
module.exports = Ability_BioMage_CORROSIVE_Skill130;
