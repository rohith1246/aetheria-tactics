/**
 * Ability_NanoTechnomancer_CRYO_Skill148.js - Tactical RPG Combat Ability System
 * Archetype: NanoTechnomancer | Element: CRYO
 * Part of Aetheria Tactics Engine
 */

class Ability_NanoTechnomancer_CRYO_Skill148 {
  constructor() {
    this.id = 'SKILL_148';
    this.name = 'Ability_NanoTechnomancer_CRYO_Skill148';
...
module.exports = Ability_NanoTechnomancer_CRYO_Skill148;
