/**
 * Ability_VoidStalker_THERMAL_Skill65.js - Tactical RPG Combat Ability System
 * Archetype: VoidStalker | Element: THERMAL
 * Part of Aetheria Tactics Engine
 */

class Ability_VoidStalker_THERMAL_Skill65 {
  constructor() {
    this.id = 'SKILL_65';
    this.name = 'Ability_VoidStalker_THERMAL_Skill65';
...
module.exports = Ability_VoidStalker_THERMAL_Skill65;
