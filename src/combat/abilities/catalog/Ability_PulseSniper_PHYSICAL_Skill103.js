/**
 * Ability_PulseSniper_PHYSICAL_Skill103.js - Tactical RPG Combat Ability System
 * Archetype: PulseSniper | Element: PHYSICAL
 * Part of Aetheria Tactics Engine
 */

class Ability_PulseSniper_PHYSICAL_Skill103 {
  constructor() {
    this.id = 'SKILL_103';
    this.name = 'Ability_PulseSniper_PHYSICAL_Skill103';
...
module.exports = Ability_PulseSniper_PHYSICAL_Skill103;
