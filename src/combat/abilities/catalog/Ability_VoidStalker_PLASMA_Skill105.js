/**
 * Ability_VoidStalker_PLASMA_Skill105.js - Tactical RPG Combat Ability System
 * Archetype: VoidStalker | Element: PLASMA
 * Part of Aetheria Tactics Engine
 */

class Ability_VoidStalker_PLASMA_Skill105 {
  constructor() {
    this.id = 'SKILL_105';
    this.name = 'Ability_VoidStalker_PLASMA_Skill105';
...
module.exports = Ability_VoidStalker_PLASMA_Skill105;
