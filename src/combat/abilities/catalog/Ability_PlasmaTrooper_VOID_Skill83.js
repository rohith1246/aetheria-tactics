/**
 * Ability_PlasmaTrooper_VOID_Skill83.js - Tactical RPG Combat Ability System
 * Archetype: PlasmaTrooper | Element: VOID
 * Part of Aetheria Tactics Engine
 */

class Ability_PlasmaTrooper_VOID_Skill83 {
  constructor() {
    this.id = 'SKILL_83';
    this.name = 'Ability_PlasmaTrooper_VOID_Skill83';
...
module.exports = Ability_PlasmaTrooper_VOID_Skill83;
