/**
 * Ability_AethericBrawler_CRYO_Skill134.js - Tactical RPG Combat Ability System
 * Archetype: AethericBrawler | Element: CRYO
 * Part of Aetheria Tactics Engine
 */

class Ability_AethericBrawler_CRYO_Skill134 {
  constructor() {
    this.id = 'SKILL_134';
    this.name = 'Ability_AethericBrawler_CRYO_Skill134';
...
module.exports = Ability_AethericBrawler_CRYO_Skill134;
