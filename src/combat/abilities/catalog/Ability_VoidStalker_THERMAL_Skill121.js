/**
 * Ability_VoidStalker_THERMAL_Skill121.js - Tactical RPG Combat Ability System
 * Archetype: VoidStalker | Element: THERMAL
 * Part of Aetheria Tactics Engine
 */

class Ability_VoidStalker_THERMAL_Skill121 {
  constructor() {
    this.id = 'SKILL_121';
    this.name = 'Ability_VoidStalker_THERMAL_Skill121';
...
module.exports = Ability_VoidStalker_THERMAL_Skill121;
