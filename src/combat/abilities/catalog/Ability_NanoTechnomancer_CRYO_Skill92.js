/**
 * Ability_NanoTechnomancer_CRYO_Skill92.js - Tactical RPG Combat Ability System
 * Archetype: NanoTechnomancer | Element: CRYO
 * Part of Aetheria Tactics Engine
 */

class Ability_NanoTechnomancer_CRYO_Skill92 {
  constructor() {
    this.id = 'SKILL_92';
    this.name = 'Ability_NanoTechnomancer_CRYO_Skill92';
...
module.exports = Ability_NanoTechnomancer_CRYO_Skill92;
