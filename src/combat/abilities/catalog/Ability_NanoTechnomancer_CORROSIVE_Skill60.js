/**
 * Ability_NanoTechnomancer_CORROSIVE_Skill60.js - Tactical RPG Combat Ability System
 * Archetype: NanoTechnomancer | Element: CORROSIVE
 * Part of Aetheria Tactics Engine
 */

class Ability_NanoTechnomancer_CORROSIVE_Skill60 {
  constructor() {
    this.id = 'SKILL_60';
    this.name = 'Ability_NanoTechnomancer_CORROSIVE_Skill60';
...
module.exports = Ability_NanoTechnomancer_CORROSIVE_Skill60;
