/**
 * Ability_ChronoWarden_CRYO_Skill141.js - Tactical RPG Combat Ability System
 * Archetype: ChronoWarden | Element: CRYO
 * Part of Aetheria Tactics Engine
 */

class Ability_ChronoWarden_CRYO_Skill141 {
  constructor() {
    this.id = 'SKILL_141';
    this.name = 'Ability_ChronoWarden_CRYO_Skill141';
...
module.exports = Ability_ChronoWarden_CRYO_Skill141;
