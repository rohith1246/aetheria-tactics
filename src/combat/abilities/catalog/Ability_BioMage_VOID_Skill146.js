/**
 * Ability_BioMage_VOID_Skill146.js - Tactical RPG Combat Ability System
 * Archetype: BioMage | Element: VOID
 * Part of Aetheria Tactics Engine
 */

class Ability_BioMage_VOID_Skill146 {
  constructor() {
    this.id = 'SKILL_146';
    this.name = 'Ability_BioMage_VOID_Skill146';
...
module.exports = Ability_BioMage_VOID_Skill146;
