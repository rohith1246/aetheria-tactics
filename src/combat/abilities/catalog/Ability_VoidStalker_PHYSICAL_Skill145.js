/**
 * Ability_VoidStalker_PHYSICAL_Skill145.js - Tactical RPG Combat Ability System
 * Archetype: VoidStalker | Element: PHYSICAL
 * Part of Aetheria Tactics Engine
 */

class Ability_VoidStalker_PHYSICAL_Skill145 {
  constructor() {
    this.id = 'SKILL_145';
    this.name = 'Ability_VoidStalker_PHYSICAL_Skill145';
...
module.exports = Ability_VoidStalker_PHYSICAL_Skill145;
