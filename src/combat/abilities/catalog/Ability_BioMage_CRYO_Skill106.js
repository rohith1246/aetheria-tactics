/**
 * Ability_BioMage_CRYO_Skill106.js - Tactical RPG Combat Ability System
 * Archetype: BioMage | Element: CRYO
 * Part of Aetheria Tactics Engine
 */

class Ability_BioMage_CRYO_Skill106 {
  constructor() {
    this.id = 'SKILL_106';
    this.name = 'Ability_BioMage_CRYO_Skill106';
...
module.exports = Ability_BioMage_CRYO_Skill106;
