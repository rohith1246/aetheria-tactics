/**
 * Ability_BioMage_VOID_Skill90.js - Tactical RPG Combat Ability System
 * Archetype: BioMage | Element: VOID
 * Part of Aetheria Tactics Engine
 */

class Ability_BioMage_VOID_Skill90 {
  constructor() {
    this.id = 'SKILL_90';
    this.name = 'Ability_BioMage_VOID_Skill90';
...
module.exports = Ability_BioMage_VOID_Skill90;
