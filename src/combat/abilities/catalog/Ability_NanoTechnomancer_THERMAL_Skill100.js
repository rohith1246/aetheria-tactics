/**
 * Ability_NanoTechnomancer_THERMAL_Skill100.js - Tactical RPG Combat Ability System
 * Archetype: NanoTechnomancer | Element: THERMAL
 * Part of Aetheria Tactics Engine
 */

class Ability_NanoTechnomancer_THERMAL_Skill100 {
  constructor() {
    this.id = 'SKILL_100';
    this.name = 'Ability_NanoTechnomancer_THERMAL_Skill100';
...
module.exports = Ability_NanoTechnomancer_THERMAL_Skill100;
