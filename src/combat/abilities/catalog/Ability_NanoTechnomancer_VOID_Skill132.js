/**
 * Ability_NanoTechnomancer_VOID_Skill132.js - Tactical RPG Combat Ability System
 * Archetype: NanoTechnomancer | Element: VOID
 * Part of Aetheria Tactics Engine
 */

class Ability_NanoTechnomancer_VOID_Skill132 {
  constructor() {
    this.id = 'SKILL_132';
    this.name = 'Ability_NanoTechnomancer_VOID_Skill132';
...
module.exports = Ability_NanoTechnomancer_VOID_Skill132;
