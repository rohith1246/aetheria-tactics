/**
 * Ability_VoidStalker_CORROSIVE_Skill25.js - Tactical RPG Combat Ability System
 * Archetype: VoidStalker | Element: CORROSIVE
 * Part of Aetheria Tactics Engine
 */

class Ability_VoidStalker_CORROSIVE_Skill25 {
  constructor() {
    this.id = 'SKILL_25';
    this.name = 'Ability_VoidStalker_CORROSIVE_Skill25';
...
module.exports = Ability_VoidStalker_CORROSIVE_Skill25;
