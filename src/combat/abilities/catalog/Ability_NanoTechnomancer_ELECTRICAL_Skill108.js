/**
 * Ability_NanoTechnomancer_ELECTRICAL_Skill108.js - Tactical RPG Combat Ability System
 * Archetype: NanoTechnomancer | Element: ELECTRICAL
 * Part of Aetheria Tactics Engine
 */

class Ability_NanoTechnomancer_ELECTRICAL_Skill108 {
  constructor() {
    this.id = 'SKILL_108';
    this.name = 'Ability_NanoTechnomancer_ELECTRICAL_Skill108';
    this.archetype = 'NanoTechnomancer';
    this.element = 'ELECTRICAL';
    this.apCost = 1;
    this.basePower = 620;
...
module.exports = Ability_NanoTechnomancer_ELECTRICAL_Skill108;
