/**
 * Ability_PulseSniper_CRYO_Skill15.js - Tactical RPG Combat Ability System
 * Archetype: PulseSniper | Element: CRYO
 * Part of Aetheria Tactics Engine
 */

class Ability_PulseSniper_CRYO_Skill15 {
  constructor() {
    this.id = 'SKILL_15';
    this.name = 'Ability_PulseSniper_CRYO_Skill15';
...
module.exports = Ability_PulseSniper_CRYO_Skill15;
