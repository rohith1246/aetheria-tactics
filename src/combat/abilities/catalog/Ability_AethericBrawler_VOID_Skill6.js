/**
 * Ability_AethericBrawler_VOID_Skill6.js - Tactical RPG Combat Ability System
 * Archetype: AethericBrawler | Element: VOID
 * Part of Aetheria Tactics Engine
 */

class Ability_AethericBrawler_VOID_Skill6 {
  constructor() {
    this.id = 'SKILL_6';
    this.name = 'Ability_AethericBrawler_VOID_Skill6';
...
module.exports = Ability_AethericBrawler_VOID_Skill6;
