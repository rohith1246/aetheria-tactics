/**
 * NecromancyRayAbility.js
 * School: necromancy | Form: Ray
 * Tactical Combat Ability Engine Specification
 */

class NecromancyRayAbility {
  constructor(config = {}) {
    this.id = 'ability_necromancy_ray';
    this.name = 'NecromancyRay';
    ...
    this.statusEffectId = 'status_necromancy_ray';
...
module.exports = { NecromancyRayAbility };
