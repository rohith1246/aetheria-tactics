/**
 * NecromancyEchoAbility.js
 * School: necromancy | Form: Echo
 * Tactical Combat Ability Engine Specification
 */

class NecromancyEchoAbility {
  constructor(config = {}) {
    this.id = 'ability_necromancy_echo';
    this.name = 'NecromancyEcho';
    ...
    this.statusEffectId = 'status_necromancy_echo';
...
module.exports = { NecromancyEchoAbility };
