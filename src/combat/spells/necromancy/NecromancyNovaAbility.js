/**
 * NecromancyNovaAbility.js
 * School: necromancy | Form: Nova
 * Tactical Combat Ability Engine Specification
 */

class NecromancyNovaAbility {
  constructor(config = {}) {
    this.id = 'ability_necromancy_nova';
    this.name = 'NecromancyNova';
...
module.exports = { NecromancyNovaAbility };
