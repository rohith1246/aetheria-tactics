/**
 * NecromancyBlastAbility.js
 * School: necromancy | Form: Blast
 * Tactical Combat Ability Engine Specification
 */

class NecromancyBlastAbility {
  constructor(config = {}) {
    this.id = 'ability_necromancy_blast';
    this.name = 'NecromancyBlast';
...
module.exports = { NecromancyBlastAbility };
