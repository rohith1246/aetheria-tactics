/**
 * NecromancyRiftAbility.js
 * School: necromancy | Form: Rift
 * Tactical Combat Ability Engine Specification
 */

class NecromancyRiftAbility {
  constructor(config = {}) {
    this.id = 'ability_necromancy_rift';
    ...
    this.statusEffectId = 'status_necromancy_rift';
...
module.exports = { NecromancyRiftAbility };
