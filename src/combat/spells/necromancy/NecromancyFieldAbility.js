/**
 * NecromancyFieldAbility.js
 * School: necromancy | Form: Field
 * Tactical Combat Ability Engine Specification
 */

class NecromancyFieldAbility {
  constructor(config = {}) {
    this.id = 'ability_necromancy_field';
    ...
    this.statusEffectId = 'status_necromancy_field';
...
module.exports = { NecromancyFieldAbility };
