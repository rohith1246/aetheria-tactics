/**
 * NecromancyAuraAbility.js
 * School: necromancy | Form: Aura
 * Tactical Combat Ability Engine Specification
 */

class NecromancyAuraAbility {
  constructor(config = {}) {
    this.id = 'ability_necromancy_aura';
    this.name = 'NecromancyAura';
    ...
    this.statusEffectId = 'status_necromancy_aura';
...
module.exports = { NecromancyAuraAbility };
