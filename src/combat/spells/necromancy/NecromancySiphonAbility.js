/**
 * NecromancySiphonAbility.js
 * School: necromancy | Form: Siphon
 * Tactical Combat Ability Engine Specification
 */

class NecromancySiphonAbility {
  constructor(config = {}) {
    this.id = 'ability_necromancy_siphon';
    this.name = 'NecromancySiphon';
...
module.exports = { NecromancySiphonAbility };
