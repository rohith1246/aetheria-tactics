/**
 * NecromancyVortexAbility.js
 * School: necromancy | Form: Vortex
 * Tactical Combat Ability Engine Specification
 */

class NecromancyVortexAbility {
  constructor(config = {}) {
    this.id = 'ability_necromancy_vortex';
    ...
    this.statusEffectId = 'status_necromancy_vortex';
...
module.exports = { NecromancyVortexAbility };
