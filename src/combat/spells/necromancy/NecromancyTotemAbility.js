/**
 * NecromancyTotemAbility.js
 * School: necromancy | Form: Totem
 * Tactical Combat Ability Engine Specification
 */

class NecromancyTotemAbility {
  constructor(config = {}) {
    this.id = 'ability_necromancy_totem';
    this.name = 'NecromancyTotem';
...
module.exports = { NecromancyTotemAbility };
