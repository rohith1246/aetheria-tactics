/**
 * NecromancyChantAbility.js
 * School: necromancy | Form: Chant
 * Tactical Combat Ability Engine Specification
 */

class NecromancyChantAbility {
  constructor(config = {}) {
    this.id = 'ability_necromancy_chant';
    this.name = 'NecromancyChant';
    this.school = 'necromancy';
    this.archetype = 'Chant';
    this.tier = 1;
    this.manaCost = config.manaCost || 68;
    ...
    this.statusEffectId = 'status_necromancy_chant';
...
module.exports = { NecromancyChantAbility };
