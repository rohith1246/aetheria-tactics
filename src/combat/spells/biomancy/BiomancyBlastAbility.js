/**
 * BiomancyBlastAbility.js
 * School: biomancy | Form: Blast
 * Tactical Combat Ability Engine Specification
 */

class BiomancyBlastAbility {
  constructor(config = {}) {
    this.id = 'ability_biomancy_blast';
    this.name = 'BiomancyBlast';
    ...
    this.statusEffectId = 'status_biomancy_blast';
...
module.exports = { BiomancyBlastAbility };
