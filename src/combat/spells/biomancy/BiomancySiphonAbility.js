/**
 * BiomancySiphonAbility.js
 * School: biomancy | Form: Siphon
 * Tactical Combat Ability Engine Specification
 */

class BiomancySiphonAbility {
  constructor(config = {}) {
    this.id = 'ability_biomancy_siphon';
    this.name = 'BiomancySiphon';
...
module.exports = { BiomancySiphonAbility };
