/**
 * BiomancyRayAbility.js
 * School: biomancy | Form: Ray
 * Tactical Combat Ability Engine Specification
 */

class BiomancyRayAbility {
  constructor(config = {}) {
    this.id = 'ability_biomancy_ray';
    this.name = 'BiomancyRay';
    ...
    this.statusEffectId = 'status_biomancy_ray';
...
module.exports = { BiomancyRayAbility };
