/**
 * BiomancyInfusionAbility.js
 * School: biomancy | Form: Infusion
 * Tactical Combat Ability Engine Specification
 */

class BiomancyInfusionAbility {
  constructor(config = {}) {
    this.id = 'ability_biomancy_infusion';
    this.name = 'BiomancyInfusion';
...
module.exports = { BiomancyInfusionAbility };
