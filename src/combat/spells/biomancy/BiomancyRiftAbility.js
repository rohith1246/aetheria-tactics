/**
 * BiomancyRiftAbility.js
 * School: biomancy | Form: Rift
 * Tactical Combat Ability Engine Specification
 */

class BiomancyRiftAbility {
  constructor(config = {}) {
    this.id = 'ability_biomancy_rift';
    this.name = 'BiomancyRift';
    ...
    this.statusEffectId = 'status_biomancy_rift';
...
module.exports = { BiomancyRiftAbility };
