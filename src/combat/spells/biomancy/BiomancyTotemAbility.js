/**
 * BiomancyTotemAbility.js
 * School: biomancy | Form: Totem
 * Tactical Combat Ability Engine Specification
 */

class BiomancyTotemAbility {
  constructor(config = {}) {
    this.id = 'ability_biomancy_totem';
    this.name = 'BiomancyTotem';
    ...
    this.statusEffectId = 'status_biomancy_totem';
...
module.exports = { BiomancyTotemAbility };
