/**
 * BiomancyBarrierAbility.js
 * School: biomancy | Form: Barrier
 * Tactical Combat Ability Engine Specification
 */

class BiomancyBarrierAbility {
  constructor(config = {}) {
    this.id = 'ability_biomancy_barrier';
    this.name = 'BiomancyBarrier';
...
module.exports = { BiomancyBarrierAbility };
