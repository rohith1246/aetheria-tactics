/**
 * BiomancyFieldAbility.js
 * School: biomancy | Form: Field
 * Tactical Combat Ability Engine Specification
 */

class BiomancyFieldAbility {
  constructor(config = {}) {
    this.id = 'ability_biomancy_field';
    this.name = 'BiomancyField';
    ...
    this.statusEffectId = 'status_biomancy_field';
...
module.exports = { BiomancyFieldAbility };
