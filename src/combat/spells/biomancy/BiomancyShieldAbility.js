/**
 * BiomancyShieldAbility.js
 * School: biomancy | Form: Shield
 * Tactical Combat Ability Engine Specification
 */

class BiomancyShieldAbility {
  constructor(config = {}) {
    this.id = 'ability_biomancy_shield';
    this.name = 'BiomancyShield';
    ...
    this.statusEffectId = 'status_biomancy_shield';
...
module.exports = { BiomancyShieldAbility };
