/**
 * BiomancyChantAbility.js
 * School: biomancy | Form: Chant
 * Tactical Combat Ability Engine Specification
 */

class BiomancyChantAbility {
  constructor(config = {}) {
    this.id = 'ability_biomancy_chant';
    this.name = 'BiomancyChant';
    this.school = 'biomancy';
    this.archetype = 'Chant';
    this.tier = 1;
    this.manaCost = config.manaCost || 88;
    ...
    this.statusEffectId = 'status_biomancy_chant';
...
module.exports = { BiomancyChantAbility };
