/**
 * BiomancyAuraAbility.js
 * School: biomancy | Form: Aura
 * Tactical Combat Ability Engine Specification
 */

class BiomancyAuraAbility {
  constructor(config = {}) {
    this.id = 'ability_biomancy_aura';
    this.name = 'BiomancyAura';
    ...
    this.statusEffectId = 'status_biomancy_aura';
...
module.exports = { BiomancyAuraAbility };
