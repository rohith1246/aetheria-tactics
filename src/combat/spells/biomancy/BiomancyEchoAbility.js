/**
 * BiomancyEchoAbility.js
 * School: biomancy | Form: Echo
 * Tactical Combat Ability Engine Specification
 */

class BiomancyEchoAbility {
  constructor(config = {}) {
    this.id = 'ability_biomancy_echo';
    this.name = 'BiomancyEcho';
    ...
    this.statusEffectId = 'status_biomancy_echo';
...
module.exports = { BiomancyEchoAbility };
