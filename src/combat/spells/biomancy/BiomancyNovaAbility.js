/**
 * BiomancyNovaAbility.js
 * School: biomancy | Form: Nova
 * Tactical Combat Ability Engine Specification
 */

class BiomancyNovaAbility {
  constructor(config = {}) {
    this.id = 'ability_biomancy_nova';
    ...
    this.statusEffectId = 'status_biomancy_nova';
...
module.exports = { BiomancyNovaAbility };
