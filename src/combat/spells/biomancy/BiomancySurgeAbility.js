/**
 * BiomancySurgeAbility.js
 * School: biomancy | Form: Surge
 * Tactical Combat Ability Engine Specification
 */

class BiomancySurgeAbility {
  constructor(config = {}) {
    this.id = 'ability_biomancy_surge';
    this.name = 'BiomancySurge';
    this.school = 'biomancy';
    this.archetype = 'Surge';
    this.tier = 2;
    this.manaCost = config.manaCost || 55;
    ...
    this.statusEffectId = 'status_biomancy_surge';
...
module.exports = { BiomancySurgeAbility };
