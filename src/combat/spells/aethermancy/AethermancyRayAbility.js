/**
 * AethermancyRayAbility.js
 * School: aethermancy | Form: Ray
 * Tactical Combat Ability Engine Specification
 */

class AethermancyRayAbility {
  constructor(config = {}) {
    this.id = 'ability_aethermancy_ray';
    this.name = 'AethermancyRay';
    this.school = 'aethermancy';
    this.archetype = 'Ray';
    this.tier = 3;
    this.manaCost = config.manaCost || 82;
    ...
    this.statusEffectId = 'status_aethermancy_ray';
...
module.exports = { AethermancyRayAbility };
