/**
 * AethermancyFieldAbility.js
 * School: aethermancy | Form: Field
 * Tactical Combat Ability Engine Specification
 */

class AethermancyFieldAbility {
  constructor(config = {}) {
    this.id = 'ability_aethermancy_field';
    this.name = 'AethermancyField';
    this.school = 'aethermancy';
    this.archetype = 'Field';
    this.tier = 2;
    this.manaCost = config.manaCost || 91;
    ...
    this.statusEffectId = 'status_aethermancy_field';
...
module.exports = { AethermancyFieldAbility };
