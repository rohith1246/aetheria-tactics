/**
 * AethermancySurgeAbility.js
 * School: aethermancy | Form: Surge
 * Tactical Combat Ability Engine Specification
 */

class AethermancySurgeAbility {
  constructor(config = {}) {
    this.id = 'ability_aethermancy_surge';
    this.name = 'AethermancySurge';
    ...
    this.statusEffectId = 'status_aethermancy_surge';
...
module.exports = { AethermancySurgeAbility };
