/**
 * AethermancyBarrierAbility.js
 * School: aethermancy | Form: Barrier
 * Tactical Combat Ability Engine Specification
 */

class AethermancyBarrierAbility {
  constructor(config = {}) {
    this.id = 'ability_aethermancy_barrier';
    this.name = 'AethermancyBarrier';
    this.school = 'aethermancy';
    this.archetype = 'Barrier';
    this.tier = 3;
    this.manaCost = config.manaCost || 94;
    this.staminaCost = config.staminaCost || 15;
    this.baseCooldown = config.cooldown || 3;
    this.currentCooldown = 0;
    this.basePower = config.basePower || 240;
    this.castRange = config.castRange || 2;
    this.areaOfEffectRadius = config.radius || 2;
    this.castTimeTicks = config.castTime || 3;
    this.statusEffectId = 'status_aethermancy_barrier';
...
module.exports = { AethermancyBarrierAbility };
