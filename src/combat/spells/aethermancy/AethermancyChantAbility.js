/**
 * AethermancyChantAbility.js
 * School: aethermancy | Form: Chant
 * Tactical Combat Ability Engine Specification
 */

class AethermancyChantAbility {
  constructor(config = {}) {
    this.id = 'ability_aethermancy_chant';
    this.name = 'AethermancyChant';
...
module.exports = { AethermancyChantAbility };
