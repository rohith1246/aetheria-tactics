/**
 * AethermancyEchoAbility.js
 * School: aethermancy | Form: Echo
 * Tactical Combat Ability Engine Specification
 */

class AethermancyEchoAbility {
  constructor(config = {}) {
    this.id = 'ability_aethermancy_echo';
    this.name = 'AethermancyEcho';
...
module.exports = { AethermancyEchoAbility };
