/**
 * AethermancyInfusionAbility.js
 * School: aethermancy | Form: Infusion
 * Tactical Combat Ability Engine Specification
 */

class AethermancyInfusionAbility {
  constructor(config = {}) {
    this.id = 'ability_aethermancy_infusion';
    this.name = 'AethermancyInfusion';
    ...
    this.statusEffectId = 'status_aethermancy_infusion';
...
module.exports = { AethermancyInfusionAbility };
