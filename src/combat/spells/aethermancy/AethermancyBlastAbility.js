/**
 * AethermancyBlastAbility.js
 * School: aethermancy | Form: Blast
 * Tactical Combat Ability Engine Specification
 */

class AethermancyBlastAbility {
  constructor(config = {}) {
    this.id = 'ability_aethermancy_blast';
    this.name = 'AethermancyBlast';
    ...
    this.statusEffectId = 'status_aethermancy_blast';
...
module.exports = { AethermancyBlastAbility };
