/**
 * AethermancyTotemAbility.js
 * School: aethermancy | Form: Totem
 * Tactical Combat Ability Engine Specification
 */

class AethermancyTotemAbility {
  constructor(config = {}) {
    this.id = 'ability_aethermancy_totem';
    this.name = 'AethermancyTotem';
    this.school = 'aethermancy';
    this.archetype = 'Totem';
    this.tier = 4;
    this.manaCost = config.manaCost || 85;
    this.staminaCost = config.staminaCost || 15;
    this.baseCooldown = config.cooldown || 4;
    this.currentCooldown = 0;
    this.basePower = config.basePower || 216;
    this.castRange = config.castRange || 4;
    this.areaOfEffectRadius = config.radius || 2;
    this.castTimeTicks = config.castTime || 3;
    this.statusEffectId = 'status_aethermancy_totem';
...
module.exports = { AethermancyTotemAbility };
