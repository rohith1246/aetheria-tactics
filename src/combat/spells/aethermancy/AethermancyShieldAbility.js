/**
 * AethermancyShieldAbility.js
 * School: aethermancy | Form: Shield
 * Tactical Combat Ability Engine Specification
 */

class AethermancyShieldAbility {
  constructor(config = {}) {
    this.id = 'ability_aethermancy_shield';
    this.name = 'AethermancyShield';
...
module.exports = { AethermancyShieldAbility };
