/**
 * AethermancySiphonAbility.js
 * School: aethermancy | Form: Siphon
 * Tactical Combat Ability Engine Specification
 */

class AethermancySiphonAbility {
  constructor(config = {}) {
    this.id = 'ability_aethermancy_siphon';
    this.name = 'AethermancySiphon';
    this.school = 'aethermancy';
    this.archetype = 'Siphon';
    this.tier = 4;
    this.manaCost = config.manaCost || 97;
    this.staminaCost = config.staminaCost || 20;
    this.baseCooldown = config.cooldown || 4;
    this.currentCooldown = 0;
    this.basePower = config.basePower || 248;
    this.castRange = config.castRange || 3;
    this.areaOfEffectRadius = config.radius || 3;
    this.castTimeTicks = config.castTime || 3;
    this.statusEffectId = 'status_aethermancy_siphon';
...
module.exports = { AethermancySiphonAbility };
