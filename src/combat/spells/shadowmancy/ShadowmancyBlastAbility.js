/**
 * ShadowmancyBlastAbility.js
 * School: shadowmancy | Form: Blast
 * Tactical Combat Ability Engine Specification
 */

class ShadowmancyBlastAbility {
  constructor(config = {}) {
    this.id = 'ability_shadowmancy_blast';
    this.name = 'ShadowmancyBlast';
    ...
    this.statusEffectId = 'status_shadowmancy_blast';
...
module.exports = { ShadowmancyBlastAbility };
