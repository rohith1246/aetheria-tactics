/**
 * ShadowmancyTotemAbility.js
 * School: shadowmancy | Form: Totem
 * Tactical Combat Ability Engine Specification
 */

class ShadowmancyTotemAbility {
  constructor(config = {}) {
    this.id = 'ability_shadowmancy_totem';
    this.name = 'ShadowmancyTotem';
...
module.exports = { ShadowmancyTotemAbility };
