/**
 * ShadowmancyRayAbility.js
 * School: shadowmancy | Form: Ray
 * Tactical Combat Ability Engine Specification
 */

class ShadowmancyRayAbility {
  constructor(config = {}) {
    this.id = 'ability_shadowmancy_ray';
    this.name = 'ShadowmancyRay';
    ...
    this.statusEffectId = 'status_shadowmancy_ray';
...
module.exports = { ShadowmancyRayAbility };
