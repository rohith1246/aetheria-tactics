/**
 * ShadowmancyShieldAbility.js
 * School: shadowmancy | Form: Shield
 * Tactical Combat Ability Engine Specification
 */

class ShadowmancyShieldAbility {
  constructor(config = {}) {
    this.id = 'ability_shadowmancy_shield';
    this.name = 'ShadowmancyShield';
...
module.exports = { ShadowmancyShieldAbility };
