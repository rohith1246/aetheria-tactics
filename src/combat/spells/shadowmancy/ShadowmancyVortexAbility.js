/**
 * ShadowmancyVortexAbility.js
 * School: shadowmancy | Form: Vortex
 * Tactical Combat Ability Engine Specification
 */

class ShadowmancyVortexAbility {
  constructor(config = {}) {
    this.id = 'ability_shadowmancy_vortex';
    this.name = 'ShadowmancyVortex';
    this.school = 'shadowmancy';
    this.archetype = 'Vortex';
    this.tier = 2;
    this.manaCost = config.manaCost || 83;
    ...
    this.statusEffectId = 'status_shadowmancy_vortex';
...
module.exports = { ShadowmancyVortexAbility };
