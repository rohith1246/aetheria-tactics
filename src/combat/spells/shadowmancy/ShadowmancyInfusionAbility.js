/**
 * ShadowmancyInfusionAbility.js
 * School: shadowmancy | Form: Infusion
 * Tactical Combat Ability Engine Specification
 */

class ShadowmancyInfusionAbility {
  constructor(config = {}) {
    this.id = 'ability_shadowmancy_infusion';
    this.name = 'ShadowmancyInfusion';
...
module.exports = { ShadowmancyInfusionAbility };
