/**
 * ShadowmancyEchoAbility.js
 * School: shadowmancy | Form: Echo
 * Tactical Combat Ability Engine Specification
 */

class ShadowmancyEchoAbility {
  constructor(config = {}) {
    this.id = 'ability_shadowmancy_echo';
    this.name = 'ShadowmancyEcho';
...
module.exports = { ShadowmancyEchoAbility };
