/**
 * ShadowmancyNovaAbility.js
 * School: shadowmancy | Form: Nova
 * Tactical Combat Ability Engine Specification
 */

class ShadowmancyNovaAbility {
  constructor(config = {}) {
    this.id = 'ability_shadowmancy_nova';
    this.name = 'ShadowmancyNova';
    ...
    this.statusEffectId = 'status_shadowmancy_nova';
...
module.exports = { ShadowmancyNovaAbility };
