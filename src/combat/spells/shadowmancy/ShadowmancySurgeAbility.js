/**
 * ShadowmancySurgeAbility.js
 * School: shadowmancy | Form: Surge
 * Tactical Combat Ability Engine Specification
 */

class ShadowmancySurgeAbility {
  constructor(config = {}) {
    this.id = 'ability_shadowmancy_surge';
    this.name = 'ShadowmancySurge';
    this.school = 'shadowmancy';
    this.archetype = 'Surge';
    this.tier = 2;
    this.manaCost = config.manaCost || 71;
    ...
    this.statusEffectId = 'status_shadowmancy_surge';
...
module.exports = { ShadowmancySurgeAbility };
