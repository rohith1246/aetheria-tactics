/**
 * CryomancySiphonAbility.js
 * School: cryomancy | Form: Siphon
 * Tactical Combat Ability Engine Specification
 */

class CryomancySiphonAbility {
  constructor(config = {}) {
    this.id = 'ability_cryomancy_siphon';
    this.name = 'CryomancySiphon';
...
module.exports = { CryomancySiphonAbility };
