/**
 * CryomancyEchoAbility.js
 * School: cryomancy | Form: Echo
 * Tactical Combat Ability Engine Specification
 */

class CryomancyEchoAbility {
  constructor(config = {}) {
    this.id = 'ability_cryomancy_echo';
    this.name = 'CryomancyEcho';
    ...
    this.statusEffectId = 'status_cryomancy_echo';
...
module.exports = { CryomancyEchoAbility };
