/**
 * CryomancyVortexAbility.js
 * School: cryomancy | Form: Vortex
 * Tactical Combat Ability Engine Specification
 */

class CryomancyVortexAbility {
  constructor(config = {}) {
    this.id = 'ability_cryomancy_vortex';
    this.name = 'CryomancyVortex';
    ...
    this.statusEffectId = 'status_cryomancy_vortex';
...
module.exports = { CryomancyVortexAbility };
