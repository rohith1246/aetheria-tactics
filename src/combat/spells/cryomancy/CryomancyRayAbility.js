/**
 * CryomancyRayAbility.js
 * School: cryomancy | Form: Ray
 * Tactical Combat Ability Engine Specification
 */

class CryomancyRayAbility {
  constructor(config = {}) {
    this.id = 'ability_cryomancy_ray';
    this.name = 'CryomancyRay';
    ...
    this.statusEffectId = 'status_cryomancy_ray';
...
module.exports = { CryomancyRayAbility };
