/**
 * CryomancyFieldAbility.js
 * School: cryomancy | Form: Field
 * Tactical Combat Ability Engine Specification
 */

class CryomancyFieldAbility {
  constructor(config = {}) {
    this.id = 'ability_cryomancy_field';
    this.name = 'CryomancyField';
    ...
    this.statusEffectId = 'status_cryomancy_field';
...
module.exports = { CryomancyFieldAbility };
