/**
 * CryomancyInfusionAbility.js
 * School: cryomancy | Form: Infusion
 * Tactical Combat Ability Engine Specification
 */

class CryomancyInfusionAbility {
  constructor(config = {}) {
    this.id = 'ability_cryomancy_infusion';
    this.name = 'CryomancyInfusion';
...
module.exports = { CryomancyInfusionAbility };
