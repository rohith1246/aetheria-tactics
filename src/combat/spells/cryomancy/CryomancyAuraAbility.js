/**
 * CryomancyAuraAbility.js
 * School: cryomancy | Form: Aura
 * Tactical Combat Ability Engine Specification
 */

class CryomancyAuraAbility {
  constructor(config = {}) {
    this.id = 'ability_cryomancy_aura';
    this.name = 'CryomancyAura';
    ...
    this.statusEffectId = 'status_cryomancy_aura';
...
module.exports = { CryomancyAuraAbility };
