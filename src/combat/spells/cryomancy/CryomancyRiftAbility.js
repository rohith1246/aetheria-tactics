/**
 * CryomancyRiftAbility.js
 * School: cryomancy | Form: Rift
 * Tactical Combat Ability Engine Specification
 */

class CryomancyRiftAbility {
  constructor(config = {}) {
    this.id = 'ability_cryomancy_rift';
    this.name = 'CryomancyRift';
    ...
    this.statusEffectId = 'status_cryomancy_rift';
...
module.exports = { CryomancyRiftAbility };
