/**
 * CryomancyChantAbility.js
 * School: cryomancy | Form: Chant
 * Tactical Combat Ability Engine Specification
 */

class CryomancyChantAbility {
  constructor(config = {}) {
    this.id = 'ability_cryomancy_chant';
    this.name = 'CryomancyChant';
    this.school = 'cryomancy';
    this.archetype = 'Chant';
    this.tier = 1;
    this.manaCost = config.manaCost || 60;
    ...
    this.statusEffectId = 'status_cryomancy_chant';
...
module.exports = { CryomancyChantAbility };
