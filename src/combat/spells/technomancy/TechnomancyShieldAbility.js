/**
 * TechnomancyShieldAbility.js
 * School: technomancy | Form: Shield
 * Tactical Combat Ability Engine Specification
 */

class TechnomancyShieldAbility {
  constructor(config = {}) {
    this.id = 'ability_technomancy_shield';
    this.name = 'TechnomancyShield';
...
module.exports = { TechnomancyShieldAbility };
