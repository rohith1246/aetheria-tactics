/**
 * TechnomancyRiftAbility.js
 * School: technomancy | Form: Rift
 * Tactical Combat Ability Engine Specification
 */

class TechnomancyRiftAbility {
  constructor(config = {}) {
    this.id = 'ability_technomancy_rift';
    this.name = 'TechnomancyRift';
...
module.exports = { TechnomancyRiftAbility };
