/**
 * TechnomancyTotemAbility.js
 * School: technomancy | Form: Totem
 * Tactical Combat Ability Engine Specification
 */

class TechnomancyTotemAbility {
  constructor(config = {}) {
    this.id = 'ability_technomancy_totem';
    this.name = 'TechnomancyTotem';
...
module.exports = { TechnomancyTotemAbility };
