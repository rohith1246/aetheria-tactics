/**
 * TechnomancyBlastAbility.js
 * School: technomancy | Form: Blast
 * Tactical Combat Ability Engine Specification
 */

class TechnomancyBlastAbility {
  constructor(config = {}) {
    this.id = 'ability_technomancy_blast';
    this.name = 'TechnomancyBlast';
    ...
    this.statusEffectId = 'status_technomancy_blast';
...
module.exports = { TechnomancyBlastAbility };
