/**
 * TechnomancyVortexAbility.js
 * School: technomancy | Form: Vortex
 * Tactical Combat Ability Engine Specification
 */

class TechnomancyVortexAbility {
  constructor(config = {}) {
    this.id = 'ability_technomancy_vortex';
    this.name = 'TechnomancyVortex';
    ...
    this.statusEffectId = 'status_technomancy_vortex';
...
module.exports = { TechnomancyVortexAbility };
