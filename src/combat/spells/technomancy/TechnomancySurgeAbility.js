/**
 * TechnomancySurgeAbility.js
 * School: technomancy | Form: Surge
 * Tactical Combat Ability Engine Specification
 */

class TechnomancySurgeAbility {
  constructor(config = {}) {
    this.id = 'ability_technomancy_surge';
    ...
    this.statusEffectId = 'status_technomancy_surge';
...
module.exports = { TechnomancySurgeAbility };
