/**
 * TechnomancyInfusionAbility.js
 * School: technomancy | Form: Infusion
 * Tactical Combat Ability Engine Specification
 */

class TechnomancyInfusionAbility {
  constructor(config = {}) {
    this.id = 'ability_technomancy_infusion';
    this.name = 'TechnomancyInfusion';
...
module.exports = { TechnomancyInfusionAbility };
