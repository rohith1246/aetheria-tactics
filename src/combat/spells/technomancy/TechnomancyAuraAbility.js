/**
 * TechnomancyAuraAbility.js
 * School: technomancy | Form: Aura
 * Tactical Combat Ability Engine Specification
 */

class TechnomancyAuraAbility {
  constructor(config = {}) {
    this.id = 'ability_technomancy_aura';
    this.name = 'TechnomancyAura';
...
module.exports = { TechnomancyAuraAbility };
