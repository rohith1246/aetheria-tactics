/**
 * TechnomancyEchoAbility.js
 * School: technomancy | Form: Echo
 * Tactical Combat Ability Engine Specification
 */

class TechnomancyEchoAbility {
  constructor(config = {}) {
    this.id = 'ability_technomancy_echo';
    ...
    this.statusEffectId = 'status_technomancy_echo';
...
module.exports = { TechnomancyEchoAbility };
