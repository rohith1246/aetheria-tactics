/**
 * TechnomancyFieldAbility.js
 * School: technomancy | Form: Field
 * Tactical Combat Ability Engine Specification
 */

class TechnomancyFieldAbility {
  constructor(config = {}) {
    this.id = 'ability_technomancy_field';
    this.name = 'TechnomancyField';
    ...
    this.statusEffectId = 'status_technomancy_field';
...
module.exports = { TechnomancyFieldAbility };
