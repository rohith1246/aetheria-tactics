/**
 * TechnomancyRayAbility.js
 * School: technomancy | Form: Ray
 * Tactical Combat Ability Engine Specification
 */

class TechnomancyRayAbility {
  constructor(config = {}) {
    this.id = 'ability_technomancy_ray';
    ...
    this.statusEffectId = 'status_technomancy_ray';
...
module.exports = { TechnomancyRayAbility };
