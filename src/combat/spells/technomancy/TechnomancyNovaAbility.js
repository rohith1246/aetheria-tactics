/**
 * TechnomancyNovaAbility.js
 * School: technomancy | Form: Nova
 * Tactical Combat Ability Engine Specification
 */

class TechnomancyNovaAbility {
  constructor(config = {}) {
    this.id = 'ability_technomancy_nova';
    this.name = 'TechnomancyNova';
    ...
    this.statusEffectId = 'status_technomancy_nova';
...
module.exports = { TechnomancyNovaAbility };
