/**
 * PyromancySiphonAbility.js
 * School: pyromancy | Form: Siphon
 * Tactical Combat Ability Engine Specification
 */

class PyromancySiphonAbility {
  constructor(config = {}) {
    this.id = 'ability_pyromancy_siphon';
    this.name = 'PyromancySiphon';
    this.school = 'pyromancy';
    this.archetype = 'Siphon';
    this.tier = 4;
    this.manaCost = config.manaCost || 53;
    this.staminaCost = config.staminaCost || 20;
    this.baseCooldown = config.cooldown || 4;
    this.currentCooldown = 0;
    this.basePower = config.basePower || 138;
    this.castRange = config.castRange || 3;
    this.areaOfEffectRadius = config.radius || 3;
    this.castTimeTicks = config.castTime || 1;
    this.statusEffectId = 'status_pyromancy_siphon';
...
module.exports = { PyromancySiphonAbility };
