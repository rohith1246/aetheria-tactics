/**
 * PyromancyVortexAbility.js
 * School: pyromancy | Form: Vortex
 * Tactical Combat Ability Engine Specification
 */

class PyromancyVortexAbility {
  constructor(config = {}) {
    this.id = 'ability_pyromancy_vortex';
    this.name = 'PyromancyVortex';
    ...
    this.statusEffectId = 'status_pyromancy_vortex';
...
module.exports = { PyromancyVortexAbility };
