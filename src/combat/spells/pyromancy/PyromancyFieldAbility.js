/**
 * PyromancyFieldAbility.js
 * School: pyromancy | Form: Field
 * Tactical Combat Ability Engine Specification
 */

class PyromancyFieldAbility {
  constructor(config = {}) {
    this.id = 'ability_pyromancy_field';
    this.name = 'PyromancyField';
    ...
    this.statusEffectId = 'status_pyromancy_field';
...
module.exports = { PyromancyFieldAbility };
