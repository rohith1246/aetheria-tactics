/**
 * PyromancyRiftAbility.js
 * School: pyromancy | Form: Rift
 * Tactical Combat Ability Engine Specification
 */

class PyromancyRiftAbility {
  constructor(config = {}) {
    this.id = 'ability_pyromancy_rift';
    this.name = 'PyromancyRift';
...
module.exports = { PyromancyRiftAbility };
