/**
 * PyromancyTotemAbility.js
 * School: pyromancy | Form: Totem
 * Tactical Combat Ability Engine Specification
 */

class PyromancyTotemAbility {
  constructor(config = {}) {
    this.id = 'ability_pyromancy_totem';
    this.name = 'PyromancyTotem';
...
module.exports = { PyromancyTotemAbility };
