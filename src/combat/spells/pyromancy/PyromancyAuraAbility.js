/**
 * PyromancyAuraAbility.js
 * School: pyromancy | Form: Aura
 * Tactical Combat Ability Engine Specification
 */

class PyromancyAuraAbility {
  constructor(config = {}) {
    this.id = 'ability_pyromancy_aura';
    this.name = 'PyromancyAura';
    ...
    this.statusEffectId = 'status_pyromancy_aura';
...
module.exports = { PyromancyAuraAbility };
