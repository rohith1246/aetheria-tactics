/**
 * PyromancyRayAbility.js
 * School: pyromancy | Form: Ray
 * Tactical Combat Ability Engine Specification
 */

class PyromancyRayAbility {
  constructor(config = {}) {
    this.id = 'ability_pyromancy_ray';
    this.name = 'PyromancyRay';
    this.school = 'pyromancy';
    this.archetype = 'Ray';
    this.tier = 3;
    this.manaCost = config.manaCost || 38;
    ...
    this.statusEffectId = 'status_pyromancy_ray';
...
module.exports = { PyromancyRayAbility };
