/**
 * PyromancyEchoAbility.js
 * School: pyromancy | Form: Echo
 * Tactical Combat Ability Engine Specification
 */

class PyromancyEchoAbility {
  constructor(config = {}) {
    this.id = 'ability_pyromancy_echo';
    this.name = 'PyromancyEcho';
    ...
    this.statusEffectId = 'status_pyromancy_echo';
...
module.exports = { PyromancyEchoAbility };
