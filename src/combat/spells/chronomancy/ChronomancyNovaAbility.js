/**
 * ChronomancyNovaAbility.js
 * School: chronomancy | Form: Nova
 * Tactical Combat Ability Engine Specification
 */

class ChronomancyNovaAbility {
  constructor(config = {}) {
    this.id = 'ability_chronomancy_nova';
    this.name = 'ChronomancyNova';
    this.school = 'chronomancy';
    this.archetype = 'Nova';
    this.tier = 3;
    this.manaCost = config.manaCost || 42;
    ...
    this.statusEffectId = 'status_chronomancy_nova';
...
module.exports = { ChronomancyNovaAbility };
