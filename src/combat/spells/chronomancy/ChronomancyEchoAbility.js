/**
 * ChronomancyEchoAbility.js
 * School: chronomancy | Form: Echo
 * Tactical Combat Ability Engine Specification
 */

class ChronomancyEchoAbility {
  constructor(config = {}) {
    this.id = 'ability_chronomancy_echo';
    this.name = 'ChronomancyEcho';
    ...
    this.statusEffectId = 'status_chronomancy_echo';
...
module.exports = { ChronomancyEchoAbility };
