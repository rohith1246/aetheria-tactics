/**
 * ChronomancyRiftAbility.js
 * School: chronomancy | Form: Rift
 * Tactical Combat Ability Engine Specification
 */

class ChronomancyRiftAbility {
  constructor(config = {}) {
    this.id = 'ability_chronomancy_rift';
    this.name = 'ChronomancyRift';
    ...
    this.statusEffectId = 'status_chronomancy_rift';
...
module.exports = { ChronomancyRiftAbility };
