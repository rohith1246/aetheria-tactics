/**
 * ChronomancyVortexAbility.js
 * School: chronomancy | Form: Vortex
 * Tactical Combat Ability Engine Specification
 */

class ChronomancyVortexAbility {
  constructor(config = {}) {
    this.id = 'ability_chronomancy_vortex';
    this.name = 'ChronomancyVortex';
    ...
    this.statusEffectId = 'status_chronomancy_vortex';
...
module.exports = { ChronomancyVortexAbility };
