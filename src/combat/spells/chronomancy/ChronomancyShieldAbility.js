/**
 * ChronomancyShieldAbility.js
 * School: chronomancy | Form: Shield
 * Tactical Combat Ability Engine Specification
 */

class ChronomancyShieldAbility {
  constructor(config = {}) {
    this.id = 'ability_chronomancy_shield';
    this.name = 'ChronomancyShield';
...
module.exports = { ChronomancyShieldAbility };
