/**
 * ChronomancyBarrierAbility.js
 * School: chronomancy | Form: Barrier
 * Tactical Combat Ability Engine Specification
 */

class ChronomancyBarrierAbility {
  constructor(config = {}) {
    this.id = 'ability_chronomancy_barrier';
    this.name = 'ChronomancyBarrier';
    ...
    this.statusEffectId = 'status_chronomancy_barrier';
...
module.exports = { ChronomancyBarrierAbility };
