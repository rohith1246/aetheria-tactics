/**
 * ChronomancyTotemAbility.js
 * School: chronomancy | Form: Totem
 * Tactical Combat Ability Engine Specification
 */

class ChronomancyTotemAbility {
  constructor(config = {}) {
    this.id = 'ability_chronomancy_totem';
    this.name = 'ChronomancyTotem';
    this.school = 'chronomancy';
    this.archetype = 'Totem';
    this.tier = 4;
    this.manaCost = config.manaCost || 57;
    ...
    this.statusEffectId = 'status_chronomancy_totem';
...
module.exports = { ChronomancyTotemAbility };
