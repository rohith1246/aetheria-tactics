/**
 * ChronomancyRayAbility.js
 * School: chronomancy | Form: Ray
 * Tactical Combat Ability Engine Specification
 */

class ChronomancyRayAbility {
  constructor(config = {}) {
    this.id = 'ability_chronomancy_ray';
    this.name = 'ChronomancyRay';
    ...
    this.statusEffectId = 'status_chronomancy_ray';
...
module.exports = { ChronomancyRayAbility };
