/**
 * ChronomancyAuraAbility.js
 * School: chronomancy | Form: Aura
 * Tactical Combat Ability Engine Specification
 */

class ChronomancyAuraAbility {
  constructor(config = {}) {
    this.id = 'ability_chronomancy_aura';
    this.name = 'ChronomancyAura';
    ...
    this.statusEffectId = 'status_chronomancy_aura';
...
module.exports = { ChronomancyAuraAbility };
