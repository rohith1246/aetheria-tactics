/**
 * ChronomancyFieldAbility.js
 * School: chronomancy | Form: Field
 * Tactical Combat Ability Engine Specification
 */

class ChronomancyFieldAbility {
  constructor(config = {}) {
    this.id = 'ability_chronomancy_field';
    this.name = 'ChronomancyField';
    ...
    this.statusEffectId = 'status_chronomancy_field';
...
module.exports = { ChronomancyFieldAbility };
