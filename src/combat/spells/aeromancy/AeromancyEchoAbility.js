/**
 * AeromancyEchoAbility.js
 * School: aeromancy | Form: Echo
 * Tactical Combat Ability Engine Specification
 */

class AeromancyEchoAbility {
  constructor(config = {}) {
    this.id = 'ability_aeromancy_echo';
    this.name = 'AeromancyEcho';
    ...
    this.statusEffectId = 'status_aeromancy_echo';
...
module.exports = { AeromancyEchoAbility };
