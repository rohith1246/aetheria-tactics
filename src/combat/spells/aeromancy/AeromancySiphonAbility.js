/**
 * AeromancySiphonAbility.js
 * School: aeromancy | Form: Siphon
 * Tactical Combat Ability Engine Specification
 */

class AeromancySiphonAbility {
  constructor(config = {}) {
    this.id = 'ability_aeromancy_siphon';
    this.name = 'AeromancySiphon';
    this.school = 'aeromancy';
    this.archetype = 'Siphon';
    this.tier = 4;
    this.manaCost = config.manaCost || 77;
    this.staminaCost = config.staminaCost || 20;
    this.baseCooldown = config.cooldown || 4;
    this.currentCooldown = 0;
    this.basePower = config.basePower || 198;
    this.castRange = config.castRange || 3;
    this.areaOfEffectRadius = config.radius || 3;
    this.castTimeTicks = config.castTime || 1;
    this.statusEffectId = 'status_aeromancy_siphon';
...
module.exports = { AeromancySiphonAbility };
