/**
 * AeromancyNovaAbility.js
 * School: aeromancy | Form: Nova
 * Tactical Combat Ability Engine Specification
 */

class AeromancyNovaAbility {
  constructor(config = {}) {
    this.id = 'ability_aeromancy_nova';
    this.name = 'AeromancyNova';
    ...
    this.statusEffectId = 'status_aeromancy_nova';
...
module.exports = { AeromancyNovaAbility };
