/**
 * AeromancyFieldAbility.js
 * School: aeromancy | Form: Field
 * Tactical Combat Ability Engine Specification
 */

class AeromancyFieldAbility {
  constructor(config = {}) {
    this.id = 'ability_aeromancy_field';
    this.name = 'AeromancyField';
    ...
    this.statusEffectId = 'status_aeromancy_field';
...
module.exports = { AeromancyFieldAbility };
