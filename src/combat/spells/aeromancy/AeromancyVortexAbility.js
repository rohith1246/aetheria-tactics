/**
 * AeromancyVortexAbility.js
 * School: aeromancy | Form: Vortex
 * Tactical Combat Ability Engine Specification
 */

class AeromancyVortexAbility {
  constructor(config = {}) {
    this.id = 'ability_aeromancy_vortex';
    this.name = 'AeromancyVortex';
    this.school = 'aeromancy';
    this.archetype = 'Vortex';
    this.tier = 2;
    this.manaCost = config.manaCost || 59;
    ...
    this.statusEffectId = 'status_aeromancy_vortex';
...
module.exports = { AeromancyVortexAbility };
