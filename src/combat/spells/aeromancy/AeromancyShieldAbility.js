/**
 * AeromancyShieldAbility.js
 * School: aeromancy | Form: Shield
 * Tactical Combat Ability Engine Specification
 */

class AeromancyShieldAbility {
  constructor(config = {}) {
    this.id = 'ability_aeromancy_shield';
    this.name = 'AeromancyShield';
...
module.exports = { AeromancyShieldAbility };
