/**
 * AeromancyRiftAbility.js
 * School: aeromancy | Form: Rift
 * Tactical Combat Ability Engine Specification
 */

class AeromancyRiftAbility {
  constructor(config = {}) {
    this.id = 'ability_aeromancy_rift';
    this.name = 'AeromancyRift';
...
module.exports = { AeromancyRiftAbility };
