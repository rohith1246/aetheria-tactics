/**
 * AeromancyBlastAbility.js
 * School: aeromancy | Form: Blast
 * Tactical Combat Ability Engine Specification
 */

class AeromancyBlastAbility {
  constructor(config = {}) {
    this.id = 'ability_aeromancy_blast';
    this.name = 'AeromancyBlast';
    ...
    this.statusEffectId = 'status_aeromancy_blast';
...
module.exports = { AeromancyBlastAbility };
