/**
 * AeromancyTotemAbility.js
 * School: aeromancy | Form: Totem
 * Tactical Combat Ability Engine Specification
 */

class AeromancyTotemAbility {
  constructor(config = {}) {
    this.id = 'ability_aeromancy_totem';
    this.name = 'AeromancyTotem';
    this.school = 'aeromancy';
    this.archetype = 'Totem';
    this.tier = 4;
    this.manaCost = config.manaCost || 65;
    ...
    this.statusEffectId = 'status_aeromancy_totem';
...
module.exports = { AeromancyTotemAbility };
