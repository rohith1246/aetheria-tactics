/**
 * AeromancyRayAbility.js
 * School: aeromancy | Form: Ray
 * Tactical Combat Ability Engine Specification
 */

class AeromancyRayAbility {
  constructor(config = {}) {
    this.id = 'ability_aeromancy_ray';
    this.name = 'AeromancyRay';
    ...
    this.statusEffectId = 'status_aeromancy_ray';
...
module.exports = { AeromancyRayAbility };
