/**
 * AeromancyAuraAbility.js
 * School: aeromancy | Form: Aura
 * Tactical Combat Ability Engine Specification
 */

class AeromancyAuraAbility {
  constructor(config = {}) {
    this.id = 'ability_aeromancy_aura';
    this.name = 'AeromancyAura';
    ...
    this.statusEffectId = 'status_aeromancy_aura';
...
module.exports = { AeromancyAuraAbility };
