/**
 * VoidmancyShieldAbility.js
 * School: voidmancy | Form: Shield
 * Tactical Combat Ability Engine Specification
 */

class VoidmancyShieldAbility {
  constructor(config = {}) {
    this.id = 'ability_voidmancy_shield';
    this.name = 'VoidmancyShield';
...
module.exports = { VoidmancyShieldAbility };
