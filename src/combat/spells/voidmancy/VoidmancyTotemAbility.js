/**
 * VoidmancyTotemAbility.js
 * School: voidmancy | Form: Totem
 * Tactical Combat Ability Engine Specification
 */

class VoidmancyTotemAbility {
  constructor(config = {}) {
    this.id = 'ability_voidmancy_totem';
    this.name = 'VoidmancyTotem';
    ...
    this.statusEffectId = 'status_voidmancy_totem';
...
module.exports = { VoidmancyTotemAbility };
