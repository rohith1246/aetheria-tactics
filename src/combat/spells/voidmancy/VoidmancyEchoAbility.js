/**
 * VoidmancyEchoAbility.js
 * School: voidmancy | Form: Echo
 * Tactical Combat Ability Engine Specification
 */

class VoidmancyEchoAbility {
  constructor(config = {}) {
    this.id = 'ability_voidmancy_echo';
    this.name = 'VoidmancyEcho';
    ...
    this.statusEffectId = 'status_voidmancy_echo';
...
module.exports = { VoidmancyEchoAbility };
