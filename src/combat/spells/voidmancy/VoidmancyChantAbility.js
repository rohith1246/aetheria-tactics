/**
 * VoidmancyChantAbility.js
 * School: voidmancy | Form: Chant
 * Tactical Combat Ability Engine Specification
 */

class VoidmancyChantAbility {
  constructor(config = {}) {
    this.id = 'ability_voidmancy_chant';
    this.name = 'VoidmancyChant';
    this.school = 'voidmancy';
    this.archetype = 'Chant';
    this.tier = 1;
    this.manaCost = config.manaCost || 84;
    ...
    this.statusEffectId = 'status_voidmancy_chant';
...
module.exports = { VoidmancyChantAbility };
