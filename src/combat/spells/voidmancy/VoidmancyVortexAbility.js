/**
 * VoidmancyVortexAbility.js
 * School: voidmancy | Form: Vortex
 * Tactical Combat Ability Engine Specification
 */

class VoidmancyVortexAbility {
  constructor(config = {}) {
    this.id = 'ability_voidmancy_vortex';
    this.name = 'VoidmancyVortex';
    ...
    this.statusEffectId = 'status_voidmancy_vortex';
...
module.exports = { VoidmancyVortexAbility };
