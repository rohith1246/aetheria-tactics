/**
 * VoidmancyBarrierAbility.js
 * School: voidmancy | Form: Barrier
 * Tactical Combat Ability Engine Specification
 */

class VoidmancyBarrierAbility {
  constructor(config = {}) {
    this.id = 'ability_voidmancy_barrier';
    ...
    this.statusEffectId = 'status_voidmancy_barrier';
...
module.exports = { VoidmancyBarrierAbility };
