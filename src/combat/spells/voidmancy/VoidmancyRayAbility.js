/**
 * VoidmancyRayAbility.js
 * School: voidmancy | Form: Ray
 * Tactical Combat Ability Engine Specification
 */

class VoidmancyRayAbility {
  constructor(config = {}) {
    this.id = 'ability_voidmancy_ray';
    this.name = 'VoidmancyRay';
    ...
    this.statusEffectId = 'status_voidmancy_ray';
...
module.exports = { VoidmancyRayAbility };
