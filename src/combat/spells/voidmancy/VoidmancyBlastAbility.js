/**
 * VoidmancyBlastAbility.js
 * School: voidmancy | Form: Blast
 * Tactical Combat Ability Engine Specification
 */

class VoidmancyBlastAbility {
  constructor(config = {}) {
    this.id = 'ability_voidmancy_blast';
    this.name = 'VoidmancyBlast';
...
module.exports = { VoidmancyBlastAbility };
