/**
 * VoidmancyInfusionAbility.js
 * School: voidmancy | Form: Infusion
 * Tactical Combat Ability Engine Specification
 */

class VoidmancyInfusionAbility {
  constructor(config = {}) {
    this.id = 'ability_voidmancy_infusion';
    this.name = 'VoidmancyInfusion';
...
module.exports = { VoidmancyInfusionAbility };
