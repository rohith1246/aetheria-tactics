/**
 * VoidmancyNovaAbility.js
 * School: voidmancy | Form: Nova
 * Tactical Combat Ability Engine Specification
 */

class VoidmancyNovaAbility {
  constructor(config = {}) {
    this.id = 'ability_voidmancy_nova';
    this.name = 'VoidmancyNova';
    ...
    this.statusEffectId = 'status_voidmancy_nova';
...
module.exports = { VoidmancyNovaAbility };
