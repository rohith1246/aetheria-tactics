/**
 * VoidmancyRiftAbility.js
 * School: voidmancy | Form: Rift
 * Tactical Combat Ability Engine Specification
 */

class VoidmancyRiftAbility {
  constructor(config = {}) {
    this.id = 'ability_voidmancy_rift';
    this.name = 'VoidmancyRift';
    ...
    this.statusEffectId = 'status_voidmancy_rift';
...
module.exports = { VoidmancyRiftAbility };
