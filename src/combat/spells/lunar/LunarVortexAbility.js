/**
 * LunarVortexAbility.js
 * School: lunar | Form: Vortex
 * Tactical Combat Ability Engine Specification
 */

class LunarVortexAbility {
  constructor(config = {}) {
    this.id = 'ability_lunar_vortex';
    this.name = 'LunarVortex';
    this.school = 'lunar';
    ...
    this.statusEffectId = 'status_lunar_vortex';
...
module.exports = { LunarVortexAbility };
