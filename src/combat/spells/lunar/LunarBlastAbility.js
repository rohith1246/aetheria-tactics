/**
 * LunarBlastAbility.js
 * School: lunar | Form: Blast
 * Tactical Combat Ability Engine Specification
 */

class LunarBlastAbility {
  constructor(config = {}) {
    this.id = 'ability_lunar_blast';
    this.name = 'LunarBlast';
    this.school = 'lunar';
    ...
    this.statusEffectId = 'status_lunar_blast';
...
module.exports = { LunarBlastAbility };
