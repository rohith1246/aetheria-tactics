/**
 * LunarShieldAbility.js
 * School: lunar | Form: Shield
 * Tactical Combat Ability Engine Specification
 */

class LunarShieldAbility {
  constructor(config = {}) {
    this.id = 'ability_lunar_shield';
    this.name = 'LunarShield';
    this.school = 'lunar';
    ...
    this.statusEffectId = 'status_lunar_shield';
...
module.exports = { LunarShieldAbility };
