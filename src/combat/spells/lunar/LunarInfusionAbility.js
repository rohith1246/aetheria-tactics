/**
 * LunarInfusionAbility.js
 * School: lunar | Form: Infusion
 * Tactical Combat Ability Engine Specification
 */

class LunarInfusionAbility {
  constructor(config = {}) {
    this.id = 'ability_lunar_infusion';
    this.name = 'LunarInfusion';
    this.school = 'lunar';
...
module.exports = { LunarInfusionAbility };
