/**
 * LunarFieldAbility.js
 * School: lunar | Form: Field
 * Tactical Combat Ability Engine Specification
 */

class LunarFieldAbility {
  constructor(config = {}) {
    this.id = 'ability_lunar_field';
    this.name = 'LunarField';
    this.school = 'lunar';
    ...
    this.statusEffectId = 'status_lunar_field';
...
module.exports = { LunarFieldAbility };
