/**
 * LunarBarrierAbility.js
 * School: lunar | Form: Barrier
 * Tactical Combat Ability Engine Specification
 */

class LunarBarrierAbility {
  constructor(config = {}) {
    this.id = 'ability_lunar_barrier';
    this.name = 'LunarBarrier';
    this.school = 'lunar';
...
module.exports = { LunarBarrierAbility };
