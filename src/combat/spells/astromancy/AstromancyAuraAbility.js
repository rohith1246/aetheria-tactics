/**
 * AstromancyAuraAbility.js
 * School: astromancy | Form: Aura
 * Tactical Combat Ability Engine Specification
 */

class AstromancyAuraAbility {
  constructor(config = {}) {
    this.id = 'ability_astromancy_aura';
    this.name = 'AstromancyAura';
...
module.exports = { AstromancyAuraAbility };
