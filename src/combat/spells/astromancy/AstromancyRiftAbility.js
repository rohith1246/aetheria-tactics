/**
 * AstromancyRiftAbility.js
 * School: astromancy | Form: Rift
 * Tactical Combat Ability Engine Specification
 */

class AstromancyRiftAbility {
  constructor(config = {}) {
    this.id = 'ability_astromancy_rift';
...
module.exports = { AstromancyRiftAbility };
