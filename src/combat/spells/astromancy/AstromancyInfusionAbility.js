/**
 * AstromancyInfusionAbility.js
 * School: astromancy | Form: Infusion
 * Tactical Combat Ability Engine Specification
 */

class AstromancyInfusionAbility {
  constructor(config = {}) {
    this.id = 'ability_astromancy_infusion';
    this.name = 'AstromancyInfusion';
...
module.exports = { AstromancyInfusionAbility };
