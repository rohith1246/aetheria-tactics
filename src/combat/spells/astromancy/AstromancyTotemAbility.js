/**
 * AstromancyTotemAbility.js
 * School: astromancy | Form: Totem
 * Tactical Combat Ability Engine Specification
 */

class AstromancyTotemAbility {
  constructor(config = {}) {
    this.id = 'ability_astromancy_totem';
    this.name = 'AstromancyTotem';
    ...
    this.statusEffectId = 'status_astromancy_totem';
...
module.exports = { AstromancyTotemAbility };
