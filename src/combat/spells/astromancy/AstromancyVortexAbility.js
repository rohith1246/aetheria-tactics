/**
 * AstromancyVortexAbility.js
 * School: astromancy | Form: Vortex
 * Tactical Combat Ability Engine Specification
 */

class AstromancyVortexAbility {
  constructor(config = {}) {
    this.id = 'ability_astromancy_vortex';
    this.name = 'AstromancyVortex';
    ...
    this.statusEffectId = 'status_astromancy_vortex';
...
module.exports = { AstromancyVortexAbility };
