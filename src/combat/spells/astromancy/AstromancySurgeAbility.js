/**
 * AstromancySurgeAbility.js
 * School: astromancy | Form: Surge
 * Tactical Combat Ability Engine Specification
 */

class AstromancySurgeAbility {
  constructor(config = {}) {
    this.id = 'ability_astromancy_surge';
    this.name = 'AstromancySurge';
    this.school = 'astromancy';
    this.archetype = 'Surge';
    this.tier = 2;
    this.manaCost = config.manaCost || 63;
    ...
    this.statusEffectId = 'status_astromancy_surge';
...
module.exports = { AstromancySurgeAbility };
