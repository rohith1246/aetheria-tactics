/**
 * AstromancyFieldAbility.js
 * School: astromancy | Form: Field
 * Tactical Combat Ability Engine Specification
 */

class AstromancyFieldAbility {
  constructor(config = {}) {
    this.id = 'ability_astromancy_field';
    this.name = 'AstromancyField';
    this.school = 'astromancy';
    this.archetype = 'Field';
    this.tier = 2;
    this.manaCost = config.manaCost || 87;
    ...
    this.statusEffectId = 'status_astromancy_field';
...
module.exports = { AstromancyFieldAbility };
