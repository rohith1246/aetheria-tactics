/**
 * AstromancyEchoAbility.js
 * School: astromancy | Form: Echo
 * Tactical Combat Ability Engine Specification
 */

class AstromancyEchoAbility {
  constructor(config = {}) {
    this.id = 'ability_astromancy_echo';
    this.name = 'AstromancyEcho';
    ...
    this.statusEffectId = 'status_astromancy_echo';
...
module.exports = { AstromancyEchoAbility };
