/**
 * AstromancyRayAbility.js
 * School: astromancy | Form: Ray
 * Tactical Combat Ability Engine Specification
 */

class AstromancyRayAbility {
  constructor(config = {}) {
    this.id = 'ability_astromancy_ray';
    this.name = 'AstromancyRay';
    this.school = 'astromancy';
    this.archetype = 'Ray';
    this.tier = 3;
    this.manaCost = config.manaCost || 78;
    ...
    this.statusEffectId = 'status_astromancy_ray';
...
module.exports = { AstromancyRayAbility };
