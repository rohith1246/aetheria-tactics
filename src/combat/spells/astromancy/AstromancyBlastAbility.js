/**
 * AstromancyBlastAbility.js
 * School: astromancy | Form: Blast
 * Tactical Combat Ability Engine Specification
 */

class AstromancyBlastAbility {
  constructor(config = {}) {
    this.id = 'ability_astromancy_blast';
    this.name = 'AstromancyBlast';
    ...
    this.statusEffectId = 'status_astromancy_blast';
...
module.exports = { AstromancyBlastAbility };
