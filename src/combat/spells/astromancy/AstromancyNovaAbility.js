/**
 * AstromancyNovaAbility.js
 * School: astromancy | Form: Nova
 * Tactical Combat Ability Engine Specification
 */

class AstromancyNovaAbility {
  constructor(config = {}) {
    this.id = 'ability_astromancy_nova';
    this.name = 'AstromancyNova';
    this.school = 'astromancy';
    this.archetype = 'Nova';
    this.tier = 3;
    this.manaCost = config.manaCost || 66;
    ...
    this.statusEffectId = 'status_astromancy_nova';
...
module.exports = { AstromancyNovaAbility };
