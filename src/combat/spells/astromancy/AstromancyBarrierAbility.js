/**
 * AstromancyBarrierAbility.js
 * School: astromancy | Form: Barrier
 * Tactical Combat Ability Engine Specification
 */

class AstromancyBarrierAbility {
  constructor(config = {}) {
    this.id = 'ability_astromancy_barrier';
    this.name = 'AstromancyBarrier';
...
module.exports = { AstromancyBarrierAbility };
