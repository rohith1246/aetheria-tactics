/**
 * AstromancyShieldAbility.js
 * School: astromancy | Form: Shield
 * Tactical Combat Ability Engine Specification
 */

class AstromancyShieldAbility {
  constructor(config = {}) {
    this.id = 'ability_astromancy_shield';
    this.name = 'AstromancyShield';
...
module.exports = { AstromancyShieldAbility };
