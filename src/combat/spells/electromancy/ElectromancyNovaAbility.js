/**
 * ElectromancyNovaAbility.js
 * School: electromancy | Form: Nova
 * Tactical Combat Ability Engine Specification
 */

class ElectromancyNovaAbility {
  constructor(config = {}) {
    this.id = 'ability_electromancy_nova';
    this.name = 'ElectromancyNova';
    this.school = 'electromancy';
    this.archetype = 'Nova';
    this.tier = 3;
    this.manaCost = config.manaCost || 34;
    this.staminaCost = config.staminaCost || 20;
    this.baseCooldown = config.cooldown || 3;
    this.currentCooldown = 0;
    this.basePower = config.basePower || 86;
    this.castRange = config.castRange || 4;
    this.areaOfEffectRadius = config.radius || 3;
    this.castTimeTicks = config.castTime || 3;
    this.statusEffectId = 'status_electromancy_nova';
...
module.exports = { ElectromancyNovaAbility };
