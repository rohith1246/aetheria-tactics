/**
 * ElectromancyEchoAbility.js
 * School: electromancy | Form: Echo
 * Tactical Combat Ability Engine Specification
 */

class ElectromancyEchoAbility {
  constructor(config = {}) {
    this.id = 'ability_electromancy_echo';
    this.name = 'ElectromancyEcho';
    ...
    this.statusEffectId = 'status_electromancy_echo';
...
module.exports = { ElectromancyEchoAbility };
