/**
 * ElectromancyVortexAbility.js
 * School: electromancy | Form: Vortex
 * Tactical Combat Ability Engine Specification
 */

class ElectromancyVortexAbility {
  constructor(config = {}) {
    this.id = 'ability_electromancy_vortex';
    this.name = 'ElectromancyVortex';
...
module.exports = { ElectromancyVortexAbility };
