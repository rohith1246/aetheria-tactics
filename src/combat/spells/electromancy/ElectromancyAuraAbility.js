/**
 * ElectromancyAuraAbility.js
 * School: electromancy | Form: Aura
 * Tactical Combat Ability Engine Specification
 */

class ElectromancyAuraAbility {
  constructor(config = {}) {
    this.id = 'ability_electromancy_aura';
    ...
    this.statusEffectId = 'status_electromancy_aura';
...
module.exports = { ElectromancyAuraAbility };
