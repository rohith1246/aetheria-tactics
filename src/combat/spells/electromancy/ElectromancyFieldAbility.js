/**
 * ElectromancyFieldAbility.js
 * School: electromancy | Form: Field
 * Tactical Combat Ability Engine Specification
 */

class ElectromancyFieldAbility {
  constructor(config = {}) {
    this.id = 'ability_electromancy_field';
    this.name = 'ElectromancyField';
    ...
    this.statusEffectId = 'status_electromancy_field';
...
module.exports = { ElectromancyFieldAbility };
