/**
 * ElectromancyRayAbility.js
 * School: electromancy | Form: Ray
 * Tactical Combat Ability Engine Specification
 */

class ElectromancyRayAbility {
  constructor(config = {}) {
    this.id = 'ability_electromancy_ray';
    this.name = 'ElectromancyRay';
    this.school = 'electromancy';
    this.archetype = 'Ray';
    this.tier = 3;
    this.manaCost = config.manaCost || 46;
    ...
    this.statusEffectId = 'status_electromancy_ray';
...
module.exports = { ElectromancyRayAbility };
