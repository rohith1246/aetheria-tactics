/**
 * ElectromancyRiftAbility.js
 * School: electromancy | Form: Rift
 * Tactical Combat Ability Engine Specification
 */

class ElectromancyRiftAbility {
  constructor(config = {}) {
    this.id = 'ability_electromancy_rift';
    this.name = 'ElectromancyRift';
    ...
    this.statusEffectId = 'status_electromancy_rift';
...
module.exports = { ElectromancyRiftAbility };
