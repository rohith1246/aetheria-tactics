/**
 * ElectromancyInfusionAbility.js
 * School: electromancy | Form: Infusion
 * Tactical Combat Ability Engine Specification
 */

class ElectromancyInfusionAbility {
  constructor(config = {}) {
    this.id = 'ability_electromancy_infusion';
    this.name = 'ElectromancyInfusion';
    this.school = 'electromancy';
    this.archetype = 'Infusion';
    this.tier = 1;
    this.manaCost = config.manaCost || 40;
    this.staminaCost = config.staminaCost || 15;
    this.baseCooldown = config.cooldown || 1;
    this.currentCooldown = 0;
    this.basePower = config.basePower || 102;
    this.castRange = config.castRange || 6;
    this.areaOfEffectRadius = config.radius || 2;
    this.castTimeTicks = config.castTime || 3;
    this.statusEffectId = 'status_electromancy_infusion';
...
module.exports = { ElectromancyInfusionAbility };
