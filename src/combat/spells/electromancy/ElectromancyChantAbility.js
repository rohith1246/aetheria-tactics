/**
 * ElectromancyChantAbility.js
 * School: electromancy | Form: Chant
 * Tactical Combat Ability Engine Specification
 */

class ElectromancyChantAbility {
  constructor(config = {}) {
    this.id = 'ability_electromancy_chant';
    this.name = 'ElectromancyChant';
    this.school = 'electromancy';
    this.archetype = 'Chant';
    this.tier = 1;
    this.manaCost = config.manaCost || 64;
    this.staminaCost = config.staminaCost || 10;
    this.baseCooldown = config.cooldown || 1;
    this.currentCooldown = 0;
    this.basePower = config.basePower || 166;
    this.castRange = config.castRange || 4;
    this.areaOfEffectRadius = config.radius || 1;
    this.castTimeTicks = config.castTime || 3;
    this.statusEffectId = 'status_electromancy_chant';
...
module.exports = { ElectromancyChantAbility };
