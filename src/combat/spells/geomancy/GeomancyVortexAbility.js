/**
 * GeomancyVortexAbility.js
 * School: geomancy | Form: Vortex
 * Tactical Combat Ability Engine Specification
 */

class GeomancyVortexAbility {
  constructor(config = {}) {
    this.id = 'ability_geomancy_vortex';
    this.name = 'GeomancyVortex';
    ...
    this.statusEffectId = 'status_geomancy_vortex';
...
module.exports = { GeomancyVortexAbility };
