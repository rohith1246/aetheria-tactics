/**
 * GeomancyChantAbility.js
 * School: geomancy | Form: Chant
 * Tactical Combat Ability Engine Specification
 */

class GeomancyChantAbility {
  constructor(config = {}) {
    this.id = 'ability_geomancy_chant';
    this.name = 'GeomancyChant';
    this.school = 'geomancy';
    this.archetype = 'Chant';
    this.tier = 1;
    this.manaCost = config.manaCost || 76;
    ...
    this.statusEffectId = 'status_geomancy_chant';
...
module.exports = { GeomancyChantAbility };
