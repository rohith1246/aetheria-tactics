/**
 * GeomancyBlastAbility.js
 * School: geomancy | Form: Blast
 * Tactical Combat Ability Engine Specification
 */

class GeomancyBlastAbility {
  constructor(config = {}) {
    this.id = 'ability_geomancy_blast';
    this.name = 'GeomancyBlast';
    ...
    this.statusEffectId = 'status_geomancy_blast';
...
module.exports = { GeomancyBlastAbility };
