/**
 * GeomancyBarrierAbility.js
 * School: geomancy | Form: Barrier
 * Tactical Combat Ability Engine Specification
 */

class GeomancyBarrierAbility {
  constructor(config = {}) {
    this.id = 'ability_geomancy_barrier';
    this.name = 'GeomancyBarrier';
...
module.exports = { GeomancyBarrierAbility };
