/**
 * GeomancyRiftAbility.js
 * School: geomancy | Form: Rift
 * Tactical Combat Ability Engine Specification
 */

class GeomancyRiftAbility {
  constructor(config = {}) {
    this.id = 'ability_geomancy_rift';
    this.name = 'GeomancyRift';
...
module.exports = { GeomancyRiftAbility };
