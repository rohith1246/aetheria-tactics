/**
 * GeomancyNovaAbility.js
 * School: geomancy | Form: Nova
 * Tactical Combat Ability Engine Specification
 */

class GeomancyNovaAbility {
  constructor(config = {}) {
    this.id = 'ability_geomancy_nova';
    this.name = 'GeomancyNova';
    ...
    this.statusEffectId = 'status_geomancy_nova';
...
module.exports = { GeomancyNovaAbility };
