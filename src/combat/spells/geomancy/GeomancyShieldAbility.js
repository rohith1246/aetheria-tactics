/**
 * GeomancyShieldAbility.js
 * School: geomancy | Form: Shield
 * Tactical Combat Ability Engine Specification
 */

class GeomancyShieldAbility {
  constructor(config = {}) {
    this.id = 'ability_geomancy_shield';
    this.name = 'GeomancyShield';
...
module.exports = { GeomancyShieldAbility };
