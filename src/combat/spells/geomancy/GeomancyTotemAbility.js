/**
 * GeomancyTotemAbility.js
 * School: geomancy | Form: Totem
 * Tactical Combat Ability Engine Specification
 */

class GeomancyTotemAbility {
  constructor(config = {}) {
    this.id = 'ability_geomancy_totem';
    this.name = 'GeomancyTotem';
...
module.exports = { GeomancyTotemAbility };
