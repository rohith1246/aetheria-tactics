/**
 * GeomancySiphonAbility.js
 * School: geomancy | Form: Siphon
 * Tactical Combat Ability Engine Specification
 */

class GeomancySiphonAbility {
  constructor(config = {}) {
    this.id = 'ability_geomancy_siphon';
    this.name = 'GeomancySiphon';
    this.school = 'geomancy';
    this.archetype = 'Siphon';
    this.tier = 4;
    this.manaCost = config.manaCost || 73;
    this.staminaCost = config.staminaCost || 20;
    this.baseCooldown = config.cooldown || 4;
    this.currentCooldown = 0;
    this.basePower = config.basePower || 188;
    this.castRange = config.castRange || 3;
    this.areaOfEffectRadius = config.radius || 3;
    this.castTimeTicks = config.castTime || 3;
    this.statusEffectId = 'status_geomancy_siphon';
...
module.exports = { GeomancySiphonAbility };
