/**
 * GeomancyRayAbility.js
 * School: geomancy | Form: Ray
 * Tactical Combat Ability Engine Specification
 */

class GeomancyRayAbility {
  constructor(config = {}) {
    this.id = 'ability_geomancy_ray';
    this.name = 'GeomancyRay';
    ...
    this.statusEffectId = 'status_geomancy_ray';
...
module.exports = { GeomancyRayAbility };
