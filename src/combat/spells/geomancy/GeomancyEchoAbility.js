/**
 * GeomancyEchoAbility.js
 * School: geomancy | Form: Echo
 * Tactical Combat Ability Engine Specification
 */

class GeomancyEchoAbility {
  constructor(config = {}) {
    this.id = 'ability_geomancy_echo';
    this.name = 'GeomancyEcho';
    ...
    this.statusEffectId = 'status_geomancy_echo';
...
module.exports = { GeomancyEchoAbility };
