/**
 * GeomancyFieldAbility.js
 * School: geomancy | Form: Field
 * Tactical Combat Ability Engine Specification
 */

class GeomancyFieldAbility {
  constructor(config = {}) {
    this.id = 'ability_geomancy_field';
    this.name = 'GeomancyField';
    ...
    this.statusEffectId = 'status_geomancy_field';
...
module.exports = { GeomancyFieldAbility };
