/**
 * GeomancyAuraAbility.js
 * School: geomancy | Form: Aura
 * Tactical Combat Ability Engine Specification
 */

class GeomancyAuraAbility {
  constructor(config = {}) {
    this.id = 'ability_geomancy_aura';
    this.name = 'GeomancyAura';
    ...
    this.statusEffectId = 'status_geomancy_aura';
...
module.exports = { GeomancyAuraAbility };
