/**
 * SolarFieldAbility.js
 * School: solar | Form: Field
 * Tactical Combat Ability Engine Specification
 */

class SolarFieldAbility {
  constructor(config = {}) {
    this.id = 'ability_solar_field';
    this.name = 'SolarField';
    this.school = 'solar';
    this.archetype = 'Field';
    this.tier = 2;
    this.manaCost = config.manaCost || 99;
    ...
    this.statusEffectId = 'status_solar_field';
...
module.exports = { SolarFieldAbility };
