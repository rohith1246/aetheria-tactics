/**
 * SolarShieldAbility.js
 * School: solar | Form: Shield
 * Tactical Combat Ability Engine Specification
 */

class SolarShieldAbility {
  constructor(config = {}) {
    this.id = 'ability_solar_shield';
    this.name = 'SolarShield';
    this.school = 'solar';
    ...
    this.statusEffectId = 'status_solar_shield';
...
module.exports = { SolarShieldAbility };
