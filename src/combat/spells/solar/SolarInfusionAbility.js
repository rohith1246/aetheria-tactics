/**
 * SolarInfusionAbility.js
 * School: solar | Form: Infusion
 * Tactical Combat Ability Engine Specification
 */

class SolarInfusionAbility {
  constructor(config = {}) {
    this.id = 'ability_solar_infusion';
    this.name = 'SolarInfusion';
    this.school = 'solar';
...
module.exports = { SolarInfusionAbility };
