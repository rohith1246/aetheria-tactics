/**
 * SolarSurgeAbility.js
 * School: solar | Form: Surge
 * Tactical Combat Ability Engine Specification
 */

class SolarSurgeAbility {
  constructor(config = {}) {
    this.id = 'ability_solar_surge';
    this.name = 'SolarSurge';
    this.school = 'solar';
    ...
    this.statusEffectId = 'status_solar_surge';
...
module.exports = { SolarSurgeAbility };
