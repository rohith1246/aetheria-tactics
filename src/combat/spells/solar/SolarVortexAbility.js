/**
 * SolarVortexAbility.js
 * School: solar | Form: Vortex
 * Tactical Combat Ability Engine Specification
 */

class SolarVortexAbility {
  constructor(config = {}) {
    this.id = 'ability_solar_vortex';
    this.name = 'SolarVortex';
    this.school = 'solar';
    ...
    this.statusEffectId = 'status_solar_vortex';
...
module.exports = { SolarVortexAbility };
