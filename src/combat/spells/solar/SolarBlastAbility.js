/**
 * SolarBlastAbility.js
 * School: solar | Form: Blast
 * Tactical Combat Ability Engine Specification
 */

class SolarBlastAbility {
  constructor(config = {}) {
    this.id = 'ability_solar_blast';
    this.name = 'SolarBlast';
    this.school = 'solar';
    ...
    this.statusEffectId = 'status_solar_blast';
...
module.exports = { SolarBlastAbility };
