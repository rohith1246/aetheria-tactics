/**
 * SolarTotemAbility.js
 * School: solar | Form: Totem
 * Tactical Combat Ability Engine Specification
 */

class SolarTotemAbility {
  constructor(config = {}) {
    this.id = 'ability_solar_totem';
    this.name = 'SolarTotem';
    this.school = 'solar';
    ...
    this.statusEffectId = 'status_solar_totem';
...
module.exports = { SolarTotemAbility };
