/**
 * ElementalSynergyMatrix_Combustion179.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 179
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion179 {
  constructor() {
    this.matrixId = 'SYNERGY_179';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion179;
