/**
 * ElementalSynergyMatrix_Combustion65.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 65
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion65 {
  constructor() {
    this.matrixId = 'SYNERGY_65';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion65;
