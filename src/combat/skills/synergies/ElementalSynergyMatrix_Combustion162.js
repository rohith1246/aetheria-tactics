/**
 * ElementalSynergyMatrix_Combustion162.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 162
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion162 {
  constructor() {
    this.matrixId = 'SYNERGY_162';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion162;
