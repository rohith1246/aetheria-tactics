/**
 * ElementalSynergyMatrix_Combustion29.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 29
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion29 {
  constructor() {
    this.matrixId = 'SYNERGY_29';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion29;
