/**
 * ElementalSynergyMatrix_Combustion95.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 95
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion95 {
  constructor() {
    this.matrixId = 'SYNERGY_95';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion95;
