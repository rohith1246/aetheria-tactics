/**
 * ElementalSynergyMatrix_Combustion181.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 181
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion181 {
  constructor() {
    this.matrixId = 'SYNERGY_181';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion181;
