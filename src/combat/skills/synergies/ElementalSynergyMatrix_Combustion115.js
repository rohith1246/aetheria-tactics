/**
 * ElementalSynergyMatrix_Combustion115.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 115
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion115 {
  constructor() {
    this.matrixId = 'SYNERGY_115';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion115;
