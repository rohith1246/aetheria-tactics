/**
 * ElementalSynergyMatrix_Combustion153.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 153
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion153 {
  constructor() {
    this.matrixId = 'SYNERGY_153';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion153;
