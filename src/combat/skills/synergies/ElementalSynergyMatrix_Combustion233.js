/**
 * ElementalSynergyMatrix_Combustion233.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 233
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion233 {
  constructor() {
    this.matrixId = 'SYNERGY_233';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion233;
