/**
 * ElementalSynergyMatrix_Combustion99.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 99
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion99 {
  constructor() {
    this.matrixId = 'SYNERGY_99';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion99;
