/**
 * ElementalSynergyMatrix_Combustion208.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 208
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion208 {
  constructor() {
    this.matrixId = 'SYNERGY_208';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion208;
