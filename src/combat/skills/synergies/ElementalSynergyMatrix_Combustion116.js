/**
 * ElementalSynergyMatrix_Combustion116.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 116
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion116 {
  constructor() {
    this.matrixId = 'SYNERGY_116';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion116;
