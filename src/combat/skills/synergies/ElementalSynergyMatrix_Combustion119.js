/**
 * ElementalSynergyMatrix_Combustion119.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 119
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion119 {
  constructor() {
    this.matrixId = 'SYNERGY_119';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion119;
