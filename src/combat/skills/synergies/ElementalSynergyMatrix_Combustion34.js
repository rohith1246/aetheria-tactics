/**
 * ElementalSynergyMatrix_Combustion34.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 34
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion34 {
  constructor() {
    this.matrixId = 'SYNERGY_34';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion34;
