/**
 * ElementalSynergyMatrix_Combustion21.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 21
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion21 {
  constructor() {
    this.matrixId = 'SYNERGY_21';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion21;
