/**
 * ElementalSynergyMatrix_Combustion191.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 191
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion191 {
  constructor() {
    this.matrixId = 'SYNERGY_191';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion191;
