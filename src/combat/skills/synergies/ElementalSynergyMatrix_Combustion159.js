/**
 * ElementalSynergyMatrix_Combustion159.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 159
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion159 {
  constructor() {
    this.matrixId = 'SYNERGY_159';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion159;
