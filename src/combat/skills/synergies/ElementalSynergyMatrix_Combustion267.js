/**
 * ElementalSynergyMatrix_Combustion267.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 267
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion267 {
  constructor() {
    this.matrixId = 'SYNERGY_267';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion267;
