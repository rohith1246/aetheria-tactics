/**
 * ElementalSynergyMatrix_Combustion83.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 83
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion83 {
  constructor() {
    this.matrixId = 'SYNERGY_83';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion83;
