/**
 * ElementalSynergyMatrix_Combustion304.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 304
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion304 {
  constructor() {
    this.matrixId = 'SYNERGY_304';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion304;
