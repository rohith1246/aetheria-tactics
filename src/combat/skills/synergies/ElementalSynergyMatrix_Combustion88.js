/**
 * ElementalSynergyMatrix_Combustion88.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 88
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion88 {
  constructor() {
    this.matrixId = 'SYNERGY_88';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion88;
