/**
 * ElementalSynergyMatrix_Combustion294.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 294
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion294 {
  constructor() {
    this.matrixId = 'SYNERGY_294';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion294;
