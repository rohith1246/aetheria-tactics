/**
 * ElementalSynergyMatrix_Combustion96.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 96
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion96 {
  constructor() {
    this.matrixId = 'SYNERGY_96';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion96;
