/**
 * ElementalSynergyMatrix_Combustion203.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 203
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion203 {
  constructor() {
    this.matrixId = 'SYNERGY_203';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion203;
