/**
 * ElementalSynergyMatrix_Combustion149.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 149
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion149 {
  constructor() {
    this.matrixId = 'SYNERGY_149';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion149;
