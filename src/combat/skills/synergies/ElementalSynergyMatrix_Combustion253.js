/**
 * ElementalSynergyMatrix_Combustion253.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 253
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion253 {
  constructor() {
    this.matrixId = 'SYNERGY_253';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion253;
