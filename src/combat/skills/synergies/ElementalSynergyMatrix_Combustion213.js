/**
 * ElementalSynergyMatrix_Combustion213.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 213
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion213 {
  constructor() {
    this.matrixId = 'SYNERGY_213';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion213;
