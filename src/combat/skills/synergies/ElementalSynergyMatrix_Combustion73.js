/**
 * ElementalSynergyMatrix_Combustion73.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 73
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion73 {
  constructor() {
    this.matrixId = 'SYNERGY_73';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion73;
