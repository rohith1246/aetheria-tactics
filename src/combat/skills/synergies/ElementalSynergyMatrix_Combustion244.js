/**
 * ElementalSynergyMatrix_Combustion244.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 244
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion244 {
  constructor() {
    this.matrixId = 'SYNERGY_244';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion244;
