/**
 * ElementalSynergyMatrix_Combustion89.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 89
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion89 {
  constructor() {
    this.matrixId = 'SYNERGY_89';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion89;
