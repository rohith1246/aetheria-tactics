/**
 * ElementalSynergyMatrix_Combustion129.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 129
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion129 {
  constructor() {
    this.matrixId = 'SYNERGY_129';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion129;
