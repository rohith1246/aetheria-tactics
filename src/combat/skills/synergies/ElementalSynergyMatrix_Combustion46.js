/**
 * ElementalSynergyMatrix_Combustion46.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 46
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion46 {
  constructor() {
    this.matrixId = 'SYNERGY_46';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion46;
