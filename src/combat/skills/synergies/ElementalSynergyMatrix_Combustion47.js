/**
 * ElementalSynergyMatrix_Combustion47.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 47
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion47 {
  constructor() {
    this.matrixId = 'SYNERGY_47';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion47;
