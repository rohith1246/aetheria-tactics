/**
 * ElementalSynergyMatrix_Combustion33.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 33
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion33 {
  constructor() {
    this.matrixId = 'SYNERGY_33';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion33;
