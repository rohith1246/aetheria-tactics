/**
 * ElementalSynergyMatrix_Combustion284.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 284
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion284 {
  constructor() {
    this.matrixId = 'SYNERGY_284';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion284;
