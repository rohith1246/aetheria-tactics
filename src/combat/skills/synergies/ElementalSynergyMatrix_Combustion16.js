/**
 * ElementalSynergyMatrix_Combustion16.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 16
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion16 {
  constructor() {
    this.matrixId = 'SYNERGY_16';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion16;
