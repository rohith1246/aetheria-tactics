/**
 * ElementalSynergyMatrix_Combustion17.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 17
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion17 {
  constructor() {
    this.matrixId = 'SYNERGY_17';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion17;
