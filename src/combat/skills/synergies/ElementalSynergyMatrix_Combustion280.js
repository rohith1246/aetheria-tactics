/**
 * ElementalSynergyMatrix_Combustion280.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 280
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion280 {
  constructor() {
    this.matrixId = 'SYNERGY_280';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion280;
