/**
 * ElementalSynergyMatrix_Combustion206.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 206
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion206 {
  constructor() {
    this.matrixId = 'SYNERGY_206';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion206;
