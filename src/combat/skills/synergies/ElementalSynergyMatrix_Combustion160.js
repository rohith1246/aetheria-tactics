/**
 * ElementalSynergyMatrix_Combustion160.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 160
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion160 {
  constructor() {
    this.matrixId = 'SYNERGY_160';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion160;
