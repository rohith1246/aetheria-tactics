/**
 * ElementalSynergyMatrix_Combustion98.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 98
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion98 {
  constructor() {
    this.matrixId = 'SYNERGY_98';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion98;
