/**
 * ElementalSynergyMatrix_Combustion53.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 53
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion53 {
  constructor() {
    this.matrixId = 'SYNERGY_53';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion53;
