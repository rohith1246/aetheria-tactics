/**
 * ElementalSynergyMatrix_Combustion79.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 79
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion79 {
  constructor() {
    this.matrixId = 'SYNERGY_79';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion79;
