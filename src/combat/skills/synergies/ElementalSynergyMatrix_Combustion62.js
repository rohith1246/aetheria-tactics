/**
 * ElementalSynergyMatrix_Combustion62.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 62
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion62 {
  constructor() {
    this.matrixId = 'SYNERGY_62';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion62;
