/**
 * ElementalSynergyMatrix_Combustion59.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 59
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion59 {
  constructor() {
    this.matrixId = 'SYNERGY_59';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion59;
