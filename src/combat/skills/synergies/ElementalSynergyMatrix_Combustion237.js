/**
 * ElementalSynergyMatrix_Combustion237.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 237
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion237 {
  constructor() {
    this.matrixId = 'SYNERGY_237';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion237;
