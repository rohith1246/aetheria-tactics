/**
 * ElementalSynergyMatrix_Combustion240.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 240
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion240 {
  constructor() {
    this.matrixId = 'SYNERGY_240';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion240;
