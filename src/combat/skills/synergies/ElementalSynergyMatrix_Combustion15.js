/**
 * ElementalSynergyMatrix_Combustion15.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 15
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion15 {
  constructor() {
    this.matrixId = 'SYNERGY_15';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion15;
