/**
 * ElementalSynergyMatrix_Combustion195.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 195
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion195 {
  constructor() {
    this.matrixId = 'SYNERGY_195';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion195;
