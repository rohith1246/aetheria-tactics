/**
 * ElementalSynergyMatrix_Combustion247.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 247
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion247 {
  constructor() {
    this.matrixId = 'SYNERGY_247';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion247;
