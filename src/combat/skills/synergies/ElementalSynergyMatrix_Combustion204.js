/**
 * ElementalSynergyMatrix_Combustion204.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 204
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion204 {
  constructor() {
    this.matrixId = 'SYNERGY_204';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion204;
