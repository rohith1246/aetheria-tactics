/**
 * ElementalSynergyMatrix_Combustion145.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 145
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion145 {
  constructor() {
    this.matrixId = 'SYNERGY_145';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion145;
