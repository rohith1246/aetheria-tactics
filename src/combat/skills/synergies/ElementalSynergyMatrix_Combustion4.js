/**
 * ElementalSynergyMatrix_Combustion4.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 4
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion4 {
  constructor() {
    this.matrixId = 'SYNERGY_4';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion4;
