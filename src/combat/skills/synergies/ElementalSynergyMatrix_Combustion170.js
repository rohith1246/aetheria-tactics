/**
 * ElementalSynergyMatrix_Combustion170.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 170
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion170 {
  constructor() {
    this.matrixId = 'SYNERGY_170';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion170;
