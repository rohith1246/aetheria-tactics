/**
 * ElementalSynergyMatrix_Combustion197.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 197
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion197 {
  constructor() {
    this.matrixId = 'SYNERGY_197';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion197;
