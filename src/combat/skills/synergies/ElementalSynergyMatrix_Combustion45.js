/**
 * ElementalSynergyMatrix_Combustion45.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 45
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion45 {
  constructor() {
    this.matrixId = 'SYNERGY_45';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion45;
