/**
 * ElementalSynergyMatrix_Combustion114.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 114
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion114 {
  constructor() {
    this.matrixId = 'SYNERGY_114';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion114;
