/**
 * ElementalSynergyMatrix_Combustion126.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 126
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion126 {
  constructor() {
    this.matrixId = 'SYNERGY_126';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion126;
