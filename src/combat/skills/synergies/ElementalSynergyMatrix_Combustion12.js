/**
 * ElementalSynergyMatrix_Combustion12.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 12
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion12 {
  constructor() {
    this.matrixId = 'SYNERGY_12';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion12;
