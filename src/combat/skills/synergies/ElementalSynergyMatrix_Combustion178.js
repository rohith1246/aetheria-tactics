/**
 * ElementalSynergyMatrix_Combustion178.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 178
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion178 {
  constructor() {
    this.matrixId = 'SYNERGY_178';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion178;
