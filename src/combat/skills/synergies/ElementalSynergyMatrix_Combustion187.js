/**
 * ElementalSynergyMatrix_Combustion187.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 187
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion187 {
  constructor() {
    this.matrixId = 'SYNERGY_187';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion187;
