/**
 * ElementalSynergyMatrix_Combustion37.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 37
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion37 {
  constructor() {
    this.matrixId = 'SYNERGY_37';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion37;
