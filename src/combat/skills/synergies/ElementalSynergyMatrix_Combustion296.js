/**
 * ElementalSynergyMatrix_Combustion296.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 296
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion296 {
  constructor() {
    this.matrixId = 'SYNERGY_296';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion296;
