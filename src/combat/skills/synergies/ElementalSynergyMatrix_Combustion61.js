/**
 * ElementalSynergyMatrix_Combustion61.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 61
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion61 {
  constructor() {
    this.matrixId = 'SYNERGY_61';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion61;
