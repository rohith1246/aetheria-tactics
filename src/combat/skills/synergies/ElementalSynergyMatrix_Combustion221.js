/**
 * ElementalSynergyMatrix_Combustion221.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 221
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion221 {
  constructor() {
    this.matrixId = 'SYNERGY_221';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion221;
