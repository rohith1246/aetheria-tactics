/**
 * ElementalSynergyMatrix_Combustion82.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 82
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion82 {
  constructor() {
    this.matrixId = 'SYNERGY_82';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion82;
