/**
 * ElementalSynergyMatrix_Combustion70.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 70
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion70 {
  constructor() {
    this.matrixId = 'SYNERGY_70';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion70;
