/**
 * ElementalSynergyMatrix_Combustion55.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 55
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion55 {
  constructor() {
    this.matrixId = 'SYNERGY_55';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion55;
