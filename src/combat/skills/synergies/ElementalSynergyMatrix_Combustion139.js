/**
 * ElementalSynergyMatrix_Combustion139.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 139
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion139 {
  constructor() {
    this.matrixId = 'SYNERGY_139';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion139;
