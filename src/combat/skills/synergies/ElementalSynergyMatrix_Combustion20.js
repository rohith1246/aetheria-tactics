/**
 * ElementalSynergyMatrix_Combustion20.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 20
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion20 {
  constructor() {
    this.matrixId = 'SYNERGY_20';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion20;
