/**
 * ElementalSynergyMatrix_Combustion97.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 97
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion97 {
  constructor() {
    this.matrixId = 'SYNERGY_97';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion97;
