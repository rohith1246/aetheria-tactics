/**
 * ElementalSynergyMatrix_Combustion202.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 202
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion202 {
  constructor() {
    this.matrixId = 'SYNERGY_202';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion202;
