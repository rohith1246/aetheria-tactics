/**
 * ElementalSynergyMatrix_Combustion269.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 269
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion269 {
  constructor() {
    this.matrixId = 'SYNERGY_269';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion269;
