/**
 * ElementalSynergyMatrix_Combustion313.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 313
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion313 {
  constructor() {
    this.matrixId = 'SYNERGY_313';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion313;
