/**
 * ElementalSynergyMatrix_Combustion120.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 120
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion120 {
  constructor() {
    this.matrixId = 'SYNERGY_120';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion120;
