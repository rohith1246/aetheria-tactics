/**
 * ElementalSynergyMatrix_Combustion76.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 76
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion76 {
  constructor() {
    this.matrixId = 'SYNERGY_76';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion76;
