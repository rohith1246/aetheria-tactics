/**
 * ElementalSynergyMatrix_Combustion279.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 279
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion279 {
  constructor() {
    this.matrixId = 'SYNERGY_279';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion279;
