/**
 * ElementalSynergyMatrix_Combustion66.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 66
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion66 {
  constructor() {
    this.matrixId = 'SYNERGY_66';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion66;
