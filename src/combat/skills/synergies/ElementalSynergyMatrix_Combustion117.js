/**
 * ElementalSynergyMatrix_Combustion117.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 117
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion117 {
  constructor() {
    this.matrixId = 'SYNERGY_117';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion117;
