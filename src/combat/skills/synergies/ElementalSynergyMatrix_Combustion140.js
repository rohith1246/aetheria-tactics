/**
 * ElementalSynergyMatrix_Combustion140.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 140
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion140 {
  constructor() {
    this.matrixId = 'SYNERGY_140';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion140;
