/**
 * ElementalSynergyMatrix_Combustion273.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 273
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion273 {
  constructor() {
    this.matrixId = 'SYNERGY_273';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion273;
