/**
 * ElementalSynergyMatrix_Combustion171.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 171
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion171 {
  constructor() {
    this.matrixId = 'SYNERGY_171';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion171;
