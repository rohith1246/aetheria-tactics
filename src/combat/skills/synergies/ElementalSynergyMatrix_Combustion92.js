/**
 * ElementalSynergyMatrix_Combustion92.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 92
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion92 {
  constructor() {
    this.matrixId = 'SYNERGY_92';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion92;
