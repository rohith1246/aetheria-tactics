/**
 * ElementalSynergyMatrix_Combustion38.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 38
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion38 {
  constructor() {
    this.matrixId = 'SYNERGY_38';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion38;
