/**
 * ElementalSynergyMatrix_Combustion137.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 137
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion137 {
  constructor() {
    this.matrixId = 'SYNERGY_137';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion137;
