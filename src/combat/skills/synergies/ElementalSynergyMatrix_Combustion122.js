/**
 * ElementalSynergyMatrix_Combustion122.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 122
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion122 {
  constructor() {
    this.matrixId = 'SYNERGY_122';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion122;
