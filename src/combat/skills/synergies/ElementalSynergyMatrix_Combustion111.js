/**
 * ElementalSynergyMatrix_Combustion111.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 111
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion111 {
  constructor() {
    this.matrixId = 'SYNERGY_111';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion111;
