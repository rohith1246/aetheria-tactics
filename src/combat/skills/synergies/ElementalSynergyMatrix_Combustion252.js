/**
 * ElementalSynergyMatrix_Combustion252.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 252
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion252 {
  constructor() {
    this.matrixId = 'SYNERGY_252';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion252;
