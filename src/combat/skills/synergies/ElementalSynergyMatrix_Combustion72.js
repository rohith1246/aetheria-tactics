/**
 * ElementalSynergyMatrix_Combustion72.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 72
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion72 {
  constructor() {
    this.matrixId = 'SYNERGY_72';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion72;
