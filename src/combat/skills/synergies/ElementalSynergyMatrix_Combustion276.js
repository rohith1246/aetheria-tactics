/**
 * ElementalSynergyMatrix_Combustion276.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 276
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion276 {
  constructor() {
    this.matrixId = 'SYNERGY_276';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion276;
