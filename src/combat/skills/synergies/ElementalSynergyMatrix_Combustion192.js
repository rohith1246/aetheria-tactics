/**
 * ElementalSynergyMatrix_Combustion192.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 192
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion192 {
  constructor() {
    this.matrixId = 'SYNERGY_192';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion192;
