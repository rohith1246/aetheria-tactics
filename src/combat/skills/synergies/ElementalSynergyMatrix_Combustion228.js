/**
 * ElementalSynergyMatrix_Combustion228.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 228
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion228 {
  constructor() {
    this.matrixId = 'SYNERGY_228';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion228;
