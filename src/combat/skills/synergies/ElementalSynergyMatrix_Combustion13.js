/**
 * ElementalSynergyMatrix_Combustion13.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 13
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion13 {
  constructor() {
    this.matrixId = 'SYNERGY_13';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion13;
