/**
 * ElementalSynergyMatrix_Combustion261.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 261
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion261 {
  constructor() {
    this.matrixId = 'SYNERGY_261';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion261;
