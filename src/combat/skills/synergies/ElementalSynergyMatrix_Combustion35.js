/**
 * ElementalSynergyMatrix_Combustion35.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 35
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion35 {
  constructor() {
    this.matrixId = 'SYNERGY_35';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion35;
