/**
 * ElementalSynergyMatrix_Combustion78.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 78
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion78 {
  constructor() {
    this.matrixId = 'SYNERGY_78';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion78;
