/**
 * ElementalSynergyMatrix_Combustion48.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 48
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion48 {
  constructor() {
    this.matrixId = 'SYNERGY_48';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion48;
