/**
 * ElementalSynergyMatrix_Combustion189.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 189
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion189 {
  constructor() {
    this.matrixId = 'SYNERGY_189';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion189;
