/**
 * ElementalSynergyMatrix_Combustion246.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 246
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion246 {
  constructor() {
    this.matrixId = 'SYNERGY_246';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion246;
