/**
 * ElementalSynergyMatrix_Combustion105.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 105
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion105 {
  constructor() {
    this.matrixId = 'SYNERGY_105';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion105;
