/**
 * ElementalSynergyMatrix_Combustion113.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 113
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion113 {
  constructor() {
    this.matrixId = 'SYNERGY_113';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion113;
