/**
 * ElementalSynergyMatrix_Combustion84.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 84
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion84 {
  constructor() {
    this.matrixId = 'SYNERGY_84';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion84;
