/**
 * ElementalSynergyMatrix_Combustion81.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 81
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion81 {
  constructor() {
    this.matrixId = 'SYNERGY_81';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion81;
