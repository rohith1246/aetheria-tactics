/**
 * ElementalSynergyMatrix_Combustion301.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 301
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion301 {
  constructor() {
    this.matrixId = 'SYNERGY_301';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion301;
