/**
 * ElementalSynergyMatrix_Combustion109.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 109
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion109 {
  constructor() {
    this.matrixId = 'SYNERGY_109';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion109;
