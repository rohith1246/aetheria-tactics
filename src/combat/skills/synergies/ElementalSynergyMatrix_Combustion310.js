/**
 * ElementalSynergyMatrix_Combustion310.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 310
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion310 {
  constructor() {
    this.matrixId = 'SYNERGY_310';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion310;
