/**
 * ElementalSynergyMatrix_Combustion22.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 22
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion22 {
  constructor() {
    this.matrixId = 'SYNERGY_22';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion22;
