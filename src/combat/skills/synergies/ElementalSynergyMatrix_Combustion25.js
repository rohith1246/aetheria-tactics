/**
 * ElementalSynergyMatrix_Combustion25.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 25
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion25 {
  constructor() {
    this.matrixId = 'SYNERGY_25';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion25;
