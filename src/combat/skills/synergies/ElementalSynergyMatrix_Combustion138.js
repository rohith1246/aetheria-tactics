/**
 * ElementalSynergyMatrix_Combustion138.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 138
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion138 {
  constructor() {
    this.matrixId = 'SYNERGY_138';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion138;
