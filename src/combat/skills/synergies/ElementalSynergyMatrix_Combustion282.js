/**
 * ElementalSynergyMatrix_Combustion282.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 282
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion282 {
  constructor() {
    this.matrixId = 'SYNERGY_282';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion282;
