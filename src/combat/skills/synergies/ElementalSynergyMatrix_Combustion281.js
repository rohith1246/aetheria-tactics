/**
 * ElementalSynergyMatrix_Combustion281.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 281
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion281 {
  constructor() {
    this.matrixId = 'SYNERGY_281';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion281;
