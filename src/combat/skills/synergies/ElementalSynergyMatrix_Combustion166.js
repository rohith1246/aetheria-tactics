/**
 * ElementalSynergyMatrix_Combustion166.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 166
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion166 {
  constructor() {
    this.matrixId = 'SYNERGY_166';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion166;
