/**
 * ElementalSynergyMatrix_Combustion226.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 226
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion226 {
  constructor() {
    this.matrixId = 'SYNERGY_226';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion226;
