/**
 * ElementalSynergyMatrix_Combustion275.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 275
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion275 {
  constructor() {
    this.matrixId = 'SYNERGY_275';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion275;
