/**
 * ElementalSynergyMatrix_Combustion123.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 123
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion123 {
  constructor() {
    this.matrixId = 'SYNERGY_123';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion123;
