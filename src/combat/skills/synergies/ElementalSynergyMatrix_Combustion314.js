/**
 * ElementalSynergyMatrix_Combustion314.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 314
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion314 {
  constructor() {
    this.matrixId = 'SYNERGY_314';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion314;
