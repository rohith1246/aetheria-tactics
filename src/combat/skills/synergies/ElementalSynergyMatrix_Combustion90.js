/**
 * ElementalSynergyMatrix_Combustion90.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 90
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion90 {
  constructor() {
    this.matrixId = 'SYNERGY_90';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion90;
