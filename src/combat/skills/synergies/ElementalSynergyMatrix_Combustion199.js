/**
 * ElementalSynergyMatrix_Combustion199.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 199
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion199 {
  constructor() {
    this.matrixId = 'SYNERGY_199';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion199;
