/**
 * ElementalSynergyMatrix_Combustion54.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 54
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion54 {
  constructor() {
    this.matrixId = 'SYNERGY_54';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion54;
