/**
 * ElementalSynergyMatrix_Combustion177.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 177
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion177 {
  constructor() {
    this.matrixId = 'SYNERGY_177';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion177;
