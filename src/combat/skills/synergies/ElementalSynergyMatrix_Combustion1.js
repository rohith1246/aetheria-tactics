/**
 * ElementalSynergyMatrix_Combustion1.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 1
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion1 {
  constructor() {
    this.matrixId = 'SYNERGY_1';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion1;
