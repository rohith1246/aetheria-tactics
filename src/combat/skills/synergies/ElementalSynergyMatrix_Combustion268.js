/**
 * ElementalSynergyMatrix_Combustion268.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 268
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion268 {
  constructor() {
    this.matrixId = 'SYNERGY_268';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion268;
