/**
 * ElementalSynergyMatrix_Combustion108.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 108
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion108 {
  constructor() {
    this.matrixId = 'SYNERGY_108';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion108;
