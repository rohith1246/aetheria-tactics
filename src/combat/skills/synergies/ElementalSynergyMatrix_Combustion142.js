/**
 * ElementalSynergyMatrix_Combustion142.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 142
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion142 {
  constructor() {
    this.matrixId = 'SYNERGY_142';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion142;
