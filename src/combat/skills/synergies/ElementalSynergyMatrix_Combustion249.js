/**
 * ElementalSynergyMatrix_Combustion249.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 249
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion249 {
  constructor() {
    this.matrixId = 'SYNERGY_249';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion249;
