/**
 * ElementalSynergyMatrix_Combustion211.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 211
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion211 {
  constructor() {
    this.matrixId = 'SYNERGY_211';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion211;
