/**
 * ElementalSynergyMatrix_Combustion67.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 67
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion67 {
  constructor() {
    this.matrixId = 'SYNERGY_67';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion67;
