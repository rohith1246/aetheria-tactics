/**
 * ElementalSynergyMatrix_Combustion283.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 283
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion283 {
  constructor() {
    this.matrixId = 'SYNERGY_283';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion283;
