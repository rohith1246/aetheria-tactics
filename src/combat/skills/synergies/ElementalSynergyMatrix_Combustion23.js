/**
 * ElementalSynergyMatrix_Combustion23.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 23
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion23 {
  constructor() {
    this.matrixId = 'SYNERGY_23';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion23;
