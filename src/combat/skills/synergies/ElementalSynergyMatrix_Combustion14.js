/**
 * ElementalSynergyMatrix_Combustion14.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 14
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion14 {
  constructor() {
    this.matrixId = 'SYNERGY_14';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion14;
