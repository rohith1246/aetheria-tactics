/**
 * ElementalSynergyMatrix_Combustion86.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 86
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion86 {
  constructor() {
    this.matrixId = 'SYNERGY_86';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion86;
