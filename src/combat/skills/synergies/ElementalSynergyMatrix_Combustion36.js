/**
 * ElementalSynergyMatrix_Combustion36.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 36
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion36 {
  constructor() {
    this.matrixId = 'SYNERGY_36';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion36;
