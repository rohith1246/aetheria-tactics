/**
 * ElementalSynergyMatrix_Combustion185.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 185
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion185 {
  constructor() {
    this.matrixId = 'SYNERGY_185';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion185;
