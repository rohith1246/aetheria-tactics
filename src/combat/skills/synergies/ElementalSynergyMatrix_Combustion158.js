/**
 * ElementalSynergyMatrix_Combustion158.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 158
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion158 {
  constructor() {
    this.matrixId = 'SYNERGY_158';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion158;
