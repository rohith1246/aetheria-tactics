/**
 * ElementalSynergyMatrix_Combustion130.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 130
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion130 {
  constructor() {
    this.matrixId = 'SYNERGY_130';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion130;
