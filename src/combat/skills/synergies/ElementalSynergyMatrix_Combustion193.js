/**
 * ElementalSynergyMatrix_Combustion193.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 193
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion193 {
  constructor() {
    this.matrixId = 'SYNERGY_193';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion193;
