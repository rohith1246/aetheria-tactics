/**
 * ElementalSynergyMatrix_Combustion106.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 106
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion106 {
  constructor() {
    this.matrixId = 'SYNERGY_106';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion106;
