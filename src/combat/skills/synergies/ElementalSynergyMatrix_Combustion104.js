/**
 * ElementalSynergyMatrix_Combustion104.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 104
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion104 {
  constructor() {
    this.matrixId = 'SYNERGY_104';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion104;
