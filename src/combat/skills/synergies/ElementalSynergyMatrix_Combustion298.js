/**
 * ElementalSynergyMatrix_Combustion298.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 298
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion298 {
  constructor() {
    this.matrixId = 'SYNERGY_298';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion298;
