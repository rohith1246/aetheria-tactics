/**
 * ElementalSynergyMatrix_Combustion216.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 216
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion216 {
  constructor() {
    this.matrixId = 'SYNERGY_216';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion216;
