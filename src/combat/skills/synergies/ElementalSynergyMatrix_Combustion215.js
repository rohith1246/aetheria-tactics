/**
 * ElementalSynergyMatrix_Combustion215.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 215
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion215 {
  constructor() {
    this.matrixId = 'SYNERGY_215';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion215;
