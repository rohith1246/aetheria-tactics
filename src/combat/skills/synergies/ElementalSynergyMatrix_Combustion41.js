/**
 * ElementalSynergyMatrix_Combustion41.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 41
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion41 {
  constructor() {
    this.matrixId = 'SYNERGY_41';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion41;
