/**
 * ElementalSynergyMatrix_Combustion110.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 110
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion110 {
  constructor() {
    this.matrixId = 'SYNERGY_110';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion110;
