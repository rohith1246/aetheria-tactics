/**
 * ElementalSynergyMatrix_Combustion60.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 60
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion60 {
  constructor() {
    this.matrixId = 'SYNERGY_60';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion60;
