/**
 * ElementalSynergyMatrix_Combustion7.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 7
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion7 {
  constructor() {
    this.matrixId = 'SYNERGY_7';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion7;
