/**
 * ElementalSynergyMatrix_Combustion100.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 100
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion100 {
  constructor() {
    this.matrixId = 'SYNERGY_100';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion100;
