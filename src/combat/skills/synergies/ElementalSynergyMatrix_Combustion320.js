/**
 * ElementalSynergyMatrix_Combustion320.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 320
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion320 {
  constructor() {
    this.matrixId = 'SYNERGY_320';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion320;
