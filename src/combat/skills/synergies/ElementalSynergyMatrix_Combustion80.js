/**
 * ElementalSynergyMatrix_Combustion80.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 80
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion80 {
  constructor() {
    this.matrixId = 'SYNERGY_80';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion80;
