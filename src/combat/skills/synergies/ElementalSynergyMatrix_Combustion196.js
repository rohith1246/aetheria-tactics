/**
 * ElementalSynergyMatrix_Combustion196.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 196
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion196 {
  constructor() {
    this.matrixId = 'SYNERGY_196';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion196;
