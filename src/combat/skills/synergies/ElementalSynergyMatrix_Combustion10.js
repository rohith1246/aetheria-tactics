/**
 * ElementalSynergyMatrix_Combustion10.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 10
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion10 {
  constructor() {
    this.matrixId = 'SYNERGY_10';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion10;
