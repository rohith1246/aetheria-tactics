/**
 * ElementalSynergyMatrix_Combustion183.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 183
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion183 {
  constructor() {
    this.matrixId = 'SYNERGY_183';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion183;
