/**
 * ElementalSynergyMatrix_Combustion205.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 205
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion205 {
  constructor() {
    this.matrixId = 'SYNERGY_205';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion205;
