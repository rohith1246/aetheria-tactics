/**
 * ElementalSynergyMatrix_Combustion184.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 184
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion184 {
  constructor() {
    this.matrixId = 'SYNERGY_184';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion184;
