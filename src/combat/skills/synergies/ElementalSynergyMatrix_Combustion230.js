/**
 * ElementalSynergyMatrix_Combustion230.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 230
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion230 {
  constructor() {
    this.matrixId = 'SYNERGY_230';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion230;
