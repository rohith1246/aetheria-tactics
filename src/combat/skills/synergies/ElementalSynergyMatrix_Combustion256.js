/**
 * ElementalSynergyMatrix_Combustion256.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 256
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion256 {
  constructor() {
    this.matrixId = 'SYNERGY_256';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion256;
