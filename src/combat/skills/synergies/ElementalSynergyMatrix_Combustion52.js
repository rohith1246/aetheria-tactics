/**
 * ElementalSynergyMatrix_Combustion52.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 52
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion52 {
  constructor() {
    this.matrixId = 'SYNERGY_52';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion52;
