/**
 * ElementalSynergyMatrix_Combustion305.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 305
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion305 {
  constructor() {
    this.matrixId = 'SYNERGY_305';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion305;
