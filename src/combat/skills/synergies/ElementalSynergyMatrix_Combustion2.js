/**
 * ElementalSynergyMatrix_Combustion2.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 2
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion2 {
  constructor() {
    this.matrixId = 'SYNERGY_2';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion2;
