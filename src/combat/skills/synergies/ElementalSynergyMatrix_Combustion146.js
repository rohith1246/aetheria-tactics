/**
 * ElementalSynergyMatrix_Combustion146.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 146
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion146 {
  constructor() {
    this.matrixId = 'SYNERGY_146';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion146;
