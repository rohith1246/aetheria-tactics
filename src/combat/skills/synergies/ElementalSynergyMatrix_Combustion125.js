/**
 * ElementalSynergyMatrix_Combustion125.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 125
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion125 {
  constructor() {
    this.matrixId = 'SYNERGY_125';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion125;
