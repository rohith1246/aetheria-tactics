/**
 * ElementalSynergyMatrix_Combustion241.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 241
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion241 {
  constructor() {
    this.matrixId = 'SYNERGY_241';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion241;
