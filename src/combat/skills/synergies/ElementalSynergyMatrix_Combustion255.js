/**
 * ElementalSynergyMatrix_Combustion255.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 255
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion255 {
  constructor() {
    this.matrixId = 'SYNERGY_255';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion255;
