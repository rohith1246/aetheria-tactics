/**
 * ElementalSynergyMatrix_Combustion219.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 219
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion219 {
  constructor() {
    this.matrixId = 'SYNERGY_219';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion219;
