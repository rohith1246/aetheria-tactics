/**
 * ElementalSynergyMatrix_Combustion69.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 69
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion69 {
  constructor() {
    this.matrixId = 'SYNERGY_69';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion69;
