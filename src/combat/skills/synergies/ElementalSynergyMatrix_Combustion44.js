/**
 * ElementalSynergyMatrix_Combustion44.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 44
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion44 {
  constructor() {
    this.matrixId = 'SYNERGY_44';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion44;
