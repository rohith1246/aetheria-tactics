/**
 * ElementalSynergyMatrix_Combustion124.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 124
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion124 {
  constructor() {
    this.matrixId = 'SYNERGY_124';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion124;
