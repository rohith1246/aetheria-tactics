/**
 * ElementalSynergyMatrix_Combustion254.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 254
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion254 {
  constructor() {
    this.matrixId = 'SYNERGY_254';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion254;
