/**
 * ElementalSynergyMatrix_Combustion234.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 234
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion234 {
  constructor() {
    this.matrixId = 'SYNERGY_234';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion234;
