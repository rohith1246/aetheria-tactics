/**
 * ElementalSynergyMatrix_Combustion9.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 9
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion9 {
  constructor() {
    this.matrixId = 'SYNERGY_9';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion9;
