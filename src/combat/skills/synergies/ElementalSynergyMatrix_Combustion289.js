/**
 * ElementalSynergyMatrix_Combustion289.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 289
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion289 {
  constructor() {
    this.matrixId = 'SYNERGY_289';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion289;
