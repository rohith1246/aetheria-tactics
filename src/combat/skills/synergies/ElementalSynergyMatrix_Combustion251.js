/**
 * ElementalSynergyMatrix_Combustion251.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 251
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion251 {
  constructor() {
    this.matrixId = 'SYNERGY_251';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion251;
