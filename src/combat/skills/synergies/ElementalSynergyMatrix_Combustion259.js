/**
 * ElementalSynergyMatrix_Combustion259.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 259
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion259 {
  constructor() {
    this.matrixId = 'SYNERGY_259';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion259;
