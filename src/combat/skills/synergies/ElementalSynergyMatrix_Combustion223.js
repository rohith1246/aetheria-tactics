/**
 * ElementalSynergyMatrix_Combustion223.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 223
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion223 {
  constructor() {
    this.matrixId = 'SYNERGY_223';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion223;
