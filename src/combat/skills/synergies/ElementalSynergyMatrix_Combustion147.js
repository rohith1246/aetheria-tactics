/**
 * ElementalSynergyMatrix_Combustion147.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 147
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion147 {
  constructor() {
    this.matrixId = 'SYNERGY_147';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion147;
