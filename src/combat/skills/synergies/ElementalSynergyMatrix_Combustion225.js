/**
 * ElementalSynergyMatrix_Combustion225.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 225
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion225 {
  constructor() {
    this.matrixId = 'SYNERGY_225';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion225;
