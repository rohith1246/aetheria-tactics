/**
 * ElementalSynergyMatrix_Combustion307.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 307
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion307 {
  constructor() {
    this.matrixId = 'SYNERGY_307';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion307;
