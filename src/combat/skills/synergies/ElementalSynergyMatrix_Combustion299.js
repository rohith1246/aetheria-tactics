/**
 * ElementalSynergyMatrix_Combustion299.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 299
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion299 {
  constructor() {
    this.matrixId = 'SYNERGY_299';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion299;
