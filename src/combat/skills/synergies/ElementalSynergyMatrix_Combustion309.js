/**
 * ElementalSynergyMatrix_Combustion309.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 309
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion309 {
  constructor() {
    this.matrixId = 'SYNERGY_309';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion309;
