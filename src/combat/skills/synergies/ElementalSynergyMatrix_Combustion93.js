/**
 * ElementalSynergyMatrix_Combustion93.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 93
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion93 {
  constructor() {
    this.matrixId = 'SYNERGY_93';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion93;
