/**
 * ElementalSynergyMatrix_Combustion286.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 286
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion286 {
  constructor() {
    this.matrixId = 'SYNERGY_286';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion286;
