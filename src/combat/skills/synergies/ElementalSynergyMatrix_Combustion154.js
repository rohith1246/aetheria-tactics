/**
 * ElementalSynergyMatrix_Combustion154.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 154
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion154 {
  constructor() {
    this.matrixId = 'SYNERGY_154';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion154;
