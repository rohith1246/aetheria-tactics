/**
 * ElementalSynergyMatrix_Combustion308.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 308
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion308 {
  constructor() {
    this.matrixId = 'SYNERGY_308';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion308;
