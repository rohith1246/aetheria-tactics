/**
 * ElementalSynergyMatrix_Combustion112.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 112
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion112 {
  constructor() {
    this.matrixId = 'SYNERGY_112';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion112;
