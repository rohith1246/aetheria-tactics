/**
 * ElementalSynergyMatrix_Combustion135.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 135
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion135 {
  constructor() {
    this.matrixId = 'SYNERGY_135';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion135;
