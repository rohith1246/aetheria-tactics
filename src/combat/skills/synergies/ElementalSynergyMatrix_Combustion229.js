/**
 * ElementalSynergyMatrix_Combustion229.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 229
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion229 {
  constructor() {
    this.matrixId = 'SYNERGY_229';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion229;
