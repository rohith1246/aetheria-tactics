/**
 * ElementalSynergyMatrix_Combustion212.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 212
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion212 {
  constructor() {
    this.matrixId = 'SYNERGY_212';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion212;
