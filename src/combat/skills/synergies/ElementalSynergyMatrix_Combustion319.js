/**
 * ElementalSynergyMatrix_Combustion319.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 319
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion319 {
  constructor() {
    this.matrixId = 'SYNERGY_319';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion319;
