/**
 * ElementalSynergyMatrix_Combustion172.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 172
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion172 {
  constructor() {
    this.matrixId = 'SYNERGY_172';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion172;
