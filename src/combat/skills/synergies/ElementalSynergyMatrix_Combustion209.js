/**
 * ElementalSynergyMatrix_Combustion209.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 209
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion209 {
  constructor() {
    this.matrixId = 'SYNERGY_209';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion209;
