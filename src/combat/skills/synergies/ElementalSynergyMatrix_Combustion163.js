/**
 * ElementalSynergyMatrix_Combustion163.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 163
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion163 {
  constructor() {
    this.matrixId = 'SYNERGY_163';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion163;
