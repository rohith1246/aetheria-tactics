/**
 * ElementalSynergyMatrix_Combustion210.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 210
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion210 {
  constructor() {
    this.matrixId = 'SYNERGY_210';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion210;
