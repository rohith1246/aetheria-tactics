/**
 * ElementalSynergyMatrix_Combustion291.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 291
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion291 {
  constructor() {
    this.matrixId = 'SYNERGY_291';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion291;
