/**
 * ElementalSynergyMatrix_Combustion131.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 131
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion131 {
  constructor() {
    this.matrixId = 'SYNERGY_131';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion131;
