/**
 * ElementalSynergyMatrix_Combustion24.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 24
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion24 {
  constructor() {
    this.matrixId = 'SYNERGY_24';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion24;
