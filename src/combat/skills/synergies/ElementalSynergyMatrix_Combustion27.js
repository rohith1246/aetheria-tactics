/**
 * ElementalSynergyMatrix_Combustion27.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 27
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion27 {
  constructor() {
    this.matrixId = 'SYNERGY_27';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion27;
