/**
 * ElementalSynergyMatrix_Combustion42.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 42
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion42 {
  constructor() {
    this.matrixId = 'SYNERGY_42';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion42;
