/**
 * ElementalSynergyMatrix_Combustion91.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 91
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion91 {
  constructor() {
    this.matrixId = 'SYNERGY_91';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion91;
