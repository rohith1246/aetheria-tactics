/**
 * ElementalSynergyMatrix_Combustion63.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 63
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion63 {
  constructor() {
    this.matrixId = 'SYNERGY_63';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion63;
