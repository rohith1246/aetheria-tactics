/**
 * ElementalSynergyMatrix_Combustion239.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 239
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion239 {
  constructor() {
    this.matrixId = 'SYNERGY_239';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion239;
