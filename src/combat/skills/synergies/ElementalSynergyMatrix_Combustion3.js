/**
 * ElementalSynergyMatrix_Combustion3.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 3
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion3 {
  constructor() {
    this.matrixId = 'SYNERGY_3';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion3;
