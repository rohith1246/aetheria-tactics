/**
 * ElementalSynergyMatrix_Combustion51.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 51
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion51 {
  constructor() {
    this.matrixId = 'SYNERGY_51';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion51;
