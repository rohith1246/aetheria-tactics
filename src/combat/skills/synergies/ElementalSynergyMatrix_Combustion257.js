/**
 * ElementalSynergyMatrix_Combustion257.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 257
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion257 {
  constructor() {
    this.matrixId = 'SYNERGY_257';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion257;
