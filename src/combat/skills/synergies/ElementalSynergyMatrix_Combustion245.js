/**
 * ElementalSynergyMatrix_Combustion245.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 245
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion245 {
  constructor() {
    this.matrixId = 'SYNERGY_245';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion245;
