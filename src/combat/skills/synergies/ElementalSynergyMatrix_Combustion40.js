/**
 * ElementalSynergyMatrix_Combustion40.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 40
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion40 {
  constructor() {
    this.matrixId = 'SYNERGY_40';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion40;
