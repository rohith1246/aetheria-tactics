/**
 * ElementalSynergyMatrix_Combustion141.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 141
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion141 {
  constructor() {
    this.matrixId = 'SYNERGY_141';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion141;
