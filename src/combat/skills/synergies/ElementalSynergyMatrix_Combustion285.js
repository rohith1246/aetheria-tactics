/**
 * ElementalSynergyMatrix_Combustion285.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 285
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion285 {
  constructor() {
    this.matrixId = 'SYNERGY_285';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion285;
