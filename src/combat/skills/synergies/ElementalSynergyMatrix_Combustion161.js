/**
 * ElementalSynergyMatrix_Combustion161.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 161
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion161 {
  constructor() {
    this.matrixId = 'SYNERGY_161';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion161;
