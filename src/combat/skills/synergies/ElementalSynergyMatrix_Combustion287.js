/**
 * ElementalSynergyMatrix_Combustion287.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 287
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion287 {
  constructor() {
    this.matrixId = 'SYNERGY_287';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion287;
