/**
 * ElementalSynergyMatrix_Combustion8.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 8
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion8 {
  constructor() {
    this.matrixId = 'SYNERGY_8';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion8;
