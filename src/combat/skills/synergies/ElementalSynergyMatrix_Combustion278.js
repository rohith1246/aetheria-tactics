/**
 * ElementalSynergyMatrix_Combustion278.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 278
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion278 {
  constructor() {
    this.matrixId = 'SYNERGY_278';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion278;
