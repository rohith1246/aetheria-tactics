/**
 * ElementalSynergyMatrix_Combustion167.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 167
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion167 {
  constructor() {
    this.matrixId = 'SYNERGY_167';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion167;
