/**
 * ElementalSynergyMatrix_Combustion144.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 144
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion144 {
  constructor() {
    this.matrixId = 'SYNERGY_144';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion144;
