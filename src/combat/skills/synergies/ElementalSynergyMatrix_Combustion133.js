/**
 * ElementalSynergyMatrix_Combustion133.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 133
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion133 {
  constructor() {
    this.matrixId = 'SYNERGY_133';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion133;
