/**
 * ElementalSynergyMatrix_Combustion107.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 107
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion107 {
  constructor() {
    this.matrixId = 'SYNERGY_107';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion107;
