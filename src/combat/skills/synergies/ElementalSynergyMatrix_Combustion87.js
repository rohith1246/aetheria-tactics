/**
 * ElementalSynergyMatrix_Combustion87.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 87
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion87 {
  constructor() {
    this.matrixId = 'SYNERGY_87';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion87;
