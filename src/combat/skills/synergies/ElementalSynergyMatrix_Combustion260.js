/**
 * ElementalSynergyMatrix_Combustion260.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 260
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion260 {
  constructor() {
    this.matrixId = 'SYNERGY_260';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion260;
