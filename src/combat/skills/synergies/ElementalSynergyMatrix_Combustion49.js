/**
 * ElementalSynergyMatrix_Combustion49.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 49
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion49 {
  constructor() {
    this.matrixId = 'SYNERGY_49';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion49;
