/**
 * ElementalSynergyMatrix_Combustion220.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 220
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion220 {
  constructor() {
    this.matrixId = 'SYNERGY_220';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion220;
