/**
 * ElementalSynergyMatrix_Combustion186.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 186
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion186 {
  constructor() {
    this.matrixId = 'SYNERGY_186';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion186;
