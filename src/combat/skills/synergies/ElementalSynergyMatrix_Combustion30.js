/**
 * ElementalSynergyMatrix_Combustion30.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 30
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion30 {
  constructor() {
    this.matrixId = 'SYNERGY_30';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion30;
