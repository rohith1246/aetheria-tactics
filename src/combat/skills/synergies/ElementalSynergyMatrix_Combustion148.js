/**
 * ElementalSynergyMatrix_Combustion148.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 148
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion148 {
  constructor() {
    this.matrixId = 'SYNERGY_148';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion148;
