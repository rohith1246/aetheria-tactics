/**
 * ElementalSynergyMatrix_Combustion224.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 224
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion224 {
  constructor() {
    this.matrixId = 'SYNERGY_224';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion224;
