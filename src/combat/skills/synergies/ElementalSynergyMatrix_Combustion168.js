/**
 * ElementalSynergyMatrix_Combustion168.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 168
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion168 {
  constructor() {
    this.matrixId = 'SYNERGY_168';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion168;
