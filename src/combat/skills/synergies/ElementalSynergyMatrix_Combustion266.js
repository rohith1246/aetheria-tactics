/**
 * ElementalSynergyMatrix_Combustion266.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 266
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion266 {
  constructor() {
    this.matrixId = 'SYNERGY_266';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion266;
