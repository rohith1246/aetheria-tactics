/**
 * ElementalSynergyMatrix_Combustion128.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 128
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion128 {
  constructor() {
    this.matrixId = 'SYNERGY_128';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion128;
