/**
 * ElementalSynergyMatrix_Combustion274.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 274
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion274 {
  constructor() {
    this.matrixId = 'SYNERGY_274';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion274;
