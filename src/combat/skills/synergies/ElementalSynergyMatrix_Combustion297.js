/**
 * ElementalSynergyMatrix_Combustion297.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 297
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion297 {
  constructor() {
    this.matrixId = 'SYNERGY_297';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion297;
