/**
 * ElementalSynergyMatrix_Combustion270.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 270
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion270 {
  constructor() {
    this.matrixId = 'SYNERGY_270';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion270;
