/**
 * ElementalSynergyMatrix_Combustion5.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 5
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion5 {
  constructor() {
    this.matrixId = 'SYNERGY_5';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion5;
