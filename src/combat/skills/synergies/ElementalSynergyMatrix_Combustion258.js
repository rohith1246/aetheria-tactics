/**
 * ElementalSynergyMatrix_Combustion258.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 258
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion258 {
  constructor() {
    this.matrixId = 'SYNERGY_258';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion258;
