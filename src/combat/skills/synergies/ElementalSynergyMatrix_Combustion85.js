/**
 * ElementalSynergyMatrix_Combustion85.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 85
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion85 {
  constructor() {
    this.matrixId = 'SYNERGY_85';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion85;
