/**
 * ElementalSynergyMatrix_Combustion263.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 263
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion263 {
  constructor() {
    this.matrixId = 'SYNERGY_263';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion263;
