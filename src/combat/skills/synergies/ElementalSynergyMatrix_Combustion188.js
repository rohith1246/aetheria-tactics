/**
 * ElementalSynergyMatrix_Combustion188.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 188
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion188 {
  constructor() {
    this.matrixId = 'SYNERGY_188';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion188;
