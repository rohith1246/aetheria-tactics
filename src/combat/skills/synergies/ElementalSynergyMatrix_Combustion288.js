/**
 * ElementalSynergyMatrix_Combustion288.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 288
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion288 {
  constructor() {
    this.matrixId = 'SYNERGY_288';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion288;
