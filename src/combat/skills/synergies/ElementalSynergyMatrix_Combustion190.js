/**
 * ElementalSynergyMatrix_Combustion190.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 190
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion190 {
  constructor() {
    this.matrixId = 'SYNERGY_190';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion190;
