/**
 * ElementalSynergyMatrix_Combustion182.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 182
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion182 {
  constructor() {
    this.matrixId = 'SYNERGY_182';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion182;
