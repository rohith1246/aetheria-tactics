/**
 * ElementalSynergyMatrix_Combustion194.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 194
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion194 {
  constructor() {
    this.matrixId = 'SYNERGY_194';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion194;
