/**
 * ElementalSynergyMatrix_Combustion169.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 169
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion169 {
  constructor() {
    this.matrixId = 'SYNERGY_169';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion169;
