/**
 * ElementalSynergyMatrix_Combustion132.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 132
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion132 {
  constructor() {
    this.matrixId = 'SYNERGY_132';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion132;
