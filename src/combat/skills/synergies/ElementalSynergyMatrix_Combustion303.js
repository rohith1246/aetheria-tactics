/**
 * ElementalSynergyMatrix_Combustion303.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 303
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion303 {
  constructor() {
    this.matrixId = 'SYNERGY_303';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion303;
