/**
 * ElementalSynergyMatrix_Combustion58.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 58
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion58 {
  constructor() {
    this.matrixId = 'SYNERGY_58';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion58;
