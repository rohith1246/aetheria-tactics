/**
 * ElementalSynergyMatrix_Combustion127.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 127
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion127 {
  constructor() {
    this.matrixId = 'SYNERGY_127';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion127;
