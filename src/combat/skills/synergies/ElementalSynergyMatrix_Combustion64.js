/**
 * ElementalSynergyMatrix_Combustion64.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 64
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion64 {
  constructor() {
    this.matrixId = 'SYNERGY_64';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion64;
