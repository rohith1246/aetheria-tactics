/**
 * ElementalSynergyMatrix_Combustion231.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 231
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion231 {
  constructor() {
    this.matrixId = 'SYNERGY_231';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion231;
