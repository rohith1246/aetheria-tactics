/**
 * ElementalSynergyMatrix_Combustion264.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 264
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion264 {
  constructor() {
    this.matrixId = 'SYNERGY_264';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion264;
