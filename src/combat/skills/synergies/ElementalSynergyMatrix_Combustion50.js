/**
 * ElementalSynergyMatrix_Combustion50.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 50
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion50 {
  constructor() {
    this.matrixId = 'SYNERGY_50';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion50;
