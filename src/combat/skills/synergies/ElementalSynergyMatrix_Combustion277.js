/**
 * ElementalSynergyMatrix_Combustion277.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 277
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion277 {
  constructor() {
    this.matrixId = 'SYNERGY_277';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion277;
