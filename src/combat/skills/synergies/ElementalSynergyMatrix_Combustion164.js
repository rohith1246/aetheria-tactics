/**
 * ElementalSynergyMatrix_Combustion164.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 164
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion164 {
  constructor() {
    this.matrixId = 'SYNERGY_164';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion164;
