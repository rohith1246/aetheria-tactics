/**
 * ElementalSynergyMatrix_Combustion19.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 19
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion19 {
  constructor() {
    this.matrixId = 'SYNERGY_19';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion19;
