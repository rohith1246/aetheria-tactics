/**
 * ElementalSynergyMatrix_Combustion136.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 136
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion136 {
  constructor() {
    this.matrixId = 'SYNERGY_136';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion136;
