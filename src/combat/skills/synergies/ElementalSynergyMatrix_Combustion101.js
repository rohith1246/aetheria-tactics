/**
 * ElementalSynergyMatrix_Combustion101.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 101
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion101 {
  constructor() {
    this.matrixId = 'SYNERGY_101';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion101;
