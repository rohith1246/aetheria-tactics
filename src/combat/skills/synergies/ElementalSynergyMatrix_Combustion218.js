/**
 * ElementalSynergyMatrix_Combustion218.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 218
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion218 {
  constructor() {
    this.matrixId = 'SYNERGY_218';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion218;
