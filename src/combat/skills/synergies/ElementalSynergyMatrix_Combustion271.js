/**
 * ElementalSynergyMatrix_Combustion271.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 271
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion271 {
  constructor() {
    this.matrixId = 'SYNERGY_271';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion271;
