/**
 * ElementalSynergyMatrix_Combustion32.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 32
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion32 {
  constructor() {
    this.matrixId = 'SYNERGY_32';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion32;
