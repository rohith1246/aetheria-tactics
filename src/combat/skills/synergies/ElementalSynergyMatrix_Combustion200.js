/**
 * ElementalSynergyMatrix_Combustion200.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 200
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion200 {
  constructor() {
    this.matrixId = 'SYNERGY_200';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion200;
