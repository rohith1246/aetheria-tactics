/**
 * ElementalSynergyMatrix_Combustion293.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 293
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion293 {
  constructor() {
    this.matrixId = 'SYNERGY_293';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion293;
