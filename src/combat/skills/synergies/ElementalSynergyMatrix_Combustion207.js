/**
 * ElementalSynergyMatrix_Combustion207.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 207
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion207 {
  constructor() {
    this.matrixId = 'SYNERGY_207';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion207;
