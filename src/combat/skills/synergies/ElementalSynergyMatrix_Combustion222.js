/**
 * ElementalSynergyMatrix_Combustion222.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 222
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion222 {
  constructor() {
    this.matrixId = 'SYNERGY_222';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion222;
