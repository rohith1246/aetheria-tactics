/**
 * ElementalSynergyMatrix_Combustion236.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 236
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion236 {
  constructor() {
    this.matrixId = 'SYNERGY_236';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion236;
