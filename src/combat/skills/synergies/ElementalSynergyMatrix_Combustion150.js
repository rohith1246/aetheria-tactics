/**
 * ElementalSynergyMatrix_Combustion150.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 150
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion150 {
  constructor() {
    this.matrixId = 'SYNERGY_150';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion150;
