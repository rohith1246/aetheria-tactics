/**
 * ElementalSynergyMatrix_Combustion243.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 243
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion243 {
  constructor() {
    this.matrixId = 'SYNERGY_243';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion243;
