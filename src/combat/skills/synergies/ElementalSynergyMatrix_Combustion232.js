/**
 * ElementalSynergyMatrix_Combustion232.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 232
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion232 {
  constructor() {
    this.matrixId = 'SYNERGY_232';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion232;
