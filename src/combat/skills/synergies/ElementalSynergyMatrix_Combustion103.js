/**
 * ElementalSynergyMatrix_Combustion103.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 103
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion103 {
  constructor() {
    this.matrixId = 'SYNERGY_103';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion103;
