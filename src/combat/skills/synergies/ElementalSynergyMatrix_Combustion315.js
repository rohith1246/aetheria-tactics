/**
 * ElementalSynergyMatrix_Combustion315.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 315
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion315 {
  constructor() {
    this.matrixId = 'SYNERGY_315';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion315;
