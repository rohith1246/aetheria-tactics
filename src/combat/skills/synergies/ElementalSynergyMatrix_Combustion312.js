/**
 * ElementalSynergyMatrix_Combustion312.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 312
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion312 {
  constructor() {
    this.matrixId = 'SYNERGY_312';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion312;
