/**
 * ElementalSynergyMatrix_Combustion43.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 43
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion43 {
  constructor() {
    this.matrixId = 'SYNERGY_43';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion43;
