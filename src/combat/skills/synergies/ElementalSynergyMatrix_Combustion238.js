/**
 * ElementalSynergyMatrix_Combustion238.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 238
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion238 {
  constructor() {
    this.matrixId = 'SYNERGY_238';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion238;
