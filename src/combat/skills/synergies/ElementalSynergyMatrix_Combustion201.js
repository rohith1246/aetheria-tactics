/**
 * ElementalSynergyMatrix_Combustion201.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 201
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion201 {
  constructor() {
    this.matrixId = 'SYNERGY_201';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion201;
