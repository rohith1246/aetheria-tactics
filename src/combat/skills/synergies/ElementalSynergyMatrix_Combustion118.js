/**
 * ElementalSynergyMatrix_Combustion118.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 118
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion118 {
  constructor() {
    this.matrixId = 'SYNERGY_118';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion118;
