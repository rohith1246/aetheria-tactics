/**
 * ElementalSynergyMatrix_Combustion214.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 214
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion214 {
  constructor() {
    this.matrixId = 'SYNERGY_214';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion214;
