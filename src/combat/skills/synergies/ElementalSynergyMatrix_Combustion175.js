/**
 * ElementalSynergyMatrix_Combustion175.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 175
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion175 {
  constructor() {
    this.matrixId = 'SYNERGY_175';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion175;
