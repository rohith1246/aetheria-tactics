/**
 * ElementalSynergyMatrix_Combustion71.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 71
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion71 {
  constructor() {
    this.matrixId = 'SYNERGY_71';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion71;
