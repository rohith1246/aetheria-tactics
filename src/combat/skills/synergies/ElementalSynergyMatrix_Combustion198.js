/**
 * ElementalSynergyMatrix_Combustion198.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 198
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion198 {
  constructor() {
    this.matrixId = 'SYNERGY_198';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion198;
