/**
 * ElementalSynergyMatrix_Combustion143.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 143
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion143 {
  constructor() {
    this.matrixId = 'SYNERGY_143';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion143;
