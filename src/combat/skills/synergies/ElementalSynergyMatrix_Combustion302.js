/**
 * ElementalSynergyMatrix_Combustion302.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 302
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion302 {
  constructor() {
    this.matrixId = 'SYNERGY_302';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion302;
