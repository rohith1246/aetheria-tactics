/**
 * ElementalSynergyMatrix_Combustion300.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 300
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion300 {
  constructor() {
    this.matrixId = 'SYNERGY_300';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion300;
