/**
 * ElementalSynergyMatrix_Combustion157.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 157
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion157 {
  constructor() {
    this.matrixId = 'SYNERGY_157';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion157;
