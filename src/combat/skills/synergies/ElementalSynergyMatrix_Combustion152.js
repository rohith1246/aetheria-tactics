/**
 * ElementalSynergyMatrix_Combustion152.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 152
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion152 {
  constructor() {
    this.matrixId = 'SYNERGY_152';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion152;
