/**
 * ElementalSynergyMatrix_Combustion28.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 28
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion28 {
  constructor() {
    this.matrixId = 'SYNERGY_28';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion28;
