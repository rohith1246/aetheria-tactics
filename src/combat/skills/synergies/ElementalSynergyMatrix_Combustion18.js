/**
 * ElementalSynergyMatrix_Combustion18.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 18
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion18 {
  constructor() {
    this.matrixId = 'SYNERGY_18';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion18;
