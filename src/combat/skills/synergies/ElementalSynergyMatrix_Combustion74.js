/**
 * ElementalSynergyMatrix_Combustion74.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 74
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion74 {
  constructor() {
    this.matrixId = 'SYNERGY_74';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion74;
