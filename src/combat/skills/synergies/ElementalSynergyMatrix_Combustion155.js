/**
 * ElementalSynergyMatrix_Combustion155.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 155
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion155 {
  constructor() {
    this.matrixId = 'SYNERGY_155';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion155;
