/**
 * ElementalSynergyMatrix_Combustion77.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 77
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion77 {
  constructor() {
    this.matrixId = 'SYNERGY_77';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion77;
