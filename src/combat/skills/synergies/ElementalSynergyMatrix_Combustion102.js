/**
 * ElementalSynergyMatrix_Combustion102.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 102
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion102 {
  constructor() {
    this.matrixId = 'SYNERGY_102';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion102;
