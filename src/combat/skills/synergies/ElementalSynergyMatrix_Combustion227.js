/**
 * ElementalSynergyMatrix_Combustion227.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 227
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion227 {
  constructor() {
    this.matrixId = 'SYNERGY_227';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion227;
