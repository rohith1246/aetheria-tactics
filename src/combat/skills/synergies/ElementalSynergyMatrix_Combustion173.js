/**
 * ElementalSynergyMatrix_Combustion173.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 173
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion173 {
  constructor() {
    this.matrixId = 'SYNERGY_173';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion173;
