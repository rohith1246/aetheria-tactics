/**
 * ElementalSynergyMatrix_Combustion217.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 217
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion217 {
  constructor() {
    this.matrixId = 'SYNERGY_217';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion217;
