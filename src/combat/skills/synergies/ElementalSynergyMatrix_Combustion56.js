/**
 * ElementalSynergyMatrix_Combustion56.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 56
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion56 {
  constructor() {
    this.matrixId = 'SYNERGY_56';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion56;
