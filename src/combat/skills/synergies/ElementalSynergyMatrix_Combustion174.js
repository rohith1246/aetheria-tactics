/**
 * ElementalSynergyMatrix_Combustion174.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 174
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion174 {
  constructor() {
    this.matrixId = 'SYNERGY_174';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion174;
