/**
 * ElementalSynergyMatrix_Combustion311.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 311
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion311 {
  constructor() {
    this.matrixId = 'SYNERGY_311';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion311;
