/**
 * ElementalSynergyMatrix_Combustion242.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 242
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion242 {
  constructor() {
    this.matrixId = 'SYNERGY_242';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion242;
