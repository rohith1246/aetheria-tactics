/**
 * ElementalSynergyMatrix_Combustion156.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 156
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion156 {
  constructor() {
    this.matrixId = 'SYNERGY_156';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion156;
