/**
 * ElementalSynergyMatrix_Combustion6.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 6
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion6 {
  constructor() {
    this.matrixId = 'SYNERGY_6';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion6;
