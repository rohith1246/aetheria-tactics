/**
 * ElementalSynergyMatrix_Combustion295.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 295
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion295 {
  constructor() {
    this.matrixId = 'SYNERGY_295';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion295;
