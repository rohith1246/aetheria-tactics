/**
 * ElementalSynergyMatrix_Combustion121.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 121
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion121 {
  constructor() {
    this.matrixId = 'SYNERGY_121';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion121;
