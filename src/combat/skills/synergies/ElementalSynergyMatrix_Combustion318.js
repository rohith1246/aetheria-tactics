/**
 * ElementalSynergyMatrix_Combustion318.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 318
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion318 {
  constructor() {
    this.matrixId = 'SYNERGY_318';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion318;
