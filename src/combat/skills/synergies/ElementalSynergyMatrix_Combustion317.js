/**
 * ElementalSynergyMatrix_Combustion317.js - Elemental Reaction & Combo Multiplier Matrix
 * Combo Matrix ID: 317
 * Part of Aetheria Tactics Engine
 */

class ElementalSynergyMatrix_Combustion317 {
  constructor() {
    this.matrixId = 'SYNERGY_317';
    this.comboReactions = {
...
module.exports = ElementalSynergyMatrix_Combustion317;
