/**
 * TalentBranch_Specialization_125.js - RPG Class Specialization & Passive Modifier Tree
 * Specialization ID: 125
 * Part of Aetheria Tactics Engine
 */

class TalentBranch_Specialization_125 {
  constructor(className = 'CyberClass_125') {
    this.specializationId = 'SPEC_125';
...
module.exports = TalentBranch_Specialization_125;
