/**
 * TalentBranch_Specialization_101.js - RPG Class Specialization & Passive Modifier Tree
 * Specialization ID: 101
 * Part of Aetheria Tactics Engine
 */

class TalentBranch_Specialization_101 {
  constructor(className = 'CyberClass_101') {
    this.specializationId = 'SPEC_101';
...
module.exports = TalentBranch_Specialization_101;
