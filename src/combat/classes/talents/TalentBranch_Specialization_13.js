/**
 * TalentBranch_Specialization_13.js - RPG Class Specialization & Passive Modifier Tree
 * Specialization ID: 13
 * Part of Aetheria Tactics Engine
 */

class TalentBranch_Specialization_13 {
  constructor(className = 'CyberClass_13') {
    this.specializationId = 'SPEC_13';
...
module.exports = TalentBranch_Specialization_13;
