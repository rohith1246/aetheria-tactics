/**
 * TalentBranch_Specialization_80.js - RPG Class Specialization & Passive Modifier Tree
 * Specialization ID: 80
 * Part of Aetheria Tactics Engine
 */

class TalentBranch_Specialization_80 {
  constructor(className = 'CyberClass_80') {
    this.specializationId = 'SPEC_80';
...
module.exports = TalentBranch_Specialization_80;
