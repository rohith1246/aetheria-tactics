/**
 * TalentBranch_Specialization_84.js - RPG Class Specialization & Passive Modifier Tree
 * Specialization ID: 84
 * Part of Aetheria Tactics Engine
 */

class TalentBranch_Specialization_84 {
  constructor(className = 'CyberClass_84') {
    this.specializationId = 'SPEC_84';
...
module.exports = TalentBranch_Specialization_84;
