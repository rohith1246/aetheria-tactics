/**
 * TalentBranch_Specialization_91.js - RPG Class Specialization & Passive Modifier Tree
 * Specialization ID: 91
 * Part of Aetheria Tactics Engine
 */

class TalentBranch_Specialization_91 {
  constructor(className = 'CyberClass_91') {
    this.specializationId = 'SPEC_91';
...
module.exports = TalentBranch_Specialization_91;
