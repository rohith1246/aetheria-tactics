/**
 * TalentBranch_Specialization_36.js - RPG Class Specialization & Passive Modifier Tree
 * Specialization ID: 36
 * Part of Aetheria Tactics Engine
 */

class TalentBranch_Specialization_36 {
  constructor(className = 'CyberClass_36') {
    this.specializationId = 'SPEC_36';
...
module.exports = TalentBranch_Specialization_36;
