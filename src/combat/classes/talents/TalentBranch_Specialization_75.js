/**
 * TalentBranch_Specialization_75.js - RPG Class Specialization & Passive Modifier Tree
 * Specialization ID: 75
 * Part of Aetheria Tactics Engine
 */

class TalentBranch_Specialization_75 {
  constructor(className = 'CyberClass_75') {
    this.specializationId = 'SPEC_75';
...
module.exports = TalentBranch_Specialization_75;
