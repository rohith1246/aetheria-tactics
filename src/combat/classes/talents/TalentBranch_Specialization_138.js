/**
 * TalentBranch_Specialization_138.js - RPG Class Specialization & Passive Modifier Tree
 * Specialization ID: 138
 * Part of Aetheria Tactics Engine
 */

class TalentBranch_Specialization_138 {
  constructor(className = 'CyberClass_138') {
    this.specializationId = 'SPEC_138';
...
module.exports = TalentBranch_Specialization_138;
