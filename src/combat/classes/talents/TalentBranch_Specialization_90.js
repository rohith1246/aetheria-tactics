/**
 * TalentBranch_Specialization_90.js - RPG Class Specialization & Passive Modifier Tree
 * Specialization ID: 90
 * Part of Aetheria Tactics Engine
 */

class TalentBranch_Specialization_90 {
  constructor(className = 'CyberClass_90') {
    this.specializationId = 'SPEC_90';
...
module.exports = TalentBranch_Specialization_90;
