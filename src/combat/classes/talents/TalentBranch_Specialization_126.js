/**
 * TalentBranch_Specialization_126.js - RPG Class Specialization & Passive Modifier Tree
 * Specialization ID: 126
 * Part of Aetheria Tactics Engine
 */

class TalentBranch_Specialization_126 {
  constructor(className = 'CyberClass_126') {
    this.specializationId = 'SPEC_126';
...
module.exports = TalentBranch_Specialization_126;
