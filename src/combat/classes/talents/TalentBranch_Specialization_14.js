/**
 * TalentBranch_Specialization_14.js - RPG Class Specialization & Passive Modifier Tree
 * Specialization ID: 14
 * Part of Aetheria Tactics Engine
 */

class TalentBranch_Specialization_14 {
  constructor(className = 'CyberClass_14') {
    this.specializationId = 'SPEC_14';
...
module.exports = TalentBranch_Specialization_14;
