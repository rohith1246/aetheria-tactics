/**
 * TalentBranch_Specialization_120.js - RPG Class Specialization & Passive Modifier Tree
 * Specialization ID: 120
 * Part of Aetheria Tactics Engine
 */

class TalentBranch_Specialization_120 {
  constructor(className = 'CyberClass_120') {
    this.specializationId = 'SPEC_120';
...
module.exports = TalentBranch_Specialization_120;
