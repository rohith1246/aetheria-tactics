/**
 * TalentBranch_Specialization_25.js - RPG Class Specialization & Passive Modifier Tree
 * Specialization ID: 25
 * Part of Aetheria Tactics Engine
 */

class TalentBranch_Specialization_25 {
  constructor(className = 'CyberClass_25') {
    this.specializationId = 'SPEC_25';
...
module.exports = TalentBranch_Specialization_25;
