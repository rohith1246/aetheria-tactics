/**
 * TalentBranch_Specialization_96.js - RPG Class Specialization & Passive Modifier Tree
 * Specialization ID: 96
 * Part of Aetheria Tactics Engine
 */

class TalentBranch_Specialization_96 {
  constructor(className = 'CyberClass_96') {
    this.specializationId = 'SPEC_96';
...
module.exports = TalentBranch_Specialization_96;
