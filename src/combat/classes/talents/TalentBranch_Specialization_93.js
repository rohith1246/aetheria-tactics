/**
 * TalentBranch_Specialization_93.js - RPG Class Specialization & Passive Modifier Tree
 * Specialization ID: 93
 * Part of Aetheria Tactics Engine
 */

class TalentBranch_Specialization_93 {
  constructor(className = 'CyberClass_93') {
    this.specializationId = 'SPEC_93';
...
module.exports = TalentBranch_Specialization_93;
