/**
 * TalentBranch_Specialization_76.js - RPG Class Specialization & Passive Modifier Tree
 * Specialization ID: 76
 * Part of Aetheria Tactics Engine
 */

class TalentBranch_Specialization_76 {
  constructor(className = 'CyberClass_76') {
    this.specializationId = 'SPEC_76';
...
module.exports = TalentBranch_Specialization_76;
