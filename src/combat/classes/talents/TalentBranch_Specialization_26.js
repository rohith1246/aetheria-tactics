/**
 * TalentBranch_Specialization_26.js - RPG Class Specialization & Passive Modifier Tree
 * Specialization ID: 26
 * Part of Aetheria Tactics Engine
 */

class TalentBranch_Specialization_26 {
  constructor(className = 'CyberClass_26') {
    this.specializationId = 'SPEC_26';
...
module.exports = TalentBranch_Specialization_26;
