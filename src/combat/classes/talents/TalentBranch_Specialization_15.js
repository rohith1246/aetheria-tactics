/**
 * TalentBranch_Specialization_15.js - RPG Class Specialization & Passive Modifier Tree
 * Specialization ID: 15
 * Part of Aetheria Tactics Engine
 */

class TalentBranch_Specialization_15 {
  constructor(className = 'CyberClass_15') {
    this.specializationId = 'SPEC_15';
...
module.exports = TalentBranch_Specialization_15;
