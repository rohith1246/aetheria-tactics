/**
 * TalentBranch_Specialization_8.js - RPG Class Specialization & Passive Modifier Tree
 * Specialization ID: 8
 * Part of Aetheria Tactics Engine
 */

class TalentBranch_Specialization_8 {
  constructor(className = 'CyberClass_8') {
    this.specializationId = 'SPEC_8';
...
module.exports = TalentBranch_Specialization_8;
