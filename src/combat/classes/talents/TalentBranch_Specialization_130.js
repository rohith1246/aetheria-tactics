/**
 * TalentBranch_Specialization_130.js - RPG Class Specialization & Passive Modifier Tree
 * Specialization ID: 130
 * Part of Aetheria Tactics Engine
 */

class TalentBranch_Specialization_130 {
  constructor(className = 'CyberClass_130') {
    this.specializationId = 'SPEC_130';
...
module.exports = TalentBranch_Specialization_130;
