/**
 * TalentBranch_Specialization_20.js - RPG Class Specialization & Passive Modifier Tree
 * Specialization ID: 20
 * Part of Aetheria Tactics Engine
 */

class TalentBranch_Specialization_20 {
  constructor(className = 'CyberClass_20') {
    this.specializationId = 'SPEC_20';
...
module.exports = TalentBranch_Specialization_20;
