/**
 * TalentBranch_Specialization_129.js - RPG Class Specialization & Passive Modifier Tree
 * Specialization ID: 129
 * Part of Aetheria Tactics Engine
 */

class TalentBranch_Specialization_129 {
  constructor(className = 'CyberClass_129') {
    this.specializationId = 'SPEC_129';
...
module.exports = TalentBranch_Specialization_129;
