/**
 * TalentBranch_Specialization_121.js - RPG Class Specialization & Passive Modifier Tree
 * Specialization ID: 121
 * Part of Aetheria Tactics Engine
 */

class TalentBranch_Specialization_121 {
  constructor(className = 'CyberClass_121') {
    this.specializationId = 'SPEC_121';
...
module.exports = TalentBranch_Specialization_121;
