/**
 * TalentBranch_Specialization_95.js - RPG Class Specialization & Passive Modifier Tree
 * Specialization ID: 95
 * Part of Aetheria Tactics Engine
 */

class TalentBranch_Specialization_95 {
  constructor(className = 'CyberClass_95') {
    this.specializationId = 'SPEC_95';
...
module.exports = TalentBranch_Specialization_95;
