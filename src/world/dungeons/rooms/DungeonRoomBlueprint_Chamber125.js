/**
 * DungeonRoomBlueprint_Chamber125.js - Procedural Dungeon Chamber Layout & Monster Spawner
 * Chamber ID: 125
 * Part of Aetheria Tactics Engine
 */

class DungeonRoomBlueprint_Chamber125 {
  constructor(width = 13, height = 13) {
    this.chamberId = 'CHAMBER_125';
    this.width = width;
    this.height = height;
    this.monsterSpawns = [
...
module.exports = DungeonRoomBlueprint_Chamber125;
