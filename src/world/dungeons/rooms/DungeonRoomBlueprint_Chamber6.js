/**
 * DungeonRoomBlueprint_Chamber6.js - Procedural Dungeon Chamber Layout & Monster Spawner
 * Chamber ID: 6
 * Part of Aetheria Tactics Engine
 */

class DungeonRoomBlueprint_Chamber6 {
  constructor(width = 14, height = 14) {
    this.chamberId = 'CHAMBER_6';
    this.width = width;
    this.height = height;
    this.monsterSpawns = [
...
module.exports = DungeonRoomBlueprint_Chamber6;
