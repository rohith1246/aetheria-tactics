/**
 * DungeonRoomBlueprint_Chamber93.js - Procedural Dungeon Chamber Layout & Monster Spawner
 * Chamber ID: 93
 * Part of Aetheria Tactics Engine
 */

class DungeonRoomBlueprint_Chamber93 {
  constructor(width = 11, height = 11) {
    this.chamberId = 'CHAMBER_93';
    this.width = width;
    this.height = height;
    this.monsterSpawns = [
...
module.exports = DungeonRoomBlueprint_Chamber93;
