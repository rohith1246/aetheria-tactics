/**
 * DungeonRoomBlueprint_Chamber26.js - Procedural Dungeon Chamber Layout & Monster Spawner
 * Chamber ID: 26
 * Part of Aetheria Tactics Engine
 */

class DungeonRoomBlueprint_Chamber26 {
  constructor(width = 14, height = 14) {
    this.chamberId = 'CHAMBER_26';
    this.width = width;
    this.height = height;
    this.monsterSpawns = [
...
module.exports = DungeonRoomBlueprint_Chamber26;
