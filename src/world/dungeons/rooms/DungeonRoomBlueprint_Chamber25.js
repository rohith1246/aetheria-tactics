/**
 * DungeonRoomBlueprint_Chamber25.js - Procedural Dungeon Chamber Layout & Monster Spawner
 * Chamber ID: 25
 * Part of Aetheria Tactics Engine
 */

class DungeonRoomBlueprint_Chamber25 {
  constructor(width = 13, height = 13) {
    this.chamberId = 'CHAMBER_25';
    this.width = width;
    this.height = height;
    this.monsterSpawns = [
...
module.exports = DungeonRoomBlueprint_Chamber25;
