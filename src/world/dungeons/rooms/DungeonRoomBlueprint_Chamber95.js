/**
 * DungeonRoomBlueprint_Chamber95.js - Procedural Dungeon Chamber Layout & Monster Spawner
 * Chamber ID: 95
 * Part of Aetheria Tactics Engine
 */

class DungeonRoomBlueprint_Chamber95 {
  constructor(width = 13, height = 13) {
    this.chamberId = 'CHAMBER_95';
    this.width = width;
    this.height = height;
    this.monsterSpawns = [
...
module.exports = DungeonRoomBlueprint_Chamber95;
