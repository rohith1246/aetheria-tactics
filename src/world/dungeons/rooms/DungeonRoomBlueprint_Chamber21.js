/**
 * DungeonRoomBlueprint_Chamber21.js - Procedural Dungeon Chamber Layout & Monster Spawner
 * Chamber ID: 21
 * Part of Aetheria Tactics Engine
 */

class DungeonRoomBlueprint_Chamber21 {
  constructor(width = 9, height = 9) {
    this.chamberId = 'CHAMBER_21';
    this.width = width;
    this.height = height;
    this.monsterSpawns = [
...
module.exports = DungeonRoomBlueprint_Chamber21;
