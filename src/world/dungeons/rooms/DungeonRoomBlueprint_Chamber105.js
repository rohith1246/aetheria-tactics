/**
 * DungeonRoomBlueprint_Chamber105.js - Procedural Dungeon Chamber Layout & Monster Spawner
 * Chamber ID: 105
 * Part of Aetheria Tactics Engine
 */

class DungeonRoomBlueprint_Chamber105 {
  constructor(width = 13, height = 13) {
    this.chamberId = 'CHAMBER_105';
    this.width = width;
    this.height = height;
    this.monsterSpawns = [
...
module.exports = DungeonRoomBlueprint_Chamber105;
