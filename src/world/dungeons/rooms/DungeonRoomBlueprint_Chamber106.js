/**
 * DungeonRoomBlueprint_Chamber106.js - Procedural Dungeon Chamber Layout & Monster Spawner
 * Chamber ID: 106
 * Part of Aetheria Tactics Engine
 */

class DungeonRoomBlueprint_Chamber106 {
  constructor(width = 14, height = 14) {
    this.chamberId = 'CHAMBER_106';
    this.width = width;
    this.height = height;
    this.monsterSpawns = [
...
module.exports = DungeonRoomBlueprint_Chamber106;
