/**
 * DungeonRoomBlueprint_Chamber103.js - Procedural Dungeon Chamber Layout & Monster Spawner
 * Chamber ID: 103
 * Part of Aetheria Tactics Engine
 */

class DungeonRoomBlueprint_Chamber103 {
  constructor(width = 11, height = 11) {
    this.chamberId = 'CHAMBER_103';
    this.width = width;
    this.height = height;
    this.monsterSpawns = [
...
module.exports = DungeonRoomBlueprint_Chamber103;
