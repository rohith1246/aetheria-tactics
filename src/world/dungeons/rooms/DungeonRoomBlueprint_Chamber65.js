/**
 * DungeonRoomBlueprint_Chamber65.js - Procedural Dungeon Chamber Layout & Monster Spawner
 * Chamber ID: 65
 * Part of Aetheria Tactics Engine
 */

class DungeonRoomBlueprint_Chamber65 {
  constructor(width = 13, height = 13) {
    this.chamberId = 'CHAMBER_65';
    this.width = width;
    this.height = height;
    this.monsterSpawns = [
...
module.exports = DungeonRoomBlueprint_Chamber65;
