/**
 * DungeonRoomBlueprint_Chamber36.js - Procedural Dungeon Chamber Layout & Monster Spawner
 * Chamber ID: 36
 * Part of Aetheria Tactics Engine
 */

class DungeonRoomBlueprint_Chamber36 {
  constructor(width = 14, height = 14) {
    this.chamberId = 'CHAMBER_36';
    this.width = width;
    this.height = height;
    this.monsterSpawns = [
...
module.exports = DungeonRoomBlueprint_Chamber36;
