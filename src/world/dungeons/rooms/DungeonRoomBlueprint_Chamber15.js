/**
 * DungeonRoomBlueprint_Chamber15.js - Procedural Dungeon Chamber Layout & Monster Spawner
 * Chamber ID: 15
 * Part of Aetheria Tactics Engine
 */

class DungeonRoomBlueprint_Chamber15 {
  constructor(width = 13, height = 13) {
    this.chamberId = 'CHAMBER_15';
    this.width = width;
    this.height = height;
    this.monsterSpawns = [
...
module.exports = DungeonRoomBlueprint_Chamber15;
