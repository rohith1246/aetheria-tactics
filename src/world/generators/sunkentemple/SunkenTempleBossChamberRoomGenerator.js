/**
 * SunkenTempleBossChamberRoomGenerator.js
 * Procedural Room Generator for SunkenTemple biome with BossChamber dimensions.
 */

class SunkenTempleBossChamberRoomGenerator {
...
module.exports = { SunkenTempleBossChamberRoomGenerator };
