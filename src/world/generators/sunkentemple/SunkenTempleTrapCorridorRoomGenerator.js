/**
 * SunkenTempleTrapCorridorRoomGenerator.js
 * Procedural Room Generator for SunkenTemple biome with TrapCorridor dimensions.
 */

class SunkenTempleTrapCorridorRoomGenerator {
...
module.exports = { SunkenTempleTrapCorridorRoomGenerator };
