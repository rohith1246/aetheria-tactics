/**
 * SunkenTempleBarracksRoomGenerator.js
 * Procedural Room Generator for SunkenTemple biome with Barracks dimensions.
 */

class SunkenTempleBarracksRoomGenerator {
...
module.exports = { SunkenTempleBarracksRoomGenerator };
