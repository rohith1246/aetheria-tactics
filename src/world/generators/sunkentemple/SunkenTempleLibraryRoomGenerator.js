/**
 * SunkenTempleLibraryRoomGenerator.js
 * Procedural Room Generator for SunkenTemple biome with Library dimensions.
 */

class SunkenTempleLibraryRoomGenerator {
...
module.exports = { SunkenTempleLibraryRoomGenerator };
