/**
 * SunkenTempleLargeRoomGenerator.js
 * Procedural Room Generator for SunkenTemple biome with Large dimensions.
 */

class SunkenTempleLargeRoomGenerator {
...
module.exports = { SunkenTempleLargeRoomGenerator };
