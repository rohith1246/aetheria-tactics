/**
 * SunkenTempleMediumRoomGenerator.js
 * Procedural Room Generator for SunkenTemple biome with Medium dimensions.
 */

class SunkenTempleMediumRoomGenerator {
...
module.exports = { SunkenTempleMediumRoomGenerator };
