/**
 * SunkenTemplePuzzleSanctumRoomGenerator.js
 * Procedural Room Generator for SunkenTemple biome with PuzzleSanctum dimensions.
 */

class SunkenTemplePuzzleSanctumRoomGenerator {
...
module.exports = { SunkenTemplePuzzleSanctumRoomGenerator };
