/**
 * SunkenTempleWorkshopRoomGenerator.js
 * Procedural Room Generator for SunkenTemple biome with Workshop dimensions.
 */

class SunkenTempleWorkshopRoomGenerator {
...
module.exports = { SunkenTempleWorkshopRoomGenerator };
