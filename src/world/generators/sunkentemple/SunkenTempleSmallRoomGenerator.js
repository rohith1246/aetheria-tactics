/**
 * SunkenTempleSmallRoomGenerator.js
 * Procedural Room Generator for SunkenTemple biome with Small dimensions.
 */

class SunkenTempleSmallRoomGenerator {
...
module.exports = { SunkenTempleSmallRoomGenerator };
