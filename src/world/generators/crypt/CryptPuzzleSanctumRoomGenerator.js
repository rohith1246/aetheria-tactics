/**
 * CryptPuzzleSanctumRoomGenerator.js
 * Procedural Room Generator for Crypt biome with PuzzleSanctum dimensions.
 */

class CryptPuzzleSanctumRoomGenerator {
...
module.exports = { CryptPuzzleSanctumRoomGenerator };
