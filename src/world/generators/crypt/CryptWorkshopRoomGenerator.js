/**
 * CryptWorkshopRoomGenerator.js
 * Procedural Room Generator for Crypt biome with Workshop dimensions.
 */

class CryptWorkshopRoomGenerator {
...
module.exports = { CryptWorkshopRoomGenerator };
