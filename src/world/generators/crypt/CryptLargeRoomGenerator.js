/**
 * CryptLargeRoomGenerator.js
 * Procedural Room Generator for Crypt biome with Large dimensions.
 */

class CryptLargeRoomGenerator {
...
module.exports = { CryptLargeRoomGenerator };
