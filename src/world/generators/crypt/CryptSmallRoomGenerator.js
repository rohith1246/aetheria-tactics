/**
 * CryptSmallRoomGenerator.js
 * Procedural Room Generator for Crypt biome with Small dimensions.
 */

class CryptSmallRoomGenerator {
...
module.exports = { CryptSmallRoomGenerator };
