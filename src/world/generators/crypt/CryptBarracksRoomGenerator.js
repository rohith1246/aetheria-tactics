/**
 * CryptBarracksRoomGenerator.js
 * Procedural Room Generator for Crypt biome with Barracks dimensions.
 */

class CryptBarracksRoomGenerator {
...
module.exports = { CryptBarracksRoomGenerator };
