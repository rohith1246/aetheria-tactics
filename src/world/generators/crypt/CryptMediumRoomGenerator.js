/**
 * CryptMediumRoomGenerator.js
 * Procedural Room Generator for Crypt biome with Medium dimensions.
 */

class CryptMediumRoomGenerator {
...
module.exports = { CryptMediumRoomGenerator };
