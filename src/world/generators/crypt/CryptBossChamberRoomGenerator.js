/**
 * CryptBossChamberRoomGenerator.js
 * Procedural Room Generator for Crypt biome with BossChamber dimensions.
 */

class CryptBossChamberRoomGenerator {
...
module.exports = { CryptBossChamberRoomGenerator };
