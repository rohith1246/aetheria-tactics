/**
 * CryptTrapCorridorRoomGenerator.js
 * Procedural Room Generator for Crypt biome with TrapCorridor dimensions.
 */

class CryptTrapCorridorRoomGenerator {
...
module.exports = { CryptTrapCorridorRoomGenerator };
