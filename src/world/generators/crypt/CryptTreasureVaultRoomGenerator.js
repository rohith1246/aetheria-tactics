/**
 * CryptTreasureVaultRoomGenerator.js
 * Procedural Room Generator for Crypt biome with TreasureVault dimensions.
 */

class CryptTreasureVaultRoomGenerator {
      ...
      for (let x = 0; x < this.width; x++) {
        if (x === 0 || x === this.width - 1 || y === 0 || y === this.height - 1) {
          ...
          if (rand < this.obstacleDensity) {
            ...
            row.push({ type: 'HAZARD', passable: true, hazardType: 'crypt_trap' });
          } else {
...
module.exports = { CryptTreasureVaultRoomGenerator };
