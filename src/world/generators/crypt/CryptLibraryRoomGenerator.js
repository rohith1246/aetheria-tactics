/**
 * CryptLibraryRoomGenerator.js
 * Procedural Room Generator for Crypt biome with Library dimensions.
 */

class CryptLibraryRoomGenerator {
...
module.exports = { CryptLibraryRoomGenerator };
