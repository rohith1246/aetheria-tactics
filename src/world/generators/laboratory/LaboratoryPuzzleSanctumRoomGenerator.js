/**
 * LaboratoryPuzzleSanctumRoomGenerator.js
 * Procedural Room Generator for Laboratory biome with PuzzleSanctum dimensions.
 */

class LaboratoryPuzzleSanctumRoomGenerator {
...
module.exports = { LaboratoryPuzzleSanctumRoomGenerator };
