/**
 * LaboratorySmallRoomGenerator.js
 * Procedural Room Generator for Laboratory biome with Small dimensions.
 */

class LaboratorySmallRoomGenerator {
...
module.exports = { LaboratorySmallRoomGenerator };
