/**
 * LaboratoryWorkshopRoomGenerator.js
 * Procedural Room Generator for Laboratory biome with Workshop dimensions.
 */

class LaboratoryWorkshopRoomGenerator {
...
module.exports = { LaboratoryWorkshopRoomGenerator };
