/**
 * LaboratoryBossChamberRoomGenerator.js
 * Procedural Room Generator for Laboratory biome with BossChamber dimensions.
 */

class LaboratoryBossChamberRoomGenerator {
...
module.exports = { LaboratoryBossChamberRoomGenerator };
