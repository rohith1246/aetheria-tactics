/**
 * LaboratoryMediumRoomGenerator.js
 * Procedural Room Generator for Laboratory biome with Medium dimensions.
 */

class LaboratoryMediumRoomGenerator {
...
module.exports = { LaboratoryMediumRoomGenerator };
