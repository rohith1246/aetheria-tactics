/**
 * LaboratoryTrapCorridorRoomGenerator.js
 * Procedural Room Generator for Laboratory biome with TrapCorridor dimensions.
 */

class LaboratoryTrapCorridorRoomGenerator {
...
module.exports = { LaboratoryTrapCorridorRoomGenerator };
