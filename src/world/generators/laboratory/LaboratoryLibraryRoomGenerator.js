/**
 * LaboratoryLibraryRoomGenerator.js
 * Procedural Room Generator for Laboratory biome with Library dimensions.
 */

class LaboratoryLibraryRoomGenerator {
...
module.exports = { LaboratoryLibraryRoomGenerator };
