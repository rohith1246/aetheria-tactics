/**
 * LaboratoryLargeRoomGenerator.js
 * Procedural Room Generator for Laboratory biome with Large dimensions.
 */

class LaboratoryLargeRoomGenerator {
...
module.exports = { LaboratoryLargeRoomGenerator };
