/**
 * LaboratoryBarracksRoomGenerator.js
 * Procedural Room Generator for Laboratory biome with Barracks dimensions.
 */

class LaboratoryBarracksRoomGenerator {
...
module.exports = { LaboratoryBarracksRoomGenerator };
