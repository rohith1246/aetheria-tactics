/**
 * CrystallineAbyssBossChamberRoomGenerator.js
 * Procedural Room Generator for CrystallineAbyss biome with BossChamber dimensions.
 */

class CrystallineAbyssBossChamberRoomGenerator {
  constructor(seed = Date.now()) {
    this.seed = seed;
    this.theme = 'CrystallineAbyss';
    this.sizeCategory = 'BossChamber';
    this.width = 22;
    this.height = 17;
...
module.exports = { CrystallineAbyssBossChamberRoomGenerator };
