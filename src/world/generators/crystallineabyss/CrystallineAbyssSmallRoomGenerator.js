/**
 * CrystallineAbyssSmallRoomGenerator.js
 * Procedural Room Generator for CrystallineAbyss biome with Small dimensions.
 */

class CrystallineAbyssSmallRoomGenerator {
...
module.exports = { CrystallineAbyssSmallRoomGenerator };
