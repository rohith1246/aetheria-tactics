/**
 * CrystallineAbyssMediumRoomGenerator.js
 * Procedural Room Generator for CrystallineAbyss biome with Medium dimensions.
 */

class CrystallineAbyssMediumRoomGenerator {
...
module.exports = { CrystallineAbyssMediumRoomGenerator };
