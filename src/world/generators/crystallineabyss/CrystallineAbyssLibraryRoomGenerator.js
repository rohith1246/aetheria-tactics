/**
 * CrystallineAbyssLibraryRoomGenerator.js
 * Procedural Room Generator for CrystallineAbyss biome with Library dimensions.
 */

class CrystallineAbyssLibraryRoomGenerator {
  constructor(seed = Date.now()) {
    this.seed = seed;
    this.theme = 'CrystallineAbyss';
    this.sizeCategory = 'Library';
    this.width = 46;
    this.height = 35;
...
module.exports = { CrystallineAbyssLibraryRoomGenerator };
