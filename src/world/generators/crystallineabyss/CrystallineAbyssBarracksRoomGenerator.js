/**
 * CrystallineAbyssBarracksRoomGenerator.js
 * Procedural Room Generator for CrystallineAbyss biome with Barracks dimensions.
 */

class CrystallineAbyssBarracksRoomGenerator {
  constructor(seed = Date.now()) {
    this.seed = seed;
    this.theme = 'CrystallineAbyss';
    this.sizeCategory = 'Barracks';
    this.width = 38;
    this.height = 29;
...
module.exports = { CrystallineAbyssBarracksRoomGenerator };
