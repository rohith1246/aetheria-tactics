/**
 * CrystallineAbyssLargeRoomGenerator.js
 * Procedural Room Generator for CrystallineAbyss biome with Large dimensions.
 */

class CrystallineAbyssLargeRoomGenerator {
...
module.exports = { CrystallineAbyssLargeRoomGenerator };
