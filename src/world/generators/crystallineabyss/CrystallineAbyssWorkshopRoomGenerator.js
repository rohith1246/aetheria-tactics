/**
 * CrystallineAbyssWorkshopRoomGenerator.js
 * Procedural Room Generator for CrystallineAbyss biome with Workshop dimensions.
 */

class CrystallineAbyssWorkshopRoomGenerator {
  constructor(seed = Date.now()) {
    this.seed = seed;
    this.theme = 'CrystallineAbyss';
    this.sizeCategory = 'Workshop';
    this.width = 42;
    this.height = 32;
...
module.exports = { CrystallineAbyssWorkshopRoomGenerator };
