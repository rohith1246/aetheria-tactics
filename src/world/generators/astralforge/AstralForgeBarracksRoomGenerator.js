/**
 * AstralForgeBarracksRoomGenerator.js
 * Procedural Room Generator for AstralForge biome with Barracks dimensions.
 */

class AstralForgeBarracksRoomGenerator {
...
module.exports = { AstralForgeBarracksRoomGenerator };
