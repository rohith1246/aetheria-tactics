/**
 * AstralForgeLargeRoomGenerator.js
 * Procedural Room Generator for AstralForge biome with Large dimensions.
 */

class AstralForgeLargeRoomGenerator {
...
module.exports = { AstralForgeLargeRoomGenerator };
