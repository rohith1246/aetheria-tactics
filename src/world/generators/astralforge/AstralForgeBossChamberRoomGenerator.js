/**
 * AstralForgeBossChamberRoomGenerator.js
 * Procedural Room Generator for AstralForge biome with BossChamber dimensions.
 */

class AstralForgeBossChamberRoomGenerator {
...
module.exports = { AstralForgeBossChamberRoomGenerator };
