/**
 * AstralForgeSmallRoomGenerator.js
 * Procedural Room Generator for AstralForge biome with Small dimensions.
 */

class AstralForgeSmallRoomGenerator {
...
module.exports = { AstralForgeSmallRoomGenerator };
