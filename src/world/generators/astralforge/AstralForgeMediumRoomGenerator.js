/**
 * AstralForgeMediumRoomGenerator.js
 * Procedural Room Generator for AstralForge biome with Medium dimensions.
 */

class AstralForgeMediumRoomGenerator {
...
module.exports = { AstralForgeMediumRoomGenerator };
