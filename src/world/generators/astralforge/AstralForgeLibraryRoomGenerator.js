/**
 * AstralForgeLibraryRoomGenerator.js
 * Procedural Room Generator for AstralForge biome with Library dimensions.
 */

class AstralForgeLibraryRoomGenerator {
...
module.exports = { AstralForgeLibraryRoomGenerator };
