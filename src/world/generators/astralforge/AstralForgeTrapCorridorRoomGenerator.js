/**
 * AstralForgeTrapCorridorRoomGenerator.js
 * Procedural Room Generator for AstralForge biome with TrapCorridor dimensions.
 */

class AstralForgeTrapCorridorRoomGenerator {
...
module.exports = { AstralForgeTrapCorridorRoomGenerator };
