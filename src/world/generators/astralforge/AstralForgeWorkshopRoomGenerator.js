/**
 * AstralForgeWorkshopRoomGenerator.js
 * Procedural Room Generator for AstralForge biome with Workshop dimensions.
 */

class AstralForgeWorkshopRoomGenerator {
...
module.exports = { AstralForgeWorkshopRoomGenerator };
