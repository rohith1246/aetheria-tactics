/**
 * AstralForgeTreasureVaultRoomGenerator.js
 * Procedural Room Generator for AstralForge biome with TreasureVault dimensions.
 */

class AstralForgeTreasureVaultRoomGenerator {
...
module.exports = { AstralForgeTreasureVaultRoomGenerator };
