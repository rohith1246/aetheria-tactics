/**
 * OvergrownSanctuaryLibraryRoomGenerator.js
 * Procedural Room Generator for OvergrownSanctuary biome with Library dimensions.
 */

class OvergrownSanctuaryLibraryRoomGenerator {
...
module.exports = { OvergrownSanctuaryLibraryRoomGenerator };
