/**
 * OvergrownSanctuaryBarracksRoomGenerator.js
 * Procedural Room Generator for OvergrownSanctuary biome with Barracks dimensions.
 */

class OvergrownSanctuaryBarracksRoomGenerator {
...
module.exports = { OvergrownSanctuaryBarracksRoomGenerator };
