/**
 * OvergrownSanctuaryLargeRoomGenerator.js
 * Procedural Room Generator for OvergrownSanctuary biome with Large dimensions.
 */

class OvergrownSanctuaryLargeRoomGenerator {
...
module.exports = { OvergrownSanctuaryLargeRoomGenerator };
