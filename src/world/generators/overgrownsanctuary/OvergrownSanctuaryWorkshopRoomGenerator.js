/**
 * OvergrownSanctuaryWorkshopRoomGenerator.js
 * Procedural Room Generator for OvergrownSanctuary biome with Workshop dimensions.
 */

class OvergrownSanctuaryWorkshopRoomGenerator {
...
module.exports = { OvergrownSanctuaryWorkshopRoomGenerator };
