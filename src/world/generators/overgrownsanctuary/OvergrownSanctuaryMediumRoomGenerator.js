/**
 * OvergrownSanctuaryMediumRoomGenerator.js
 * Procedural Room Generator for OvergrownSanctuary biome with Medium dimensions.
 */

class OvergrownSanctuaryMediumRoomGenerator {
...
module.exports = { OvergrownSanctuaryMediumRoomGenerator };
