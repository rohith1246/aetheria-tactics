/**
 * OvergrownSanctuarySmallRoomGenerator.js
 * Procedural Room Generator for OvergrownSanctuary biome with Small dimensions.
 */

class OvergrownSanctuarySmallRoomGenerator {
...
module.exports = { OvergrownSanctuarySmallRoomGenerator };
