/**
 * FrozenCavernBossChamberRoomGenerator.js
 * Procedural Room Generator for FrozenCavern biome with BossChamber dimensions.
 */

class FrozenCavernBossChamberRoomGenerator {
...
module.exports = { FrozenCavernBossChamberRoomGenerator };
