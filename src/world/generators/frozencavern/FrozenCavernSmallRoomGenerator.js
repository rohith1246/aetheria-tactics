/**
 * FrozenCavernSmallRoomGenerator.js
 * Procedural Room Generator for FrozenCavern biome with Small dimensions.
 */

class FrozenCavernSmallRoomGenerator {
...
module.exports = { FrozenCavernSmallRoomGenerator };
