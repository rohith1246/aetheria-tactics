/**
 * FrozenCavernBarracksRoomGenerator.js
 * Procedural Room Generator for FrozenCavern biome with Barracks dimensions.
 */

class FrozenCavernBarracksRoomGenerator {
...
module.exports = { FrozenCavernBarracksRoomGenerator };
