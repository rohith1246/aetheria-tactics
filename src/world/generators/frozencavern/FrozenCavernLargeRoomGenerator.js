/**
 * FrozenCavernLargeRoomGenerator.js
 * Procedural Room Generator for FrozenCavern biome with Large dimensions.
 */

class FrozenCavernLargeRoomGenerator {
...
module.exports = { FrozenCavernLargeRoomGenerator };
