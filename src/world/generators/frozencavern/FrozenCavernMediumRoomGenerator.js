/**
 * FrozenCavernMediumRoomGenerator.js
 * Procedural Room Generator for FrozenCavern biome with Medium dimensions.
 */

class FrozenCavernMediumRoomGenerator {
...
module.exports = { FrozenCavernMediumRoomGenerator };
