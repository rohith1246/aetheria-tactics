/**
 * FrozenCavernTrapCorridorRoomGenerator.js
 * Procedural Room Generator for FrozenCavern biome with TrapCorridor dimensions.
 */

class FrozenCavernTrapCorridorRoomGenerator {
...
module.exports = { FrozenCavernTrapCorridorRoomGenerator };
