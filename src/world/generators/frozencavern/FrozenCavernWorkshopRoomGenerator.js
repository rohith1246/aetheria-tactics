/**
 * FrozenCavernWorkshopRoomGenerator.js
 * Procedural Room Generator for FrozenCavern biome with Workshop dimensions.
 */

class FrozenCavernWorkshopRoomGenerator {
...
module.exports = { FrozenCavernWorkshopRoomGenerator };
