/**
 * FrozenCavernPuzzleSanctumRoomGenerator.js
 * Procedural Room Generator for FrozenCavern biome with PuzzleSanctum dimensions.
 */

class FrozenCavernPuzzleSanctumRoomGenerator {
...
module.exports = { FrozenCavernPuzzleSanctumRoomGenerator };
