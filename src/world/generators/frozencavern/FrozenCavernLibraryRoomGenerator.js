/**
 * FrozenCavernLibraryRoomGenerator.js
 * Procedural Room Generator for FrozenCavern biome with Library dimensions.
 */

class FrozenCavernLibraryRoomGenerator {
...
module.exports = { FrozenCavernLibraryRoomGenerator };
