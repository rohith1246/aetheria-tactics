/**
 * AncientRuinsPuzzleSanctumRoomGenerator.js
 * Procedural Room Generator for AncientRuins biome with PuzzleSanctum dimensions.
 */

class AncientRuinsPuzzleSanctumRoomGenerator {
...
module.exports = { AncientRuinsPuzzleSanctumRoomGenerator };
