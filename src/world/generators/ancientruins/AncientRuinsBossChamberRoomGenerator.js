/**
 * AncientRuinsBossChamberRoomGenerator.js
 * Procedural Room Generator for AncientRuins biome with BossChamber dimensions.
 */

class AncientRuinsBossChamberRoomGenerator {
...
module.exports = { AncientRuinsBossChamberRoomGenerator };
