/**
 * AncientRuinsLargeRoomGenerator.js
 * Procedural Room Generator for AncientRuins biome with Large dimensions.
 */

class AncientRuinsLargeRoomGenerator {
...
module.exports = { AncientRuinsLargeRoomGenerator };
