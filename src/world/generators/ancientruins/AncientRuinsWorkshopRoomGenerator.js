/**
 * AncientRuinsWorkshopRoomGenerator.js
 * Procedural Room Generator for AncientRuins biome with Workshop dimensions.
 */

class AncientRuinsWorkshopRoomGenerator {
...
module.exports = { AncientRuinsWorkshopRoomGenerator };
