/**
 * AncientRuinsMediumRoomGenerator.js
 * Procedural Room Generator for AncientRuins biome with Medium dimensions.
 */

class AncientRuinsMediumRoomGenerator {
...
module.exports = { AncientRuinsMediumRoomGenerator };
