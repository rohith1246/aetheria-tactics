/**
 * AncientRuinsSmallRoomGenerator.js
 * Procedural Room Generator for AncientRuins biome with Small dimensions.
 */

class AncientRuinsSmallRoomGenerator {
...
module.exports = { AncientRuinsSmallRoomGenerator };
