/**
 * AncientRuinsLibraryRoomGenerator.js
 * Procedural Room Generator for AncientRuins biome with Library dimensions.
 */

class AncientRuinsLibraryRoomGenerator {
...
module.exports = { AncientRuinsLibraryRoomGenerator };
