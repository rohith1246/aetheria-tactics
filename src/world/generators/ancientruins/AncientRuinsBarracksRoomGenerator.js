/**
 * AncientRuinsBarracksRoomGenerator.js
 * Procedural Room Generator for AncientRuins biome with Barracks dimensions.
 */

class AncientRuinsBarracksRoomGenerator {
...
module.exports = { AncientRuinsBarracksRoomGenerator };
