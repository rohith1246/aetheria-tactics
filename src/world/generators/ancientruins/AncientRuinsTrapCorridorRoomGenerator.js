/**
 * AncientRuinsTrapCorridorRoomGenerator.js
 * Procedural Room Generator for AncientRuins biome with TrapCorridor dimensions.
 */

class AncientRuinsTrapCorridorRoomGenerator {
...
module.exports = { AncientRuinsTrapCorridorRoomGenerator };
