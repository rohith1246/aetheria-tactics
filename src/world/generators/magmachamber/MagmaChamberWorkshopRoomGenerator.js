/**
 * MagmaChamberWorkshopRoomGenerator.js
 * Procedural Room Generator for MagmaChamber biome with Workshop dimensions.
 */

class MagmaChamberWorkshopRoomGenerator {
...
module.exports = { MagmaChamberWorkshopRoomGenerator };
