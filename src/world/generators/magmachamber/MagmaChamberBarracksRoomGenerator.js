/**
 * MagmaChamberBarracksRoomGenerator.js
 * Procedural Room Generator for MagmaChamber biome with Barracks dimensions.
 */

class MagmaChamberBarracksRoomGenerator {
...
module.exports = { MagmaChamberBarracksRoomGenerator };
