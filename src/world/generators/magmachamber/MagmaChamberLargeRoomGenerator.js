/**
 * MagmaChamberLargeRoomGenerator.js
 * Procedural Room Generator for MagmaChamber biome with Large dimensions.
 */

class MagmaChamberLargeRoomGenerator {
...
module.exports = { MagmaChamberLargeRoomGenerator };
