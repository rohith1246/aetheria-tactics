/**
 * MagmaChamberLibraryRoomGenerator.js
 * Procedural Room Generator for MagmaChamber biome with Library dimensions.
 */

class MagmaChamberLibraryRoomGenerator {
...
module.exports = { MagmaChamberLibraryRoomGenerator };
