/**
 * MagmaChamberTreasureVaultRoomGenerator.js
 * Procedural Room Generator for MagmaChamber biome with TreasureVault dimensions.
 */

class MagmaChamberTreasureVaultRoomGenerator {
  constructor(seed = Date.now()) {
    this.seed = seed;
    this.theme = 'MagmaChamber';
    this.sizeCategory = 'TreasureVault';
    this.width = 26;
    this.height = 20;
    this.obstacleDensity = 0.22999999999999998;
  }
      ...
      for (let x = 0; x < this.width; x++) {
        if (x === 0 || x === this.width - 1 || y === 0 || y === this.height - 1) {
          ...
          if (rand < this.obstacleDensity) {
            ...
            row.push({ type: 'HAZARD', passable: true, hazardType: 'magmachamber_trap' });
          } else {
...
module.exports = { MagmaChamberTreasureVaultRoomGenerator };
