/**
 * MagmaChamberPuzzleSanctumRoomGenerator.js
 * Procedural Room Generator for MagmaChamber biome with PuzzleSanctum dimensions.
 */

class MagmaChamberPuzzleSanctumRoomGenerator {
...
module.exports = { MagmaChamberPuzzleSanctumRoomGenerator };
