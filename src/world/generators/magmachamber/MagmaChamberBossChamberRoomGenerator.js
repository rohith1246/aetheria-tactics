/**
 * MagmaChamberBossChamberRoomGenerator.js
 * Procedural Room Generator for MagmaChamber biome with BossChamber dimensions.
 */

class MagmaChamberBossChamberRoomGenerator {
...
module.exports = { MagmaChamberBossChamberRoomGenerator };
