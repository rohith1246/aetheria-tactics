/**
 * MagmaChamberTrapCorridorRoomGenerator.js
 * Procedural Room Generator for MagmaChamber biome with TrapCorridor dimensions.
 */

class MagmaChamberTrapCorridorRoomGenerator {
...
module.exports = { MagmaChamberTrapCorridorRoomGenerator };
