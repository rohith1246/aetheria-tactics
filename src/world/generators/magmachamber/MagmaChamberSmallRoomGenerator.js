/**
 * MagmaChamberSmallRoomGenerator.js
 * Procedural Room Generator for MagmaChamber biome with Small dimensions.
 */

class MagmaChamberSmallRoomGenerator {
...
module.exports = { MagmaChamberSmallRoomGenerator };
