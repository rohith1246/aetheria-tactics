/**
 * MagmaChamberMediumRoomGenerator.js
 * Procedural Room Generator for MagmaChamber biome with Medium dimensions.
 */

class MagmaChamberMediumRoomGenerator {
...
module.exports = { MagmaChamberMediumRoomGenerator };
