/**
 * ObsidianKeepBarracksRoomGenerator.js
 * Procedural Room Generator for ObsidianKeep biome with Barracks dimensions.
 */

class ObsidianKeepBarracksRoomGenerator {
...
module.exports = { ObsidianKeepBarracksRoomGenerator };
