/**
 * ObsidianKeepLargeRoomGenerator.js
 * Procedural Room Generator for ObsidianKeep biome with Large dimensions.
 */

class ObsidianKeepLargeRoomGenerator {
...
module.exports = { ObsidianKeepLargeRoomGenerator };
