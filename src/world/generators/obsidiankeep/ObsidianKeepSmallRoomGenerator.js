/**
 * ObsidianKeepSmallRoomGenerator.js
 * Procedural Room Generator for ObsidianKeep biome with Small dimensions.
 */

class ObsidianKeepSmallRoomGenerator {
...
module.exports = { ObsidianKeepSmallRoomGenerator };
