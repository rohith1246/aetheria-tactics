/**
 * ObsidianKeepLibraryRoomGenerator.js
 * Procedural Room Generator for ObsidianKeep biome with Library dimensions.
 */

class ObsidianKeepLibraryRoomGenerator {
...
module.exports = { ObsidianKeepLibraryRoomGenerator };
