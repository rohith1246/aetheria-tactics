/**
 * ObsidianKeepWorkshopRoomGenerator.js
 * Procedural Room Generator for ObsidianKeep biome with Workshop dimensions.
 */

class ObsidianKeepWorkshopRoomGenerator {
...
module.exports = { ObsidianKeepWorkshopRoomGenerator };
