/**
 * ObsidianKeepBossChamberRoomGenerator.js
 * Procedural Room Generator for ObsidianKeep biome with BossChamber dimensions.
 */

class ObsidianKeepBossChamberRoomGenerator {
...
module.exports = { ObsidianKeepBossChamberRoomGenerator };
