/**
 * ObsidianKeepTrapCorridorRoomGenerator.js
 * Procedural Room Generator for ObsidianKeep biome with TrapCorridor dimensions.
 */

class ObsidianKeepTrapCorridorRoomGenerator {
...
module.exports = { ObsidianKeepTrapCorridorRoomGenerator };
