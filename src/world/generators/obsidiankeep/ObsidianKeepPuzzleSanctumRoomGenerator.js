/**
 * ObsidianKeepPuzzleSanctumRoomGenerator.js
 * Procedural Room Generator for ObsidianKeep biome with PuzzleSanctum dimensions.
 */

class ObsidianKeepPuzzleSanctumRoomGenerator {
...
module.exports = { ObsidianKeepPuzzleSanctumRoomGenerator };
