/**
 * ObsidianKeepMediumRoomGenerator.js
 * Procedural Room Generator for ObsidianKeep biome with Medium dimensions.
 */

class ObsidianKeepMediumRoomGenerator {
...
module.exports = { ObsidianKeepMediumRoomGenerator };
