/**
 * ClockworkSpireSmallRoomGenerator.js
 * Procedural Room Generator for ClockworkSpire biome with Small dimensions.
 */

class ClockworkSpireSmallRoomGenerator {
...
module.exports = { ClockworkSpireSmallRoomGenerator };
