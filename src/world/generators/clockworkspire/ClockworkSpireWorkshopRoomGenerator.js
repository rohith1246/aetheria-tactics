/**
 * ClockworkSpireWorkshopRoomGenerator.js
 * Procedural Room Generator for ClockworkSpire biome with Workshop dimensions.
 */

class ClockworkSpireWorkshopRoomGenerator {
...
module.exports = { ClockworkSpireWorkshopRoomGenerator };
