/**
 * ClockworkSpireMediumRoomGenerator.js
 * Procedural Room Generator for ClockworkSpire biome with Medium dimensions.
 */

class ClockworkSpireMediumRoomGenerator {
...
module.exports = { ClockworkSpireMediumRoomGenerator };
