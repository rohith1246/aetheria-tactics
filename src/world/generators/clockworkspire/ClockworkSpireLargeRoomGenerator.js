/**
 * ClockworkSpireLargeRoomGenerator.js
 * Procedural Room Generator for ClockworkSpire biome with Large dimensions.
 */

class ClockworkSpireLargeRoomGenerator {
...
module.exports = { ClockworkSpireLargeRoomGenerator };
