/**
 * ClockworkSpireTrapCorridorRoomGenerator.js
 * Procedural Room Generator for ClockworkSpire biome with TrapCorridor dimensions.
 */

class ClockworkSpireTrapCorridorRoomGenerator {
...
module.exports = { ClockworkSpireTrapCorridorRoomGenerator };
