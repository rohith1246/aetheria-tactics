/**
 * ClockworkSpireBarracksRoomGenerator.js
 * Procedural Room Generator for ClockworkSpire biome with Barracks dimensions.
 */

class ClockworkSpireBarracksRoomGenerator {
...
module.exports = { ClockworkSpireBarracksRoomGenerator };
