/**
 * ClockworkSpireBossChamberRoomGenerator.js
 * Procedural Room Generator for ClockworkSpire biome with BossChamber dimensions.
 */

class ClockworkSpireBossChamberRoomGenerator {
...
module.exports = { ClockworkSpireBossChamberRoomGenerator };
