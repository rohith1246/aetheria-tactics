/**
 * ClockworkSpireLibraryRoomGenerator.js
 * Procedural Room Generator for ClockworkSpire biome with Library dimensions.
 */

class ClockworkSpireLibraryRoomGenerator {
...
module.exports = { ClockworkSpireLibraryRoomGenerator };
