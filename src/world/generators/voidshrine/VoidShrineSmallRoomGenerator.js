/**
 * VoidShrineSmallRoomGenerator.js
 * Procedural Room Generator for VoidShrine biome with Small dimensions.
 */

class VoidShrineSmallRoomGenerator {
...
module.exports = { VoidShrineSmallRoomGenerator };
