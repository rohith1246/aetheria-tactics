/**
 * VoidShrineMediumRoomGenerator.js
 * Procedural Room Generator for VoidShrine biome with Medium dimensions.
 */

class VoidShrineMediumRoomGenerator {
...
module.exports = { VoidShrineMediumRoomGenerator };
