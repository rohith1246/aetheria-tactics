/**
 * VoidShrineWorkshopRoomGenerator.js
 * Procedural Room Generator for VoidShrine biome with Workshop dimensions.
 */

class VoidShrineWorkshopRoomGenerator {
...
module.exports = { VoidShrineWorkshopRoomGenerator };
