/**
 * VoidShrineTrapCorridorRoomGenerator.js
 * Procedural Room Generator for VoidShrine biome with TrapCorridor dimensions.
 */

class VoidShrineTrapCorridorRoomGenerator {
...
module.exports = { VoidShrineTrapCorridorRoomGenerator };
