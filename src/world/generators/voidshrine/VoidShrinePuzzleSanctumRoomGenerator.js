/**
 * VoidShrinePuzzleSanctumRoomGenerator.js
 * Procedural Room Generator for VoidShrine biome with PuzzleSanctum dimensions.
 */

class VoidShrinePuzzleSanctumRoomGenerator {
...
module.exports = { VoidShrinePuzzleSanctumRoomGenerator };
