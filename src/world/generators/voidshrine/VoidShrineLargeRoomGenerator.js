/**
 * VoidShrineLargeRoomGenerator.js
 * Procedural Room Generator for VoidShrine biome with Large dimensions.
 */

class VoidShrineLargeRoomGenerator {
...
module.exports = { VoidShrineLargeRoomGenerator };
