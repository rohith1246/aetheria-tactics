/**
 * VoidShrineBarracksRoomGenerator.js
 * Procedural Room Generator for VoidShrine biome with Barracks dimensions.
 */

class VoidShrineBarracksRoomGenerator {
...
module.exports = { VoidShrineBarracksRoomGenerator };
