/**
 * VoidShrineBossChamberRoomGenerator.js
 * Procedural Room Generator for VoidShrine biome with BossChamber dimensions.
 */

class VoidShrineBossChamberRoomGenerator {
...
module.exports = { VoidShrineBossChamberRoomGenerator };
