/**
 * VoidShrineLibraryRoomGenerator.js
 * Procedural Room Generator for VoidShrine biome with Library dimensions.
 */

class VoidShrineLibraryRoomGenerator {
...
module.exports = { VoidShrineLibraryRoomGenerator };
