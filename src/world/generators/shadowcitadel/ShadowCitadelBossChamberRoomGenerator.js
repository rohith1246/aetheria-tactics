/**
 * ShadowCitadelBossChamberRoomGenerator.js
 * Procedural Room Generator for ShadowCitadel biome with BossChamber dimensions.
 */

class ShadowCitadelBossChamberRoomGenerator {
...
module.exports = { ShadowCitadelBossChamberRoomGenerator };
