/**
 * ShadowCitadelMediumRoomGenerator.js
 * Procedural Room Generator for ShadowCitadel biome with Medium dimensions.
 */

class ShadowCitadelMediumRoomGenerator {
...
module.exports = { ShadowCitadelMediumRoomGenerator };
