/**
 * ShadowCitadelLargeRoomGenerator.js
 * Procedural Room Generator for ShadowCitadel biome with Large dimensions.
 */

class ShadowCitadelLargeRoomGenerator {
...
module.exports = { ShadowCitadelLargeRoomGenerator };
