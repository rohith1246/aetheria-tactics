/**
 * ShadowCitadelTrapCorridorRoomGenerator.js
 * Procedural Room Generator for ShadowCitadel biome with TrapCorridor dimensions.
 */

class ShadowCitadelTrapCorridorRoomGenerator {
...
module.exports = { ShadowCitadelTrapCorridorRoomGenerator };
