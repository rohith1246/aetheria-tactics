/**
 * ShadowCitadelBarracksRoomGenerator.js
 * Procedural Room Generator for ShadowCitadel biome with Barracks dimensions.
 */

class ShadowCitadelBarracksRoomGenerator {
...
module.exports = { ShadowCitadelBarracksRoomGenerator };
