/**
 * ShadowCitadelWorkshopRoomGenerator.js
 * Procedural Room Generator for ShadowCitadel biome with Workshop dimensions.
 */

class ShadowCitadelWorkshopRoomGenerator {
...
module.exports = { ShadowCitadelWorkshopRoomGenerator };
