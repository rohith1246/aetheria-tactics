/**
 * ShadowCitadelSmallRoomGenerator.js
 * Procedural Room Generator for ShadowCitadel biome with Small dimensions.
 */

class ShadowCitadelSmallRoomGenerator {
...
module.exports = { ShadowCitadelSmallRoomGenerator };
