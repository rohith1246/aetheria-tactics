/**
 * ShadowCitadelPuzzleSanctumRoomGenerator.js
 * Procedural Room Generator for ShadowCitadel biome with PuzzleSanctum dimensions.
 */

class ShadowCitadelPuzzleSanctumRoomGenerator {
...
module.exports = { ShadowCitadelPuzzleSanctumRoomGenerator };
