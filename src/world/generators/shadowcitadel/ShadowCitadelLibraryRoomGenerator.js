/**
 * ShadowCitadelLibraryRoomGenerator.js
 * Procedural Room Generator for ShadowCitadel biome with Library dimensions.
 */

class ShadowCitadelLibraryRoomGenerator {
...
module.exports = { ShadowCitadelLibraryRoomGenerator };
