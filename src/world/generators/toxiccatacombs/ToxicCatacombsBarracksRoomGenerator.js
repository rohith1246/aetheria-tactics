/**
 * ToxicCatacombsBarracksRoomGenerator.js
 * Procedural Room Generator for ToxicCatacombs biome with Barracks dimensions.
 */

class ToxicCatacombsBarracksRoomGenerator {
...
module.exports = { ToxicCatacombsBarracksRoomGenerator };
