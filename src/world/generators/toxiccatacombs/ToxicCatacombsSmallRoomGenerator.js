/**
 * ToxicCatacombsSmallRoomGenerator.js
 * Procedural Room Generator for ToxicCatacombs biome with Small dimensions.
 */

class ToxicCatacombsSmallRoomGenerator {
...
module.exports = { ToxicCatacombsSmallRoomGenerator };
