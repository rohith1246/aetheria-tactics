/**
 * ToxicCatacombsMediumRoomGenerator.js
 * Procedural Room Generator for ToxicCatacombs biome with Medium dimensions.
 */

class ToxicCatacombsMediumRoomGenerator {
...
module.exports = { ToxicCatacombsMediumRoomGenerator };
