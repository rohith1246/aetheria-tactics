/**
 * ToxicCatacombsWorkshopRoomGenerator.js
 * Procedural Room Generator for ToxicCatacombs biome with Workshop dimensions.
 */

class ToxicCatacombsWorkshopRoomGenerator {
...
module.exports = { ToxicCatacombsWorkshopRoomGenerator };
