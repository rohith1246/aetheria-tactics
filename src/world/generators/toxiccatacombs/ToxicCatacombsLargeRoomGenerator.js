/**
 * ToxicCatacombsLargeRoomGenerator.js
 * Procedural Room Generator for ToxicCatacombs biome with Large dimensions.
 */

class ToxicCatacombsLargeRoomGenerator {
...
module.exports = { ToxicCatacombsLargeRoomGenerator };
