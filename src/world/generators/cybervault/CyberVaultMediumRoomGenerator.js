/**
 * CyberVaultMediumRoomGenerator.js
 * Procedural Room Generator for CyberVault biome with Medium dimensions.
 */

class CyberVaultMediumRoomGenerator {
...
module.exports = { CyberVaultMediumRoomGenerator };
