/**
 * CyberVaultPuzzleSanctumRoomGenerator.js
 * Procedural Room Generator for CyberVault biome with PuzzleSanctum dimensions.
 */

class CyberVaultPuzzleSanctumRoomGenerator {
...
module.exports = { CyberVaultPuzzleSanctumRoomGenerator };
