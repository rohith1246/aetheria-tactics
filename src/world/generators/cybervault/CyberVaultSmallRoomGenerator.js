/**
 * CyberVaultSmallRoomGenerator.js
 * Procedural Room Generator for CyberVault biome with Small dimensions.
 */

class CyberVaultSmallRoomGenerator {
...
module.exports = { CyberVaultSmallRoomGenerator };
