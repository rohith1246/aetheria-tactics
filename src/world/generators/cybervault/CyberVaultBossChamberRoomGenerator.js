/**
 * CyberVaultBossChamberRoomGenerator.js
 * Procedural Room Generator for CyberVault biome with BossChamber dimensions.
 */

class CyberVaultBossChamberRoomGenerator {
...
module.exports = { CyberVaultBossChamberRoomGenerator };
