/**
 * CyberVaultLibraryRoomGenerator.js
 * Procedural Room Generator for CyberVault biome with Library dimensions.
 */

class CyberVaultLibraryRoomGenerator {
...
module.exports = { CyberVaultLibraryRoomGenerator };
