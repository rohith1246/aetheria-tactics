/**
 * CyberVaultWorkshopRoomGenerator.js
 * Procedural Room Generator for CyberVault biome with Workshop dimensions.
 */

class CyberVaultWorkshopRoomGenerator {
...
module.exports = { CyberVaultWorkshopRoomGenerator };
