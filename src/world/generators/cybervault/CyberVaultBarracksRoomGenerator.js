/**
 * CyberVaultBarracksRoomGenerator.js
 * Procedural Room Generator for CyberVault biome with Barracks dimensions.
 */

class CyberVaultBarracksRoomGenerator {
...
module.exports = { CyberVaultBarracksRoomGenerator };
