/**
 * CyberVaultTrapCorridorRoomGenerator.js
 * Procedural Room Generator for CyberVault biome with TrapCorridor dimensions.
 */

class CyberVaultTrapCorridorRoomGenerator {
...
module.exports = { CyberVaultTrapCorridorRoomGenerator };
