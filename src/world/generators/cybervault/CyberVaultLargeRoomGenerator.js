/**
 * CyberVaultLargeRoomGenerator.js
 * Procedural Room Generator for CyberVault biome with Large dimensions.
 */

class CyberVaultLargeRoomGenerator {
...
module.exports = { CyberVaultLargeRoomGenerator };
